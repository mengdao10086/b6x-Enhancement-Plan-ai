...
This project is indexed by GitNexus as **b6x-Enhancement-Plan-ai** (867 symbols, 1490 relationships, 75 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
