...
This project is indexed by GitNexus as **b6x-Enhancement-Plan-ai** (11480 symbols, 11856 relationships, 45 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
