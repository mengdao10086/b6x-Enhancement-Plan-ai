...
This project is indexed by GitNexus as **b6x-Enhancement-Plan-ai** (856 symbols, 1455 relationships, 74 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
