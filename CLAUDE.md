...
This project is indexed by GitNexus as **b6x-Enhancement-Plan-ai** (840 symbols, 1420 relationships, 70 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
