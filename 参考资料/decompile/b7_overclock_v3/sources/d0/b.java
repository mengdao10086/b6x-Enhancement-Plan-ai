...
public class b {
    ...
    public static final ThreadLocal<Matrix> f25924a = new ThreadLocal<>();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final ThreadLocal<RectF> f25925b = new ThreadLocal<>();
    ...
    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal<Matrix> threadLocal = f25924a;
        ...
        ThreadLocal<RectF> threadLocal2 = f25925b;
