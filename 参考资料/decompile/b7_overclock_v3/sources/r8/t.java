...
public final class t implements j2.b {
    ...
    @n0
    public final LinearLayout f47836a;

    public t(@n0 LinearLayout linearLayout) {
    ...
    public static t d(@n0 LayoutInflater layoutInflater, @p0 ViewGroup viewGroup, boolean z10) {
        View viewInflate = layoutInflater.inflate(R.layout.game_view_downloading_empty, viewGroup, false);
        if (z10) {
