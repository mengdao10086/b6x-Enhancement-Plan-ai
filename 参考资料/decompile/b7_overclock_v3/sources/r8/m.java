...
public final class m implements j2.b {
    ...
    @n0
    public final ImageView f47809a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    @n0
    public final ImageView f47810b;

    public m(@n0 ImageView imageView, @n0 ImageView imageView2) {
        this.f47809a = imageView;
    ...
    public static m d(@n0 LayoutInflater layoutInflater, @p0 ViewGroup viewGroup, boolean z10) {
        View viewInflate = layoutInflater.inflate(R.layout.game_item_home_banner, viewGroup, false);
        if (z10) {
