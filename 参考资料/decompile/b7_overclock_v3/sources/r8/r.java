...
public final class r implements j2.b {
    ...
    @n0
    public final TextView f47833a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    @n0
    public final TextView f47834b;

    public r(@n0 TextView textView, @n0 TextView textView2) {
        this.f47833a = textView;
        this.f47834b = textView2;
    }
    ...
    public static r d(@n0 LayoutInflater layoutInflater, @p0 ViewGroup viewGroup, boolean z10) {
        View viewInflate = layoutInflater.inflate(R.layout.game_view_download_status, viewGroup, false);
        if (z10) {
