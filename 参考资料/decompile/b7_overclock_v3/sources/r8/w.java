...
public final class w implements j2.b {
    ...
    @n0
    public final LinearLayout f47855a;

    public w(@n0 LinearLayout linearLayout) {
        this.f47855a = linearLayout;
    }
    ...
    public static w d(@n0 LayoutInflater layoutInflater, @p0 ViewGroup viewGroup, boolean z10) {
        View viewInflate = layoutInflater.inflate(R.layout.game_view_search_empty, viewGroup, false);
        if (z10) {
