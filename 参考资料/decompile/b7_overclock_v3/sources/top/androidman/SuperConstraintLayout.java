...
public final class SuperConstraintLayout extends ConstraintLayout implements c {
    ...
    @i
    public SuperConstraintLayout(@k Context context) {
    ...
    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    @i
    public SuperConstraintLayout(@k Context context, @l AttributeSet attributeSet) {
        this(context, attributeSet, 0, 4, null);
        f0.p(context, "context");
    }

    public /* synthetic */ SuperConstraintLayout(Context context, AttributeSet attributeSet, int i10, int i11, u uVar) {
        this(context, (i11 & 2) != 0 ? null : attributeSet, (i11 & 4) != 0 ? 0 : i10);
    }

    private final Plasterer getPlasterer() {
        return (Plasterer) this.K1.getValue();
    }
    ...
    @i
    public SuperConstraintLayout(@k final Context context, @l final AttributeSet attributeSet, int i10) {
        super(context, attributeSet, i10);
        f0.p(context, "context");
        this.C1 = b0.a(new a<b>() { // from class: top.androidman.SuperConstraintLayout$valueStore$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
        ...
        this.K1 = b0.a(new a<Plasterer>() { // from class: top.androidman.SuperConstraintLayout$plasterer$2
            {
                super(0);
            }
            ...
            public final Plasterer o() {
                ...
                return new Plasterer(superConstraintLayout, superConstraintLayout.getValueStore());
            }
        });
        getPlasterer().D();
    }
