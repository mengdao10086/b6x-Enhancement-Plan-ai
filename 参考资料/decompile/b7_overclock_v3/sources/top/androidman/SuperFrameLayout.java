...
public final class SuperFrameLayout extends FrameLayout implements c {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    @k
    public final z f51429a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    @k
    public final z f51430b;

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    @i
    public SuperFrameLayout(@k Context context) {
    ...
    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    @i
    public SuperFrameLayout(@k Context context, @l AttributeSet attributeSet) {
        this(context, attributeSet, 0, 4, null);
        f0.p(context, "context");
    }

    public /* synthetic */ SuperFrameLayout(Context context, AttributeSet attributeSet, int i10, int i11, u uVar) {
        this(context, (i11 & 2) != 0 ? null : attributeSet, (i11 & 4) != 0 ? 0 : i10);
    }

    private final Plasterer getPlasterer() {
        return (Plasterer) this.f51430b.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final b getValueStore() {
        return (b) this.f51429a.getValue();
    }
    ...
    @i
    public SuperFrameLayout(@k final Context context, @l final AttributeSet attributeSet, int i10) {
        super(context, attributeSet, i10);
        f0.p(context, "context");
        this.f51429a = b0.a(new a<b>() { // from class: top.androidman.SuperFrameLayout$valueStore$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
        ...
        this.f51430b = b0.a(new a<Plasterer>() { // from class: top.androidman.SuperFrameLayout$plasterer$2
            {
                super(0);
            }
            ...
            public final Plasterer o() {
                SuperFrameLayout superFrameLayout = this.this$0;
                return new Plasterer(superFrameLayout, superFrameLayout.getValueStore());
            }
        });
        getPlasterer().D();
    }
