...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$3<T> implements e<T> {
    ...
    public final /* synthetic */ Iterable f38491a;
    ...
    @zj.d(c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$3", f = "Builders.kt", i = {0}, l = {115}, m = "collect", n = {"$this$asFlow_u24lambda_u243"}, s = {"L$0"})
    ...
    */
    public java.lang.Object a(@yt.k kotlinx.coroutines.flow.f<? super T> r6, @yt.k kotlin.coroutines.c<? super kotlin.z1> r7) throws java.lang.Throwable {
        ...
        L3a:
            kotlin.u0.n(r7)
            java.lang.Iterable r7 = r5.f38491a
        ...
        L5d:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$3.a(kotlinx.coroutines.flow.f, kotlin.coroutines.c):java.lang.Object");
    }
}
