...
@zj.d(c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransformUnsafe$1", f = "Zip.kt", i = {}, l = {273}, m = "invokeSuspend", n = {}, s = {})
public final class FlowKt__ZipKt$combineTransformUnsafe$1<R> extends SuspendLambda implements ik.p<f<? super R>, kotlin.coroutines.c<? super z1>, Object> {
    ...
    @zj.d(c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransformUnsafe$1$1", f = "Zip.kt", i = {}, l = {273}, m = "invokeSuspend", n = {}, s = {})
    public static final class AnonymousClass1<T> extends SuspendLambda implements ik.q<f<? super R>, T[], kotlin.coroutines.c<? super z1>, Object> {
        public final /* synthetic */ ik.q<f<? super R>, T[], kotlin.coroutines.c<? super z1>, Object> $transform;
        private /* synthetic */ Object L$0;
        ...
        public AnonymousClass1(ik.q<? super f<? super R>, ? super T[], ? super kotlin.coroutines.c<? super z1>, ? extends Object> qVar, kotlin.coroutines.c<? super AnonymousClass1> cVar) {
            super(3, cVar);
            this.$transform = qVar;
        }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public FlowKt__ZipKt$combineTransformUnsafe$1(e<? extends T>[] eVarArr, ik.q<? super f<? super R>, ? super T[], ? super kotlin.coroutines.c<? super z1>, ? extends Object> qVar, kotlin.coroutines.c<? super FlowKt__ZipKt$combineTransformUnsafe$1> cVar) {
        super(2, cVar);
        this.$flows = eVarArr;
        this.$transform = qVar;
    }
    ...
    public final Object r0(@yt.k f<? super R> fVar, @yt.l kotlin.coroutines.c<? super z1> cVar) {
        return ((FlowKt__ZipKt$combineTransformUnsafe$1) M(fVar, cVar)).q0(z1.f38230a);
    }
}
