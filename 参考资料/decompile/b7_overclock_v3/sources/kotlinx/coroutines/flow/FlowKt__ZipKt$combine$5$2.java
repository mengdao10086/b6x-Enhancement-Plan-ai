...
@zj.d(c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combine$5$2", f = "Zip.kt", i = {}, l = {mb.e.f41061s1, mb.e.f41061s1}, m = "invokeSuspend", n = {}, s = {})
public final class FlowKt__ZipKt$combine$5$2<R, T> extends SuspendLambda implements ik.q<f<? super R>, T[], kotlin.coroutines.c<? super z1>, Object> {
    ...
    public FlowKt__ZipKt$combine$5$2(ik.p<? super T[], ? super kotlin.coroutines.c<? super R>, ? extends Object> pVar, kotlin.coroutines.c<? super FlowKt__ZipKt$combine$5$2> cVar) {
        super(3, cVar);
        this.$transform = pVar;
    }
    ...
    public final Object A(@yt.k f<? super R> fVar, @yt.k T[] tArr, @yt.l kotlin.coroutines.c<? super z1> cVar) {
        ...
        return flowKt__ZipKt$combine$5$2.q0(z1.f38230a);
    }
}
