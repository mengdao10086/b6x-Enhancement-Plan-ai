...
public class l implements org.bouncycastle.crypto.f {
    ...
    public int[] f25438c = new int[96];

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public int[] f25439d = new int[8];

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public int[] f25440e = new int[12];

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    public int[] f25441f = new int[4];
    ...
    public static void o(int i10, int[] iArr, int i11, int[] iArr2, int i12) {
        int i13 = i12 + 0;
        int i14 = i11 + 0;
        int i15 = i11 + 1;
        int i16 = 32 - i10;
    ...
    public int d(byte[] bArr, int i10, byte[] bArr2, int i11) throws IllegalStateException, DataLengthException {
        ...
        if (i11 + 16 <= bArr2.length) {
            return this.f25437b ? l(bArr, i10, bArr2, i11) : m(bArr, i10, bArr2, i11);
        }
    ...
    public final int l(byte[] bArr, int i10, byte[] bArr2, int i11) {
        for (int i12 = 0; i12 < 4; i12++) {
            this.f25441f[i12] = e(bArr, (i12 * 4) + i10);
            int[] iArr = this.f25441f;
            iArr[i12] = iArr[i12] ^ this.f25439d[i12];
        }
        f(this.f25441f, this.f25438c, 0);
        f(this.f25441f, this.f25438c, 4);
        f(this.f25441f, this.f25438c, 8);
        g(this.f25441f, this.f25440e, 0);
        f(this.f25441f, this.f25438c, 12);
        f(this.f25441f, this.f25438c, 16);
        f(this.f25441f, this.f25438c, 20);
        g(this.f25441f, this.f25440e, 4);
        f(this.f25441f, this.f25438c, 24);
        f(this.f25441f, this.f25438c, 28);
        f(this.f25441f, this.f25438c, 32);
        int[] iArr2 = this.f25441f;
        int i13 = iArr2[2];
        int[] iArr3 = this.f25439d;
        iArr2[2] = iArr3[4] ^ i13;
        iArr2[3] = iArr2[3] ^ iArr3[5];
        iArr2[0] = iArr2[0] ^ iArr3[6];
        iArr2[1] = iArr3[7] ^ iArr2[1];
        j(iArr2[2], bArr2, i11);
        j(this.f25441f[3], bArr2, i11 + 4);
        j(this.f25441f[0], bArr2, i11 + 8);
        j(this.f25441f[1], bArr2, i11 + 12);
        return 16;
    }
    ...
    public final int m(byte[] bArr, int i10, byte[] bArr2, int i11) {
        ...
        f(this.f25441f, this.f25438c, 28);
        f(this.f25441f, this.f25438c, 32);
        g(this.f25441f, this.f25440e, 8);
        f(this.f25441f, this.f25438c, 36);
        f(this.f25441f, this.f25438c, 40);
        f(this.f25441f, this.f25438c, 44);
        int[] iArr2 = this.f25441f;
        int i13 = iArr2[2];
        int[] iArr3 = this.f25439d;
        iArr2[2] = i13 ^ iArr3[4];
    ...
    public final void q(boolean z10, byte[] bArr) {
        ...
        f(iArr2, f25431i, 4);
        if (this.f25437b) {
            int[] iArr5 = this.f25439d;
            if (z10) {
                iArr5[0] = iArr[0];
                iArr5[1] = iArr[1];
                iArr5[2] = iArr[2];
                iArr5[3] = iArr[3];
                o(15, iArr, 0, this.f25438c, 4);
                o(30, iArr, 0, this.f25438c, 12);
                o(15, iArr, 0, iArr4, 0);
                int[] iArr6 = this.f25438c;
                iArr6[18] = iArr4[2];
                iArr6[19] = iArr4[3];
                o(17, iArr, 0, this.f25440e, 4);
                o(17, iArr, 0, this.f25438c, 24);
                o(17, iArr, 0, this.f25438c, 32);
                int[] iArr7 = this.f25438c;
                iArr7[0] = iArr2[0];
                iArr7[1] = iArr2[1];
                iArr7[2] = iArr2[2];
                iArr7[3] = iArr2[3];
                o(15, iArr2, 0, iArr7, 8);
                o(15, iArr2, 0, this.f25440e, 0);
                o(15, iArr2, 0, iArr4, 0);
                int[] iArr8 = this.f25438c;
                iArr8[16] = iArr4[0];
                iArr8[17] = iArr4[1];
                o(15, iArr2, 0, iArr8, 20);
                p(34, iArr2, 0, this.f25438c, 28);
                o(17, iArr2, 0, this.f25439d, 4);
                return;
            }
            iArr5[4] = iArr[0];
            iArr5[5] = iArr[1];
            iArr5[6] = iArr[2];
            iArr5[7] = iArr[3];
            h(15, iArr, 0, this.f25438c, 28);
            h(30, iArr, 0, this.f25438c, 20);
            h(15, iArr, 0, iArr4, 0);
            int[] iArr9 = this.f25438c;
            iArr9[16] = iArr4[0];
            iArr9[17] = iArr4[1];
            h(17, iArr, 0, this.f25440e, 0);
            h(17, iArr, 0, this.f25438c, 8);
            h(17, iArr, 0, this.f25438c, 0);
            int[] iArr10 = this.f25438c;
            iArr10[34] = iArr2[0];
            iArr10[35] = iArr2[1];
            iArr10[32] = iArr2[2];
            iArr10[33] = iArr2[3];
            h(15, iArr2, 0, iArr10, 24);
            h(15, iArr2, 0, this.f25440e, 4);
            h(15, iArr2, 0, iArr4, 0);
            int[] iArr11 = this.f25438c;
            iArr11[18] = iArr4[2];
            iArr11[19] = iArr4[3];
            h(15, iArr2, 0, iArr11, 12);
            i(34, iArr2, 0, this.f25438c, 4);
            o(17, iArr2, 0, this.f25439d, 0);
            return;
        }
        for (int i12 = 0; i12 < 4; i12++) {
        ...
        f(iArr3, f25431i, 8);
        int[] iArr12 = this.f25439d;
        if (z10) {
            iArr12[0] = iArr[0];
            iArr12[1] = iArr[1];
            iArr12[2] = iArr[2];
            iArr12[3] = iArr[3];
            p(45, iArr, 0, this.f25438c, 16);
            o(15, iArr, 0, this.f25440e, 4);
            o(17, iArr, 0, this.f25438c, 32);
            p(34, iArr, 0, this.f25438c, 44);
            o(15, iArr, 4, this.f25438c, 4);
            o(15, iArr, 4, this.f25440e, 0);
            o(30, iArr, 4, this.f25438c, 24);
            p(34, iArr, 4, this.f25438c, 36);
            o(15, iArr2, 0, this.f25438c, 8);
            o(30, iArr2, 0, this.f25438c, 20);
            int[] iArr13 = this.f25440e;
            iArr13[8] = iArr2[1];
            iArr13[9] = iArr2[2];
            iArr13[10] = iArr2[3];
            iArr13[11] = iArr2[0];
            p(49, iArr2, 0, this.f25438c, 40);
            int[] iArr14 = this.f25438c;
            iArr14[0] = iArr3[0];
            iArr14[1] = iArr3[1];
            iArr14[2] = iArr3[2];
            iArr14[3] = iArr3[3];
            o(30, iArr3, 0, iArr14, 12);
            o(30, iArr3, 0, this.f25438c, 28);
            p(51, iArr3, 0, this.f25439d, 4);
            return;
        }
        iArr12[4] = iArr[0];
        iArr12[5] = iArr[1];
        iArr12[6] = iArr[2];
        iArr12[7] = iArr[3];
        i(45, iArr, 0, this.f25438c, 28);
        h(15, iArr, 0, this.f25440e, 4);
        h(17, iArr, 0, this.f25438c, 12);
        i(34, iArr, 0, this.f25438c, 0);
        h(15, iArr, 4, this.f25438c, 40);
        h(15, iArr, 4, this.f25440e, 8);
        h(30, iArr, 4, this.f25438c, 20);
        i(34, iArr, 4, this.f25438c, 8);
        h(15, iArr2, 0, this.f25438c, 36);
        h(30, iArr2, 0, this.f25438c, 24);
        int[] iArr15 = this.f25440e;
        iArr15[2] = iArr2[1];
        iArr15[3] = iArr2[2];
        iArr15[0] = iArr2[3];
        iArr15[1] = iArr2[0];
        i(49, iArr2, 0, this.f25438c, 4);
        int[] iArr16 = this.f25438c;
        iArr16[46] = iArr3[0];
        iArr16[47] = iArr3[1];
        iArr16[44] = iArr3[2];
        iArr16[45] = iArr3[3];
        h(30, iArr3, 0, iArr16, 32);
        h(30, iArr3, 0, this.f25438c, 16);
        p(51, iArr3, 0, this.f25439d, 0);
    }
