...
public class y extends org.bouncycastle.crypto.h {
    ...
    public y(org.bouncycastle.crypto.f fVar) {
        if ((fVar instanceof x) || (fVar instanceof e)) {
    ...
    public int a(byte[] bArr, int i10) throws InvalidCipherTextException, IllegalStateException, DataLengthException {
        ...
        if (this.f44683c) {
            ...
            while (true) {
                ...
                bArr3[i12] = bArr2[i12 - iC];
                i12++;
            }
            for (int i13 = iC; i13 != this.f44682b; i13++) {
                byte[] bArr4 = this.f44681a;
                bArr4[i13] = (byte) (bArr4[i13] ^ bArr2[i13 - iC]);
            }
            ...
            System.arraycopy(bArr2, 0, bArr, i10 + iC, i11);
        } else {
            ...
            for (int i14 = iC; i14 != this.f44682b; i14++) {
                int i15 = i14 - iC;
                bArr5[i15] = (byte) (bArr2[i15] ^ this.f44681a[i14]);
            }
            System.arraycopy(this.f44681a, iC, bArr2, 0, i11);
            this.f44684d.d(bArr2, 0, bArr, i10);
            System.arraycopy(bArr5, 0, bArr, i10 + iC, i11);
        }
        int i16 = this.f44682b;
        i();
        return i16;
    }
    ...
    public int g(byte b10, byte[] bArr, int i10) throws IllegalStateException, DataLengthException {
        ...
        if (i11 == bArr2.length) {
            ...
            byte[] bArr3 = this.f44681a;
            int i13 = this.f36819g;
            System.arraycopy(bArr3, i13, bArr3, 0, i13);
            this.f44682b = this.f36819g;
            i12 = iD;
        }
        byte[] bArr4 = this.f44681a;
