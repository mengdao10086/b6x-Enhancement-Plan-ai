...
public final class q implements j2.b {
    ...
    public q(@n0 ConstraintLayout constraintLayout, @n0 TextView textView) {
    ...
    public static q d(@n0 LayoutInflater layoutInflater, @p0 ViewGroup viewGroup, boolean z10) {
        View viewInflate = layoutInflater.inflate(R.layout.main_item_mall_product_detail_section, viewGroup, false);
        if (z10) {
