...
public class g implements org.bouncycastle.crypto.p {
    ...
    public void a(boolean z10, org.bouncycastle.crypto.k kVar) {
        ...
        if (!z10) {
            ...
            if (kVar instanceof w1) {
                w1 w1Var = (w1) kVar;
                this.f48995h = w1Var.b();
                this.f48994g = (l0) w1Var.a();
                return;
            }
            this.f48995h = org.bouncycastle.crypto.n.f();
            j0Var = (l0) kVar;
        }
        this.f48994g = j0Var;
    }
    ...
    public BigInteger[] b(byte[] bArr) {
        ...
        g0 g0VarD = this.f48994g.d();
        BigInteger bigIntegerE = g0VarD.e();
        BigInteger bigIntegerE2 = ((l0) this.f48994g).e();
        ir.h hVarD = d();
        while (true) {
            BigInteger bigIntegerF = org.bouncycastle.util.b.f(bigIntegerE.bitLength(), this.f48995h);
    ...
    public boolean c(byte[] bArr, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger bigIntegerE = this.f48994g.d().e();
        ...
        ir.i iVarB = ir.c.v(this.f48994g.d().b(), bigInteger2.multiply(bigIntegerO).mod(bigIntegerE), ((m0) this.f48994g).e(), bigIntegerE.subtract(bigInteger).multiply(bigIntegerO).mod(bigIntegerE)).B();
        if (iVarB.v()) {
            return false;
        }
