...
public final class w0 implements j2.b {
    ...
    @g.n0
    public final PropertyLinearLayout f54516a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    @g.n0
    public final FloatViewPropertyIntroductionView f54517b;

    public w0(@g.n0 PropertyLinearLayout propertyLinearLayout, @g.n0 FloatViewPropertyIntroductionView floatViewPropertyIntroductionView) {
        this.f54516a = propertyLinearLayout;
        this.f54517b = floatViewPropertyIntroductionView;
    }
    ...
    public static w0 a(@g.n0 View view) {
        ...
        if (floatViewPropertyIntroductionView != null) {
            return new w0((PropertyLinearLayout) view, floatViewPropertyIntroductionView);
        }
    ...
    public static w0 d(@g.n0 LayoutInflater layoutInflater, @g.p0 ViewGroup viewGroup, boolean z10) {
        View viewInflate = layoutInflater.inflate(R.layout.floatview_property_key_fps_get_off_car, viewGroup, false);
        if (z10) {
