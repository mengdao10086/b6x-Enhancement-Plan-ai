...
public final class n1 implements j2.b {
    ...
    @g.n0
    public final PropertyLinearLayout f54314a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    @g.n0
    public final FloatViewPropertyIntroductionView f54315b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    @g.n0
    public final FloatViewSingleSeekBarView f54316c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    @g.n0
    public final FloatViewTwoCheckBoxView f54317d;

    public n1(@g.n0 PropertyLinearLayout propertyLinearLayout, @g.n0 FloatViewPropertyIntroductionView floatViewPropertyIntroductionView, @g.n0 FloatViewSingleSeekBarView floatViewSingleSeekBarView, @g.n0 FloatViewTwoCheckBoxView floatViewTwoCheckBoxView) {
        this.f54314a = propertyLinearLayout;
        this.f54315b = floatViewPropertyIntroductionView;
        this.f54316c = floatViewSingleSeekBarView;
        this.f54317d = floatViewTwoCheckBoxView;
    }
        ...
        if (floatViewPropertyIntroductionView != null) {
            ...
            if (floatViewSingleSeekBarView != null) {
                ...
                if (floatViewTwoCheckBoxView != null) {
                    return new n1((PropertyLinearLayout) view, floatViewPropertyIntroductionView, floatViewSingleSeekBarView, floatViewTwoCheckBoxView);
                }
            }
        }
    ...
    public static n1 d(@g.n0 LayoutInflater layoutInflater, @g.p0 ViewGroup viewGroup, boolean z10) {
        View viewInflate = layoutInflater.inflate(R.layout.floatview_property_key_moba_right_joystick_relation, viewGroup, false);
        if (z10) {
