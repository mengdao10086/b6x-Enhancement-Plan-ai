...
public final class k1 implements j2.b {
    ...
    @g.n0
    public final PropertyLinearLayout f54222a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    @g.n0
    public final FloatViewPropertyIntroductionView f54223b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    @g.n0
    public final FloatViewSingleSeekBarView f54224c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    @g.n0
    public final FloatViewTwoCheckBoxView f54225d;

    public k1(@g.n0 PropertyLinearLayout propertyLinearLayout, @g.n0 FloatViewPropertyIntroductionView floatViewPropertyIntroductionView, @g.n0 FloatViewSingleSeekBarView floatViewSingleSeekBarView, @g.n0 FloatViewTwoCheckBoxView floatViewTwoCheckBoxView) {
        this.f54222a = propertyLinearLayout;
        this.f54223b = floatViewPropertyIntroductionView;
        this.f54224c = floatViewSingleSeekBarView;
        this.f54225d = floatViewTwoCheckBoxView;
    }
        ...
        if (floatViewPropertyIntroductionView != null) {
            ...
            if (floatViewSingleSeekBarView != null) {
                ...
                if (floatViewTwoCheckBoxView != null) {
                    return new k1((PropertyLinearLayout) view, floatViewPropertyIntroductionView, floatViewSingleSeekBarView, floatViewTwoCheckBoxView);
                }
            }
        }
    ...
    public static k1 d(@g.n0 LayoutInflater layoutInflater, @g.p0 ViewGroup viewGroup, boolean z10) {
        View viewInflate = layoutInflater.inflate(R.layout.floatview_property_key_moba_look_map, viewGroup, false);
        if (z10) {
