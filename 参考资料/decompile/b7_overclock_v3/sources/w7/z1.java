...
public final class z1 implements j2.b {
    ...
    @g.n0
    public final PropertyLinearLayout f54585a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    @g.n0
    public final FloatViewPropertyIntroductionView f54586b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    @g.n0
    public final FloatViewSingleSeekBarView f54587c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    @g.n0
    public final FloatViewSingleSeekBarView f54588d;

    public z1(@g.n0 PropertyLinearLayout propertyLinearLayout, @g.n0 FloatViewPropertyIntroductionView floatViewPropertyIntroductionView, @g.n0 FloatViewSingleSeekBarView floatViewSingleSeekBarView, @g.n0 FloatViewSingleSeekBarView floatViewSingleSeekBarView2) {
        this.f54585a = propertyLinearLayout;
        this.f54586b = floatViewPropertyIntroductionView;
        this.f54587c = floatViewSingleSeekBarView;
        this.f54588d = floatViewSingleSeekBarView2;
    }
        ...
        if (floatViewPropertyIntroductionView != null) {
            ...
            if (floatViewSingleSeekBarView != null) {
                ...
                if (floatViewSingleSeekBarView2 != null) {
                    return new z1((PropertyLinearLayout) view, floatViewPropertyIntroductionView, floatViewSingleSeekBarView, floatViewSingleSeekBarView2);
                }
            }
        }
    ...
    public static z1 d(@g.n0 LayoutInflater layoutInflater, @g.p0 ViewGroup viewGroup, boolean z10) {
        View viewInflate = layoutInflater.inflate(R.layout.floatview_property_key_slide_right, viewGroup, false);
        if (z10) {
