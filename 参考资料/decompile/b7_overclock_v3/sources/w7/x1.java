...
public final class x1 implements j2.b {
    ...
    @g.n0
    public final PropertyLinearLayout f54541a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    @g.n0
    public final FloatViewPropertyIntroductionView f54542b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    @g.n0
    public final FloatViewSingleSeekBarView f54543c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    @g.n0
    public final FloatViewSingleSeekBarView f54544d;

    public x1(@g.n0 PropertyLinearLayout propertyLinearLayout, @g.n0 FloatViewPropertyIntroductionView floatViewPropertyIntroductionView, @g.n0 FloatViewSingleSeekBarView floatViewSingleSeekBarView, @g.n0 FloatViewSingleSeekBarView floatViewSingleSeekBarView2) {
        this.f54541a = propertyLinearLayout;
        this.f54542b = floatViewPropertyIntroductionView;
        this.f54543c = floatViewSingleSeekBarView;
        this.f54544d = floatViewSingleSeekBarView2;
    }
        ...
        if (floatViewPropertyIntroductionView != null) {
            ...
            if (floatViewSingleSeekBarView != null) {
                ...
                if (floatViewSingleSeekBarView2 != null) {
                    return new x1((PropertyLinearLayout) view, floatViewPropertyIntroductionView, floatViewSingleSeekBarView, floatViewSingleSeekBarView2);
                }
            }
        }
    ...
    public static x1 d(@g.n0 LayoutInflater layoutInflater, @g.p0 ViewGroup viewGroup, boolean z10) {
        View viewInflate = layoutInflater.inflate(R.layout.floatview_property_key_slide_left_down, viewGroup, false);
        if (z10) {
