...
public final class j1 implements j2.b {
    ...
    @g.n0
    public final PropertyLinearLayout f54187a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    @g.n0
    public final FloatViewPropertyIntroductionView f54188b;

    public j1(@g.n0 PropertyLinearLayout propertyLinearLayout, @g.n0 FloatViewPropertyIntroductionView floatViewPropertyIntroductionView) {
        this.f54187a = propertyLinearLayout;
        this.f54188b = floatViewPropertyIntroductionView;
    }
    ...
    public static j1 a(@g.n0 View view) {
        ...
        if (floatViewPropertyIntroductionView != null) {
            return new j1((PropertyLinearLayout) view, floatViewPropertyIntroductionView);
        }
    ...
    public static j1 d(@g.n0 LayoutInflater layoutInflater, @g.p0 ViewGroup viewGroup, boolean z10) {
        View viewInflate = layoutInflater.inflate(R.layout.floatview_property_key_moba_lock_view, viewGroup, false);
        if (z10) {
