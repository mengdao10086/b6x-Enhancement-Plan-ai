...
public final class u1 implements j2.b {
    ...
    @g.n0
    public final PropertyLinearLayout f54480a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    @g.n0
    public final FloatViewPropertyIntroductionView f54481b;

    public u1(@g.n0 PropertyLinearLayout propertyLinearLayout, @g.n0 FloatViewPropertyIntroductionView floatViewPropertyIntroductionView) {
        this.f54480a = propertyLinearLayout;
        this.f54481b = floatViewPropertyIntroductionView;
    }
    ...
    public static u1 a(@g.n0 View view) {
        ...
        if (floatViewPropertyIntroductionView != null) {
            return new u1((PropertyLinearLayout) view, floatViewPropertyIntroductionView);
        }
    ...
    public static u1 d(@g.n0 LayoutInflater layoutInflater, @g.p0 ViewGroup viewGroup, boolean z10) {
        View viewInflate = layoutInflater.inflate(R.layout.floatview_property_key_singletouch_release, viewGroup, false);
        if (z10) {
