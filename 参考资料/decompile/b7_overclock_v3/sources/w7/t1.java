...
public final class t1 implements j2.b {
    ...
    @g.n0
    public final PropertyLinearLayout f54468a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    @g.n0
    public final FloatViewPropertyIntroductionView f54469b;

    public t1(@g.n0 PropertyLinearLayout propertyLinearLayout, @g.n0 FloatViewPropertyIntroductionView floatViewPropertyIntroductionView) {
        this.f54468a = propertyLinearLayout;
        this.f54469b = floatViewPropertyIntroductionView;
    }
    ...
    public static t1 a(@g.n0 View view) {
        ...
        if (floatViewPropertyIntroductionView != null) {
            return new t1((PropertyLinearLayout) view, floatViewPropertyIntroductionView);
        }
    ...
    public static t1 d(@g.n0 LayoutInflater layoutInflater, @g.p0 ViewGroup viewGroup, boolean z10) {
        View viewInflate = layoutInflater.inflate(R.layout.floatview_property_key_singletouch_normal, viewGroup, false);
        if (z10) {
