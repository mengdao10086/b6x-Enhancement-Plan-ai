...
public final class b2 implements j2.b {
    ...
    @g.n0
    public final PropertyLinearLayout f53990a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    @g.n0
    public final FloatViewPropertyIntroductionView f53991b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    @g.n0
    public final FloatViewSingleSeekBarView f53992c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    @g.n0
    public final FloatViewSingleSeekBarView f53993d;

    public b2(@g.n0 PropertyLinearLayout propertyLinearLayout, @g.n0 FloatViewPropertyIntroductionView floatViewPropertyIntroductionView, @g.n0 FloatViewSingleSeekBarView floatViewSingleSeekBarView, @g.n0 FloatViewSingleSeekBarView floatViewSingleSeekBarView2) {
        this.f53990a = propertyLinearLayout;
        this.f53991b = floatViewPropertyIntroductionView;
        this.f53992c = floatViewSingleSeekBarView;
        this.f53993d = floatViewSingleSeekBarView2;
    }
        ...
        if (floatViewPropertyIntroductionView != null) {
            ...
            if (floatViewSingleSeekBarView != null) {
                ...
                if (floatViewSingleSeekBarView2 != null) {
                    return new b2((PropertyLinearLayout) view, floatViewPropertyIntroductionView, floatViewSingleSeekBarView, floatViewSingleSeekBarView2);
                }
            }
        }
    ...
    public static b2 d(@g.n0 LayoutInflater layoutInflater, @g.p0 ViewGroup viewGroup, boolean z10) {
        View viewInflate = layoutInflater.inflate(R.layout.floatview_property_key_slide_right_up, viewGroup, false);
        if (z10) {
