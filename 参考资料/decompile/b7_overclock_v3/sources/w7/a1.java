...
public final class a1 implements j2.b {
    ...
    @g.n0
    public final PropertyLinearLayout f53962a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    @g.n0
    public final FloatViewPropertyIntroductionView f53963b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    @g.n0
    public final FloatViewTwoSeekBarView f53964c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    @g.n0
    public final FloatViewTwoSeekBarView f53965d;

    public a1(@g.n0 PropertyLinearLayout propertyLinearLayout, @g.n0 FloatViewPropertyIntroductionView floatViewPropertyIntroductionView, @g.n0 FloatViewTwoSeekBarView floatViewTwoSeekBarView, @g.n0 FloatViewTwoSeekBarView floatViewTwoSeekBarView2) {
        this.f53962a = propertyLinearLayout;
        this.f53963b = floatViewPropertyIntroductionView;
        this.f53964c = floatViewTwoSeekBarView;
        this.f53965d = floatViewTwoSeekBarView2;
    }
        ...
        if (floatViewPropertyIntroductionView != null) {
            ...
            if (floatViewTwoSeekBarView != null) {
                ...
                if (floatViewTwoSeekBarView2 != null) {
                    return new a1((PropertyLinearLayout) view, floatViewPropertyIntroductionView, floatViewTwoSeekBarView, floatViewTwoSeekBarView2);
                }
            }
        }
    ...
    public static a1 d(@g.n0 LayoutInflater layoutInflater, @g.p0 ViewGroup viewGroup, boolean z10) {
        View viewInflate = layoutInflater.inflate(R.layout.floatview_property_key_fps_motion_view, viewGroup, false);
        if (z10) {
