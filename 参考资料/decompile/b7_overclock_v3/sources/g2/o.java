...
public class o extends f0 {
    ...
    public float f28970d = 3.0f;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public int f28971e = 80;
    ...
    public long c(ViewGroup viewGroup, androidx.transition.q qVar, q qVar2, q qVar3) {
        ...
        int iCenterY;
        q qVar4 = qVar2;
        if (qVar4 == null && qVar3 == null) {
            return 0L;
        }
        Rect rectH = qVar.H();
        if (qVar3 == null || e(qVar4) == 0) {
            i10 = -1;
        } else {
            qVar4 = qVar3;
            i10 = 1;
        ...
        return Math.round(((jG * ((long) i10)) / this.f28970d) * fH);
    }
    ...
    */
    public final int h(android.view.View r7, int r8, int r9, int r10, int r11, int r12, int r13, int r14, int r15) {
        /*
            ...
            if (r0 != r5) goto L19
            int r7 = androidx.core.view.u0.Z(r7)
            if (r7 != r4) goto L12
            goto L13
        L12:
            r4 = 0
        ...
        L59:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: g2.o.h(android.view.View, int, int, int, int, int, int, int, int):int");
    }
