...
public final class Utf8Safe extends Utf8 {
    ...
    public static int j(CharSequence charSequence, byte[] bArr, int i10, int i11) {
        int i12;
        int i13;
        int i14;
        char cCharAt;
    ...
    public String a(ByteBuffer byteBuffer, int i10, int i11) throws IllegalArgumentException {
        return byteBuffer.hasArray() ? h(byteBuffer.array(), byteBuffer.arrayOffset() + i10, i11) : i(byteBuffer, i10, i11);
    }
    ...
    public void b(CharSequence charSequence, ByteBuffer byteBuffer) {
        if (!byteBuffer.hasArray()) {
            ...
            byteBuffer.position(j(charSequence, byteBuffer.array(), byteBuffer.position() + iArrayOffset, byteBuffer.remaining()) - iArrayOffset);
        }
    }
