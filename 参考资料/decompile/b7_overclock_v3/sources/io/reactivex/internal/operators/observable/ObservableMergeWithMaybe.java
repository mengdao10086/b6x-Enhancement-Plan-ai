...
public final class ObservableMergeWithMaybe<T> extends a<T, T> {
    ...
    public final xi.w<? extends T> f34243b;
    ...
    public static final class MergeWithObserver<T> extends AtomicInteger implements xi.g0<T>, io.reactivex.disposables.b {
        ...
        public static final int f34244a = 1;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        public static final int f34245b = 2;
    ...
    public ObservableMergeWithMaybe(xi.z<T> zVar, xi.w<? extends T> wVar) {
        super(zVar);
        this.f34243b = wVar;
    }
    ...
    public void I5(xi.g0<? super T> g0Var) {
        ...
        this.f34243b.a(mergeWithObserver.otherObserver);
    }
}
