...
public final class MaybeTimeoutMaybe<T, U> extends a<T, T> {
    ...
    public final xi.w<U> f33896b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final xi.w<? extends T> f33897c;
    ...
    public static final class TimeoutOtherMaybeObserver<T, U> extends AtomicReference<io.reactivex.disposables.b> implements xi.t<Object> {
        private static final long serialVersionUID = 8663801314800248617L;
    ...
    public MaybeTimeoutMaybe(xi.w<T> wVar, xi.w<U> wVar2, xi.w<? extends T> wVar3) {
        super(wVar);
        this.f33896b = wVar2;
        this.f33897c = wVar3;
    }
    ...
    public void q1(xi.t<? super T> tVar) {
        TimeoutMainMaybeObserver timeoutMainMaybeObserver = new TimeoutMainMaybeObserver(tVar, this.f33897c);
        tVar.onSubscribe(timeoutMainMaybeObserver);
        this.f33896b.a(timeoutMainMaybeObserver.other);
