...
public final class ObservableRepeatWhen<T> extends a<T, T> {
    ...
    public final dj.o<? super xi.z<Object>, ? extends xi.e0<?>> f34282b;
    ...
    public static final class RepeatWhenObserver<T> extends AtomicInteger implements xi.g0<T>, io.reactivex.disposables.b {
        ...
        public RepeatWhenObserver(xi.g0<? super T> g0Var, io.reactivex.subjects.c<Object> cVar, xi.e0<T> e0Var) {
    ...
    public ObservableRepeatWhen(xi.e0<T> e0Var, dj.o<? super xi.z<Object>, ? extends xi.e0<?>> oVar) {
        super(e0Var);
        this.f34282b = oVar;
    }
    ...
    public void I5(xi.g0<? super T> g0Var) {
        ...
        try {
            xi.e0 e0Var = (xi.e0) io.reactivex.internal.functions.a.g(this.f34282b.apply(cVarM8), "The handler returned a null ObservableSource");
