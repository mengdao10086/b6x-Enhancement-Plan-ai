...
public final class w<T> extends io.reactivex.internal.operators.maybe.a<T, T> {
    ...
    public static final class a<T> implements xi.t<T>, io.reactivex.disposables.b {
        ...
        public final xi.t<? super T> f34011a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        public io.reactivex.disposables.b f34012b;
        ...
        public void dispose() {
            ...
            this.f34012b = DisposableHelper.DISPOSED;
        }
        ...
        public void onError(Throwable th2) {
            this.f34012b = DisposableHelper.DISPOSED;
            this.f34011a.onError(th2);
        }

        @Override // xi.t
        public void onSubscribe(io.reactivex.disposables.b bVar) {
            if (DisposableHelper.validate(this.f34012b, bVar)) {
                this.f34012b = bVar;
