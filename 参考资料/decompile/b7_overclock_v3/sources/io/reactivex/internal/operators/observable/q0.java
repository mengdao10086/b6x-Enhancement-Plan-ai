...
public final class q0<T> extends io.reactivex.internal.operators.observable.a<T, T> {
    ...
    public static final class a<T> implements xi.g0<T>, io.reactivex.disposables.b {
        ...
        public final xi.g0<? super T> f34670a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        public io.reactivex.disposables.b f34671b;
        ...
        public void onNext(T t10) {
            this.f34670a.onNext(t10);
        }

        @Override // xi.g0
        public void onSubscribe(io.reactivex.disposables.b bVar) {
            if (DisposableHelper.validate(this.f34671b, bVar)) {
                this.f34671b = bVar;
