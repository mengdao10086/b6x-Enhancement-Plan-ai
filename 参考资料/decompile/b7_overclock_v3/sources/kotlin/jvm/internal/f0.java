...
public class f0 {
    ...
    public static <T extends Throwable> T A(T t10) {
        return (T) B(t10, f0.class.getName());
    }
    ...
    public static void j(Object obj, String str, String str2) {
        ...
        throw ((IllegalStateException) A(new IllegalStateException("Field specified as non-null is null: " + str + j3.b.f36044h + str2)));
    }

    public static void k(String str) throws ClassNotFoundException {
        String strReplace = str.replace(zc.f.f58380j, '.');
        try {
    ...
    public static void s(Object obj, String str, String str2) {
        ...
        throw ((IllegalStateException) A(new IllegalStateException("Method specified as non-null returned null: " + str + j3.b.f36044h + str2)));
    }
    ...
    public static String v(String str) {
        ...
        return "Parameter specified as non-null is null: method " + stackTraceElement.getClassName() + j3.b.f36044h + stackTraceElement.getMethodName() + ", parameter " + str;
    }
