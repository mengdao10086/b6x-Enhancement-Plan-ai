...
public class g1 extends o0 {
    ...
    public static final int f2477d = 20;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final WeakReference<Context> f2478b;

    public g1(@g.n0 Context context, @g.n0 Resources resources) {
        super(resources);
        this.f2478b = new WeakReference<>(context);
    }
    ...
    public Drawable getDrawable(int i10) throws Resources.NotFoundException {
        Context context = this.f2478b.get();
        return context != null ? n0.h().t(context, this, i10) : a(i10);
    }
