...
public class AppCompatCheckBox extends CheckBox implements androidx.core.widget.u, androidx.core.view.r0, f0, androidx.core.widget.v {
    ...
    public AppCompatCheckBox(@g.n0 Context context) {
        this(context, null);
    }
    ...
    public AppCompatCheckBox(@g.n0 Context context, @g.p0 AttributeSet attributeSet) {
        this(context, attributeSet, R.attr.checkboxStyle);
    }

    public AppCompatCheckBox(@g.n0 Context context, @g.p0 AttributeSet attributeSet, int i10) {
