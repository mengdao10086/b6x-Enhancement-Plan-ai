...
public class AppCompatImageView extends ImageView implements androidx.core.view.r0, androidx.core.widget.w {
    ...
    public AppCompatImageView(@g.n0 Context context) {
        this(context, null);
    }
    ...
    public boolean hasOverlappingRendering() {
        return this.f2144b.f() && super.hasOverlappingRendering();
    }
    ...
    public void setImageDrawable(@g.p0 Drawable drawable) {
        o oVar = this.f2144b;
        if (oVar != null && drawable != null && !this.f2145c) {
            oVar.h(drawable);
        }
    ...
    public AppCompatImageView(@g.n0 Context context, @g.p0 AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public AppCompatImageView(@g.n0 Context context, @g.p0 AttributeSet attributeSet, int i10) {
