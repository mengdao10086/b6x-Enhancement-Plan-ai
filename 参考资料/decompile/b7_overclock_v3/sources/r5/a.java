...
public class a {
    ...
    public static final String f47741c = "PathDataNode";

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public char f47742a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public float[] f47743b;
    ...
    public static void f(a[] aVarArr, Path path) {
        ...
        for (int i10 = 0; i10 < aVarArr.length; i10++) {
            a(path, fArr, c10, aVarArr[i10].f47742a, aVarArr[i10].f47743b);
            c10 = aVarArr[i10].f47742a;
        }
    }
    ...
    public void e(a aVar, a aVar2, float f10) {
        int i10 = 0;
        while (true) {
            float[] fArr = aVar.f47743b;
            if (i10 >= fArr.length) {
                return;
            }
            this.f47743b[i10] = (fArr[i10] * (1.0f - f10)) + (aVar2.f47743b[i10] * f10);
            i10++;
        }
    }

    public a(a aVar) {
        this.f47742a = aVar.f47742a;
        float[] fArr = aVar.f47743b;
        this.f47743b = b.d(fArr, 0, fArr.length);
    }
}
