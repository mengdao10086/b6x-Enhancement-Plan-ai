...
@Route(path = a.i.f31989d)
public final class AboutPhoneActivity extends p {
    ...
    public void onCreate(@l Bundle bundle) {
        ...
        e4();
        this.C1.setText(R.string.app_action_title_about_phone);
        Fragment fragmentA = d0.A(n3(), AboutPhoneFragment.class);
        if (fragmentA == null) {
            fragmentA = AboutPhoneFragment.B8.a();
        }
