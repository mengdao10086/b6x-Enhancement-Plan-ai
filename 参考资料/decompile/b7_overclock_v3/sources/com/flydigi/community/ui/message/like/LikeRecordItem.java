...
public final class LikeRecordItem extends AbstractModelItem<MyMessageBean.Message, a> {
    ...
    public static final class a extends gi.d {
        ...
        public final void v(@k ImageView imageView) {
            f0.p(imageView, "<set-?>");
            this.f13936g = imageView;
        }

        public final void w(@k TextView textView) {
            f0.p(textView, "<set-?>");
            this.f13937h = textView;
        }
        ...
        public final void y(@k TextView textView) {
            f0.p(textView, "<set-?>");
            this.f13938i = textView;
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LikeRecordItem(@k MyMessageBean.Message data) {
        super(data);
        f0.p(data, "data");
    }
