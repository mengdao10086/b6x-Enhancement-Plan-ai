...
@kotlin.jvm.internal.t0({"SMAP\nCloudConfigItem.kt\nKotlin\n*S Kotlin\n*F\n+ 1 CloudConfigItem.kt\ncom/flydigi/device_manager/ui/sync/CloudConfigItem\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,78:1\n1#2:79\n*E\n"})
public final class CloudConfigItem extends AbstractModelItem<CloudConfigBean, a> {
    ...
    public static final class a extends gi.d {
        ...
        public a(@yt.k View view, @yt.k eu.davidea.flexibleadapter.b<? extends ei.h<RecyclerView.e0>> adapter) {
            ...
            this.f15390g = s1VarA;
            ImageButton imageButton = s1VarA.f10452g;
            kotlin.jvm.internal.f0.o(imageButton, "binding.ivRename");
            o5.c.b(imageButton, Boolean.FALSE, false, 2, null);
        ...
        public void q() {
            ...
            this.f15390g.f10447b.setImageResource(zB ? R.drawable.ic_check_yes : R.drawable.ic_check_no);
        }
    ...
    public /* synthetic */ CloudConfigItem(CloudConfigBean cloudConfigBean, boolean z10, int i10, kotlin.jvm.internal.u uVar) {
        this(cloudConfigBean, (i10 & 2) != 0 ? false : z10);
    }
    ...
    public void o(@yt.k eu.davidea.flexibleadapter.b<ei.h<RecyclerView.e0>> adapter, @yt.k a holder, int i10, @yt.k List<Object> payloads) {
        ...
        holder.r().f10455j.setText(z().title);
        int i11 = z().version;
        holder.r().f10451f.setImageResource(i11 != 1 ? i11 != 2 ? i11 != 3 ? R.drawable.main_ic_device_game_pad_gray : R.drawable.main_ic_device_game_pad_half_gray : R.drawable.main_ic_device_keyboard_mouse_gray : R.drawable.main_ic_device_game_pad_gray);
        holder.r().f10453h.setImageResource(R.drawable.main_ic_download_white);
        v(adapter.t() == 2);
        ...
        holder.r().f10449d.setCanLeftSwipe((this.shareMode || k()) ? false : true);
        holder.r().f10449d.setCanRightSwipe((this.shareMode || k()) ? false : true);
        holder.r().f10449d.g();
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CloudConfigItem(@yt.k CloudConfigBean data, boolean z10) {
        super(data);
