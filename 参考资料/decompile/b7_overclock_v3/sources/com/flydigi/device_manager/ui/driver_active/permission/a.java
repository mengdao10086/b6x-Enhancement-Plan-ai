...
public final class a implements d {
    ...
    @yt.k
    public static final List<j> f14905b = CollectionsKt__CollectionsKt.E();
    ...
    public List<j> b() {
        ...
        String string3 = j1.a().getString(R.string.device_driver_active_permission_enable_developer_option_content_click_build_number_blackshark);
        f0.o(string3, "getApp()\n               …_build_number_blackshark)");
        return CollectionsKt__CollectionsKt.L(new j(str, string, R.drawable.device_driver_active_my_device_blackshark), new j("", string2, R.drawable.device_driver_active_about_phone_miui), new j("", string3, R.drawable.device_driver_active_build_number_blackshark));
    }
