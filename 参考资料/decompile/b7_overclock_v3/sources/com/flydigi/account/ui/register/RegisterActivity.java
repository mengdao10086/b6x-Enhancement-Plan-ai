...
@Route(path = a.C0378a.f31906c)
public final class RegisterActivity extends p {
    ...
    public void onCreate(@l Bundle bundle) {
        ...
        aVar.a(mTVTitle, R.string.account_register);
        if (a4(RegisterFragment.class.getSimpleName()) == null) {
            d0.v0(n3(), RegisterFragment.o6(), R.id.fl_container);
        }
    }
}
