...
public abstract class MultiTypeDelegate<T> {
    ...
    private void addItemType(int i10, @i0 int i11) {
    ...
    public MultiTypeDelegate registerItemType(int i10, @i0 int i11) {
        this.selfMode = true;
    ...
    public MultiTypeDelegate registerItemTypeAutoIncrease(@i0 int... iArr) {
        this.autoMode = true;
