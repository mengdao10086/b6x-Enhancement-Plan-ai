...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.g<K> {
    ...
    public BaseQuickAdapter(@i0 int i10, @p0 List<T> list) {
    ...
    private void addAnimation(RecyclerView.e0 e0Var) {
        if (this.mOpenAnimationEnable) {
            if (!this.mFirstOnlyEnable || e0Var.getLayoutPosition() > this.mLastPosition) {
                ...
                for (Animator animator : baseAnimation.getAnimators(e0Var.itemView)) {
    ...
    private K getLoadingView(ViewGroup viewGroup) {
        K k10 = (K) createBaseViewHolder(getItemView(this.mLoadMoreView.getLayoutId(), viewGroup));
        k10.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.chad.library.adapter.base.BaseQuickAdapter.3
    ...
    private int recursiveCollapse(@f0(from = 0) int i10) {
        T item = getItem(i10);
        ...
        for (int i11 = i10 + 1; i11 < size; i11++) {
            T t10 = this.mData.get(i11);
            if ((t10 instanceof IExpandable) && ((IExpandable) t10).getLevel() <= level) {
                break;
            }
            arrayList.add(t10);
        }
    ...
    private int recursiveExpand(int i10, @n0 List list) {
        int size = list.size();
    ...
    @Deprecated
    public void add(@f0(from = 0) int i10, @n0 T t10) {
        addData(i10, t10);
    }

    public void addData(@f0(from = 0) int i10, @n0 T t10) {
    ...
    public void bindViewClickListener(final K k10) {
        if (k10 == null) {
            return;
        }
    ...
    public int collapse(@f0(from = 0) int i10, boolean z10, boolean z11) {
    ...
    public abstract void convert(@n0 K k10, T t10);

    public void convertPayloads(@n0 K k10, T t10, @n0 List<Object> list) {
    }

    public K createBaseViewHolder(ViewGroup viewGroup, int i10) {
        return (K) createBaseViewHolder(getItemView(i10, viewGroup));
    }
    ...
    public int expand(@f0(from = 0) int i10, boolean z10, boolean z11) {
        int headerLayoutCount = i10 - getHeaderLayoutCount();
        IExpandable expandableItem = getExpandableItem(headerLayoutCount);
        ...
        if (!expandableItem.isExpanded()) {
            ...
            this.mData.addAll(i11, subItems);
            iRecursiveExpand = 0 + recursiveExpand(i11, subItems);
            expandableItem.setExpanded(true);
        }
        int headerLayoutCount2 = headerLayoutCount + getHeaderLayoutCount();
        if (z11) {
    ...
    public int expandAll(int i10, boolean z10, boolean z11) {
        ...
        while (i11 < this.mData.size() && ((item = getItem(i11)) == null || !item.equals(item2))) {
            if (isExpandable(item)) {
                iExpand += expand(getHeaderLayoutCount() + i11, false, false);
            }
            i11++;
        }
        if (z11) {
    ...
    public View getItemView(@i0 int i10, ViewGroup viewGroup) {
    ...
    public int getItemViewType(int i10) {
        ...
        if (i11 - size < getFooterLayoutCount()) {
            return FOOTER_VIEW;
        }
        return 546;
    }
    ...
    public int getParentPosition(@n0 T t10) {
    ...
    @p0
    public View getViewByPosition(int i10, @d0 int i11) {
        checkNotNull();
    ...
    public void onAttachedToRecyclerView(@n0 RecyclerView recyclerView) {
        ...
        if (layoutManager instanceof GridLayoutManager) {
            ...
            final GridLayoutManager.c cVarL3 = gridLayoutManager.L3();
            gridLayoutManager.R3(new GridLayoutManager.c() { // from class: com.chad.library.adapter.base.BaseQuickAdapter.4
                ...
                public int getSpanSize(int i10) {
                    ...
                    return BaseQuickAdapter.this.mSpanSizeLookup == null ? BaseQuickAdapter.this.isFixedViewType(itemViewType) ? gridLayoutManager.H3() : cVarL3.getSpanSize(i10) : BaseQuickAdapter.this.isFixedViewType(itemViewType) ? gridLayoutManager.H3() : BaseQuickAdapter.this.mSpanSizeLookup.getSpanSize(gridLayoutManager, i10 - BaseQuickAdapter.this.getHeaderLayoutCount());
                }
            });
        }
    }
    ...
    public void setData(@f0(from = 0) int i10, @n0 T t10) {
    ...
    public void setFullSpan(RecyclerView.e0 e0Var) {
        if (e0Var.itemView.getLayoutParams() instanceof StaggeredGridLayoutManager.c) {
            ((StaggeredGridLayoutManager.c) e0Var.itemView.getLayoutParams()).M(true);
        }
    }
    ...
    public K createBaseViewHolder(View view) {
        ...
        K k10 = instancedGenericKClass == null ? (K) new BaseViewHolder(view) : (K) createGenericKInstance(instancedGenericKClass, view);
    ...
    @Override // androidx.recyclerview.widget.RecyclerView.g
    public /* bridge */ /* synthetic */ void onBindViewHolder(@n0 RecyclerView.e0 e0Var, int i10, @n0 List list) {
        onBindViewHolder((BaseViewHolder) e0Var, i10, (List<Object>) list);
    }

    @Override // androidx.recyclerview.widget.RecyclerView.g
    @n0
    public K onCreateViewHolder(@n0 ViewGroup viewGroup, int i10) {
        K k10;
        ...
        if (i10 == 273) {
            ...
            k10 = (K) createBaseViewHolder(this.mHeaderLayout);
        } else if (i10 == 546) {
            k10 = (K) getLoadingView(viewGroup);
        } else if (i10 == 819) {
            ViewParent parent2 = this.mFooterLayout.getParent();
            if (parent2 instanceof ViewGroup) {
                ((ViewGroup) parent2).removeView(this.mFooterLayout);
            }
            k10 = (K) createBaseViewHolder(this.mFooterLayout);
        } else if (i10 != 1365) {
            k10 = (K) onCreateDefViewHolder(viewGroup, i10);
            ...
            k10 = (K) createBaseViewHolder(this.mEmptyLayout);
        }
        k10.setAdapter(this);
        return k10;
    }
    ...
    @Override // androidx.recyclerview.widget.RecyclerView.g
    public void onViewAttachedToWindow(@n0 K k10) {
    ...
    public final void refreshNotifyItemChanged(int i10, @p0 Object obj) {
        notifyItemChanged(i10 + getHeaderLayoutCount(), obj);
    }
    ...
    public void setNewDiffData(@n0 BaseQuickDiffCallback<T> baseQuickDiffCallback, boolean z10) {
        if (getEmptyViewCount() == 1) {
            setNewData(baseQuickDiffCallback.getNewList());
            return;
        }
        baseQuickDiffCallback.setOldList(getData());
        i.b(baseQuickDiffCallback, z10).f(new BaseQuickAdapterListUpdateCallback(this));
    ...
    @p0
    public View getViewByPosition(RecyclerView recyclerView, int i10, @d0 int i11) {
    ...
    public void addData(@f0(from = 0) int i10, @n0 Collection<? extends T> collection) {
    ...
    public void setNewDiffData(@n0 i.c cVar, @n0 List<T> list) {
        if (getEmptyViewCount() == 1) {
            setNewData(list);
        } else {
            cVar.f(new BaseQuickAdapterListUpdateCallback(this));
            this.mData = list;
        }
    }

    public int collapse(@f0(from = 0) int i10) {
        return collapse(i10, true, true);
    }

    public void onBindViewHolder(@n0 K k10, int i10, @n0 List<Object> list) {
        if (list.isEmpty()) {
            onBindViewHolder((BaseViewHolder) k10, i10);
            return;
        }
        autoUpFetch(i10);
        autoLoadMore(i10);
        int itemViewType = k10.getItemViewType();
        if (itemViewType == 0) {
            convertPayloads(k10, getItem(i10 - getHeaderLayoutCount()), list);
            return;
        }
        if (itemViewType != 273) {
            if (itemViewType == 546) {
    ...
    public int collapse(@f0(from = 0) int i10, boolean z10) {
    ...
    public int expand(@f0(from = 0) int i10, boolean z10) {
        return expand(i10, z10, true);
    }

    public int expand(@f0(from = 0) int i10) {
