...
public final class d {
    ...
    @yt.k
    public final b f22106b;

    public d(@yt.k t pb2, @yt.k b chainTask) {
        f0.p(pb2, "pb");
        f0.p(chainTask, "chainTask");
        this.f22105a = pb2;
        this.f22106b = chainTask;
    }
    ...
    public final void a(@yt.k RationaleDialogFragment dialogFragment) {
        ...
        this.f22105a.K(this.f22106b, false, dialogFragment);
    }

    public final void b(@yt.k eg.c dialog) {
        f0.p(dialog, "dialog");
        this.f22105a.L(this.f22106b, false, dialog);
    }
    ...
    public final void d(@yt.k List<String> permissions, @yt.k String message, @yt.k String positiveText, @yt.l String str) {
        ...
        f0.p(message, "message");
        f0.p(positiveText, "positiveText");
        this.f22105a.M(this.f22106b, false, permissions, message, positiveText, str);
    }
}
