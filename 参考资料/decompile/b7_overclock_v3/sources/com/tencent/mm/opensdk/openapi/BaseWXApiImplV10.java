...
class BaseWXApiImplV10 implements IWXAPI {
    ...
    public BaseWXApiImplV10(Context context, String str, boolean z10, int i10) {
        ...
        this.launchMode = i10;
        b.f22597a = context.getApplicationContext();
    }
    ...
    private boolean handleWxInternalRespType(String str, IWXAPIEventHandler iWXAPIEventHandler) {
        ...
        if (queryParameter.equals("subscribemessage")) {
            ...
            String queryParameter2 = uri.getQueryParameter(UMTencentSSOHandler.RET);
        ...
        if (queryParameter.contains("invoice_auth_insert")) {
            ...
            String queryParameter3 = uri.getQueryParameter(UMTencentSSOHandler.RET);
        ...
        if (queryParameter.contains("payinsurance")) {
            ...
            String queryParameter4 = uri.getQueryParameter(UMTencentSSOHandler.RET);
        ...
        if (queryParameter.contains("nontaxpay")) {
            ...
            String queryParameter5 = uri.getQueryParameter(UMTencentSSOHandler.RET);
        ...
        String queryParameter6 = uri.getQueryParameter(UMTencentSSOHandler.RET);
        ...
        resp5.nickname = uri.getQueryParameter(UMTencentSSOHandler.NICKNAME);
    ...
    private boolean sendOpenBusinessWebview(Context context, BaseReq baseReq) {
        ...
        Cursor cursorQuery = contentResolver.query(uri, null, null, new String[]{this.appId, req.businessType + "", (map == null || map.size() <= 0) ? "" : new JSONObject(req.queryInfo).toString()}, null);
        if (cursorQuery != null) {
            cursorQuery.close();
        }
        return true;
    ...
    public int getWXAppSupportAPI() {
        ...
        b.f22601e.submit(new Runnable() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.1
                    ...
                    if (str != null && str.contains("openbusinesswebview")) {
                        try {
                            ...
                            if (uri != null && "openbusinesswebview".equals(uri.getHost())) {
                                ...
                                String queryParameter = uri.getQueryParameter(UMTencentSSOHandler.RET);
    ...
    public boolean registerApp(String str, long j10) {
        ...
        c0244a.f22556a = "com.tencent.mm";
        c0244a.f22557b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c0244a.f22558c = "weixin://registerapp?appid=" + this.appId;
        c0244a.f22559d = j10;
        return a.a(this.context, c0244a);
    }
    ...
    public void unregisterApp() {
        ...
        a.C0244a c0244a = new a.C0244a();
        c0244a.f22556a = "com.tencent.mm";
        c0244a.f22557b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        c0244a.f22558c = "weixin://unregisterapp?appid=" + this.appId;
        a.a(this.context, c0244a);
    }
}
