...
public class a {
    ...
    public static final Uri f22662a = Uri.parse("content://telephony/carriers/preferapn");
    ...
    public static String c(Context context) {
        try {
            Cursor cursorQuery = context.getContentResolver().query(f22662a, null, null, null, null);
            if (cursorQuery == null) {
                return null;
            }
