...
public class IM extends BaseApi {
    ...
    public int startIMConversation(Activity activity, String str, String str2, String str3) {
        ...
        if (k.d(activity)) {
            ...
            intent.setData(Uri.parse(String.format("mqqapi://im/chat?chat_type=%1$s&uin=%2$s&version=1&src_type=app&open_id=%3$s&app_id=%4$s&app_pkg_name=%5$s", str, str2, k.l(this.f22519c.getOpenId()), k.l(this.f22519c.getAppId()), k.l(str3))));
