...
public class SocialOperation extends BaseApi {
    ...
    public void bindQQGroup(final Activity activity, String str, String str2, final IUiListener iUiListener) {
        ...
        stringBuffer.append("&openid=" + Base64.encodeToString(k.j(openId), 2));
        stringBuffer.append("&appid=" + Base64.encodeToString(k.j(appId), 2));
        ...
        DefaultUiListener defaultUiListener = new DefaultUiListener() { // from class: com.tencent.open.SocialOperation.3
            ...
            public void onComplete(Object obj) {
                ...
                try {
                    ...
                    SLog.e("openSDK_LOG.GameAppOperation", "-->bind group, start activity exception.", e10);
        ...
        Bundle bundleA = a();
        bundleA.putString("appid", appId);
        bundleA.putString("orgid", str);
        HttpUtils.requestAsync(this.f22519c, activity, "https://openmobile.qq.com/cgi-bin/qunopensdk/check_group", bundleA, Constants.HTTP_GET, new BaseApi.TempRequestListener(defaultUiListener));
        ...
        DefaultUiListener defaultUiListener = new DefaultUiListener() { // from class: com.tencent.open.SocialOperation.2
            ...
            public void onComplete(Object obj) {
                ...
                try {
                    ...
                    SLog.e("openSDK_LOG.GameAppOperation", "-->join group, start activity exception.", e10);
                    SocialOperation.this.a(activity);
                }
            }
    ...
    public void makeFriend(Activity activity, Bundle bundle) {
        ...
        if (bundle == null) {
            ...
            e.a().a(this.f22519c.getOpenId(), this.f22519c.getAppId(), Constants.VIA_MAKE_FRIEND, Constants.VIA_REPORT_TYPE_MAKE_FRIEND, "18", "1");
            return;
        }
        ...
        sb2.append("&fopen_id=");
        sb2.append(Base64.encodeToString(k.j(string), 2));
        ...
        intent.setData(Uri.parse(stringBuffer.toString()));
        if (!a(intent) || k.f(activity, eu.davidea.flexibleadapter.a.f27244f)) {
            ...
            try {
                ...
                e.a().a(this.f22519c.getOpenId(), this.f22519c.getAppId(), Constants.VIA_MAKE_FRIEND, Constants.VIA_REPORT_TYPE_MAKE_FRIEND, "18", "0");
            } catch (Exception e10) {
                SLog.e("openSDK_LOG.GameAppOperation", "-->make friend, start activity exception.", e10);
                a(activity);
                e.a().a(this.f22519c.getOpenId(), this.f22519c.getAppId(), Constants.VIA_MAKE_FRIEND, Constants.VIA_REPORT_TYPE_MAKE_FRIEND, "18", "1");
            }
        }
    ...
    public void unBindGroup(Context context, String str, final IUiListener iUiListener) {
        ...
        bundleA.putString("appid", appId);
        bundleA.putString("orgid", str);
        HttpUtils.requestAsync(this.f22519c, context, "https://openmobile.qq.com/cgi-bin/qunopensdk/unbind", bundleA, Constants.HTTP_GET, new BaseApi.TempRequestListener(defaultUiListener));
    ...
    private void a(Activity activity, String str) {
        new TDialog(activity, "", a(str), null, this.f22519c).show();
    }
}
