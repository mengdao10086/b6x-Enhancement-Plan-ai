...
public class UIListenerManager {
    ...
    private static UIListenerManager f22525a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private Map<String, ApiTask> f22526b;
    ...
    private UIListenerManager() {
        ...
        this.f22526b = mapSynchronizedMap;
        if (mapSynchronizedMap == null) {
            this.f22526b = Collections.synchronizedMap(new HashMap());
        }
    }
    ...
    public IUiListener getListnerWithAction(String str) {
        ...
        synchronized (this.f22526b) {
            apiTask = this.f22526b.get(str);
            this.f22526b.remove(str);
        }
        if (apiTask == null) {
            return null;
        }
    ...
    public Object setListenerWithRequestcode(int i10, IUiListener iUiListener) {
        ...
        synchronized (this.f22526b) {
            apiTaskPut = this.f22526b.put(strA, new ApiTask(i10, iUiListener));
        }
        if (apiTaskPut == null) {
            return null;
        }
    ...
    public Object setListnerWithAction(String str, IUiListener iUiListener) {
        ...
        synchronized (this.f22526b) {
            apiTaskPut = this.f22526b.put(str, new ApiTask(iA, iUiListener));
        }
        if (apiTaskPut == null) {
            return null;
        }
