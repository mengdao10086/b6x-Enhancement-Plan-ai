...
public class UserInfo extends BaseApi {
    ...
    public void getOpenId(IUiListener iUiListener) {
        HttpUtils.requestAsync(this.f22519c, f.a(), GRAPH_OPEN_ID, a(), Constants.HTTP_GET, new BaseApi.TempRequestListener(iUiListener));
    }

    public void getUserInfo(IUiListener iUiListener) {
        HttpUtils.requestAsync(this.f22519c, f.a(), "user/get_simple_userinfo", a(), Constants.HTTP_GET, new BaseApi.TempRequestListener(iUiListener));
    }
