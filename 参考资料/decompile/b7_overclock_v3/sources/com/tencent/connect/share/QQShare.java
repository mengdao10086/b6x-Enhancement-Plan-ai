...
public class QQShare extends BaseApi {
    ...
    public void d(Activity activity, Bundle bundle, IUiListener iUiListener) {
        ...
        String openIdWithCache = this.f22519c.getOpenIdWithCache();
        ...
        stringBuffer.append("&req_type=" + Base64.encodeToString(k.j(String.valueOf(i12)), 2));
        ...
        stringBuffer.append("&cflag=" + Base64.encodeToString(k.j(String.valueOf(i13)), 2));
        ...
        com.tencent.connect.a.a.a(f.a(), this.f22519c, "requireApi", "shareToNativeQQ");
        ...
        String str4 = i11 == i10 ? Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE : Constants.VIA_REPORT_TYPE_SHARE_TO_QQ;
        if (a(intent)) {
            e.a().a(this.f22519c.getOpenId(), this.f22519c.getAppId(), Constants.VIA_SHARE_TO_QQ, str4, "3", "0", this.mViaShareQQType, "0", "1", "0");
            e.a().a(0, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.f22519c.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "");
        } else {
            e.a().a(this.f22519c.getOpenId(), this.f22519c.getAppId(), Constants.VIA_SHARE_TO_QQ, str4, "3", "1", this.mViaShareQQType, "0", "1", "0");
            e.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.f22519c.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "hasActivityForIntent fail");
        }
    ...
    public void shareToQQ(Activity activity, Bundle bundle, IUiListener iUiListener) {
        ...
        SLog.i("openSDK_LOG.QQShare", "shareToQQ -- type: " + i11);
        if (i11 == 1) {
        ...
        if (!k.a() && k.f(activity, "4.5.0")) {
            ...
            e.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.f22519c.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "shareToQQ sdcard is null");
            return;
        }
        if (i11 == 5) {
            if (k.f(activity, "4.3.0")) {
                ...
                e.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.f22519c.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "shareToQQ, version below 4.3 is not support.");
                return;
            } else if (!k.i(string5)) {
                iUiListener.onError(new UiError(-6, Constants.MSG_PARAM_IMAGE_URL_FORMAT_ERROR, null));
                SLog.e("openSDK_LOG.QQShare", "shareToQQ -- error: 非法的图片地址!");
                e.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.f22519c.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, Constants.MSG_PARAM_IMAGE_URL_FORMAT_ERROR);
                return;
            }
        }
        if (i11 != 5) {
            i10 = 7;
            if (i11 != 7) {
                if (TextUtils.isEmpty(string4) || !(string4.startsWith(DefaultWebClient.f21814v) || string4.startsWith(DefaultWebClient.f21815w))) {
                    ...
                    e.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.f22519c.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "shareToQQ, targetUrl is empty or illegal..");
                    return;
                } else {
                    if (TextUtils.isEmpty(string2)) {
                        iUiListener.onError(new UiError(-6, Constants.MSG_PARAM_TITLE_NULL_ERROR, null));
                        SLog.e("openSDK_LOG.QQShare", "shareToQQ, title is empty.");
                        e.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.f22519c.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "shareToQQ, title is empty.");
                        return;
                    }
                    i10 = 7;
                }
        ...
        if (i11 == i10) {
            if (TextUtils.isEmpty(string6) || TextUtils.isEmpty(string7) || TextUtils.isEmpty(string4) || TextUtils.isEmpty(this.f22519c.getAppId())) {
        ...
        if (!TextUtils.isEmpty(string) && !string.startsWith(DefaultWebClient.f21814v) && !string.startsWith(DefaultWebClient.f21815w) && !new File(string).exists()) {
            iUiListener.onError(new UiError(-6, Constants.MSG_PARAM_IMAGE_URL_FORMAT_ERROR, null));
            SLog.e("openSDK_LOG.QQShare", "shareToQQ, image url is emprty or illegal.");
            e.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.f22519c.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "shareToQQ, image url is emprty or illegal.");
            return;
        }
        ...
        if (k.a(activity, bundle2.getInt("cflag", 0) == 1)) {
            ...
            try {
                ...
                new TDialog(activity, "", a(""), null, this.f22519c).show();
            } catch (RuntimeException e10) {
                SLog.e("openSDK_LOG.QQShare", " shareToQQ, TDialog.show not in main thread", e10);
                e10.printStackTrace();
                ...
                a.a(activity, string, new d() { // from class: com.tencent.connect.share.QQShare.2
                    ...
                    public void a(int i10, String str) {
                        if (i10 == 0) {
                            ...
                            e.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, QQShare.this.f22519c.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, Constants.MSG_SHARE_GETIMG_ERROR);
                            return;
                        }
