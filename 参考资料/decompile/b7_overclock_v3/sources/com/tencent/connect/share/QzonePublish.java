    ...
    */
    ...
    public void publishToQzone(final Activity activity, final Bundle bundle, final IUiListener iUiListener) {
        ...
        if (bundle == null) {
            ...
            e.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.f22519c.getAppId(), String.valueOf(4), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, Constants.MSG_PARAM_NULL_ERROR);
            return;
        }
        if (!k.f(activity)) {
            ...
            e.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.f22519c.getAppId(), String.valueOf(4), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "publicToQzone, this is not support below qq 5.9.5");
        ...
        if (i11 == 3) {
            ...
            if (stringArrayList != null && stringArrayList.size() > 0) {
                while (i10 < stringArrayList.size()) {
                    if (!k.i(stringArrayList.get(i10))) {
        ...
        if (i11 != 4) {
            ...
            e.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.f22519c.getAppId(), String.valueOf(4), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "publishToQzone() 请选择支持的分享类型");
            return;
        }
