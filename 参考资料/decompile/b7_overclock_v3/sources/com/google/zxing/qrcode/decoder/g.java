...
public final class g {
    ...
    public static final int[] f21607e = {31892, 34236, 39577, 42195, 48118, 51042, 55367, 58893, 63784, 68472, 70749, 76311, 79154, 84390, 87683, 92361, 96236, 102084, 102881, 110507, 110734, 117786, 119615, 126325, 127568, 133589, 136944, 141498, 145311, 150283, 152622, 158308, 161089, 167017};

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    public static final g[] f21608f = b();
    ...
    public g(int i10, int[] iArr, b... bVarArr) {
        this.f21609a = i10;
        this.f21610b = iArr;
        this.f21611c = bVarArr;
        int iB = bVarArr[0].b();
        int iA = 0;
    ...
    public static g g(int i10) throws FormatException {
        if (i10 % 4 != 1) {
    ...
    public static g i(int i10) {
        ...
        return f21608f[i10 - 1];
    }

    public af.b a() {
        int iE = e();
        af.b bVar = new af.b(iE);
        bVar.t(0, 0, 9, 9);
        int i10 = iE - 8;
        bVar.t(i10, 0, 8, 9);
        bVar.t(0, i10, 9, 8);
        int length = this.f21610b.length;
        for (int i11 = 0; i11 < length; i11++) {
            int i12 = this.f21610b[i11] - 2;
            for (int i13 = 0; i13 < length; i13++) {
                if ((i11 != 0 || (i13 != 0 && i13 != length - 1)) && (i11 != length - 1 || i13 != 0)) {
                    bVar.t(this.f21610b[i13] - 2, i12, 5, 5);
                }
            }
        }
        int i14 = iE - 17;
    ...
    public int e() {
        return (this.f21609a * 4) + 17;
    }

    public b f(ErrorCorrectionLevel errorCorrectionLevel) {
        return this.f21611c[errorCorrectionLevel.ordinal()];
    }
    ...
    public String toString() {
        return String.valueOf(this.f21609a);
    }
}
