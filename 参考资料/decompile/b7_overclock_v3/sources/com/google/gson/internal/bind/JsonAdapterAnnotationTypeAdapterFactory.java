...
public final class JsonAdapterAnnotationTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public TypeAdapter<?> getTypeAdapter(ConstructorConstructor constructorConstructor, Gson gson, TypeToken<?> typeToken, JsonAdapter jsonAdapter) {
        ...
        if (objConstruct instanceof TypeAdapter) {
            ...
            boolean z10 = objConstruct instanceof JsonSerializer;
            if (!z10 && !(objConstruct instanceof JsonDeserializer)) {
            ...
            treeTypeAdapter = new TreeTypeAdapter<>(z10 ? (JsonSerializer) objConstruct : null, objConstruct instanceof JsonDeserializer ? (JsonDeserializer) objConstruct : null, gson, typeToken, null, zNullSafe);
            zNullSafe = false;
        }
