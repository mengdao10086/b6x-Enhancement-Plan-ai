...
public final class Gson {
    ...
    public <T> TypeAdapter<T> getAdapter(TypeToken<T> typeToken) {
        ...
        try {
            ...
            while (it2.hasNext()) {
                TypeAdapter<T> typeAdapterCreate = it2.next().create(this, typeToken);
                if (typeAdapterCreate != null) {
                    TypeAdapter<T> typeAdapter2 = (TypeAdapter) this.typeTokenCache.putIfAbsent(typeToken, typeAdapterCreate);
                    if (typeAdapter2 != null) {
                        typeAdapterCreate = typeAdapter2;
                    }
    ...
    public JsonWriter newJsonWriter(Writer writer) throws IOException {
        ...
        if (this.prettyPrinting) {
            jsonWriter.setIndent(GlideException.a.f12263d);
        }
    ...
    public String toString() {
        return "{serializeNulls:" + this.serializeNulls + ",factories:" + this.factories + ",instanceCreators:" + this.constructorConstructor + a.f58317e;
    }
    ...
    public <T> T fromJson(Reader reader, TypeToken<T> typeToken) throws JsonSyntaxException, JsonIOException {
        ...
        T t10 = (T) fromJson(jsonReaderNewJsonReader, typeToken);
        ...
        try {
            try {
                try {
                    jsonReader.peek();
                    z10 = false;
                    T t10 = getAdapter(typeToken).read(jsonReader);
