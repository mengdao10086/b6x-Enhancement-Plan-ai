...
public final class Hashing {
    ...
    public static class Sha1Holder {
        public static final HashFunction SHA_1 = new MessageDigestHashFunction(e.f27137f, "Hashing.sha1()");
    ...
    public static class Sha384Holder {
        public static final HashFunction SHA_384 = new MessageDigestHashFunction(e.f27140i, "Hashing.sha384()");
    ...
    public static HashCode combineOrdered(Iterable<HashCode> iterable) {
        ...
        while (it3.hasNext()) {
            ...
            for (int i10 = 0; i10 < bArrAsBytes.length; i10++) {
                bArr[i10] = (byte) ((bArr[i10] * a.X) ^ bArrAsBytes[i10]);
            }
        }
        return HashCode.fromBytesNoCopy(bArr);
    }
    ...
    public static HashFunction goodFastHash(int i10) {
        int iCheckPositiveAndMakeMultipleOf32 = checkPositiveAndMakeMultipleOf32(i10);
        ...
        int i11 = (iCheckPositiveAndMakeMultipleOf32 + 127) / 128;
    ...
    public static HashFunction hmacSha1(Key key) {
        return new MacHashFunction(c.f31295a, key, hmacToString("hmacSha1", key));
    }
    ...
    public static int consistentHash(long j10, int i10) {
        ...
        while (true) {
            int iNextDouble = (int) (((double) (i11 + 1)) / linearCongruentialGenerator.nextDouble());
            if (iNextDouble < 0 || iNextDouble >= i10) {
                break;
            }
            i11 = iNextDouble;
        }
    ...
    public static HashFunction hmacSha1(byte[] bArr) {
        return hmacSha1(new SecretKeySpec((byte[]) Preconditions.checkNotNull(bArr), c.f31295a));
    }
