...
public final class LinkedHashMultimap<K, V> extends LinkedHashMultimapGwtSerializationDependencies<K, V> {
    ...
    public static final class ValueEntry<K, V> extends ImmutableEntry<K, V> implements ValueSetLink<K, V> {
        ...
        public boolean matchesValue(@NullableDecl Object obj, int i10) {
            return this.smearedValueHash == i10 && Objects.equal(getValue(), obj);
        }
    ...
    public final class ValueSet extends Sets.ImprovedAbstractSet<V> implements ValueSetLink<K, V> {
        ...
        public ValueSet(K k10, int i10) {
            this.key = k10;
            this.hashTable = new ValueEntry[Hashing.closedTableSize(i10, 1.0d)];
        }
        ...
        public boolean add(@NullableDecl V v10) {
            ...
            for (ValueEntry<K, V> valueEntry2 = valueEntry; valueEntry2 != null; valueEntry2 = valueEntry2.nextInValueBucket) {
                if (valueEntry2.matchesValue(v10, iSmearedHash)) {
                    return false;
                }
            }
            ValueEntry<K, V> valueEntry3 = new ValueEntry<>(this.key, v10, iSmearedHash, valueEntry);
    ...
    private void readObject(ObjectInputStream objectInputStream) throws ClassNotFoundException, IOException {
        ...
        for (int i13 = 0; i13 < i12; i13++) {
            ...
            ((Collection) mapNewLinkedHashMapWithExpectedSize.get(object2)).add(objectInputStream.readObject());
        }
