...
public final class Multisets {
    ...
    public static final class FilteredMultiset<E> extends ViewMultiset<E> {
        ...
        public int add(@NullableDecl E e10, int i10) {
            Preconditions.checkArgument(this.predicate.apply(e10), "Element %s does not match predicate %s", e10, this.predicate);
    ...
    public static class ImmutableEntry<E> extends AbstractEntry<E> implements Serializable {
        ...
        public ImmutableEntry(@NullableDecl E e10, int i10) {
            this.element = e10;
            this.count = i10;
    ...
    public static <E> Multiset<E> difference(final Multiset<E> multiset, final Multiset<?> multiset2) {
        ...
        return new ViewMultiset<E>() { // from class: com.google.common.collect.Multisets.4
            ...
            @Override // com.google.common.collect.AbstractMultiset
            public Iterator<E> elementIterator() {
                final Iterator<Multiset.Entry<E>> it2 = multiset.entrySet().iterator();
                return new AbstractIterator<E>() { // from class: com.google.common.collect.Multisets.4.1
                    ...
                    public E computeNext() {
                        while (it2.hasNext()) {
                            ...
                            if (entry.getCount() > multiset2.count(e10)) {
                                return e10;
                            }
                        }
                        return endOfData();
    ...
    public static boolean removeOccurrences(Multiset<?> multiset, Iterable<?> iterable) {
        ...
        while (it2.hasNext()) {
            zRemove |= multiset.remove(it2.next());
        }
        return zRemove;
    }
    ...
    public static <E> int setCountImpl(Multiset<E> multiset, E e10, int i10) {
        CollectPreconditions.checkNonnegative(i10, a.C);
        int iCount = multiset.count(e10);
        int i11 = i10 - iCount;
        if (i11 > 0) {
    ...
    public static <E> boolean setCountImpl(Multiset<E> multiset, E e10, int i10, int i11) {
