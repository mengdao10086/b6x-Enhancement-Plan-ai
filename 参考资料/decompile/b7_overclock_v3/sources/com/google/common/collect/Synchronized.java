...
final class Synchronized {
    ...
    public static class SynchronizedBiMap<K, V> extends SynchronizedMap<K, V> implements BiMap<K, V>, Serializable {
        ...
        public V forcePut(K k10, V v10) {
            V vForcePut;
            synchronized (this.mutex) {
                vForcePut = delegate().forcePut(k10, v10);
            }
            return vForcePut;
        }
    ...
    public static class SynchronizedList<E> extends SynchronizedCollection<E> implements List<E> {
        ...
        public boolean addAll(int i10, Collection<? extends E> collection) {
            boolean zAddAll;
            synchronized (this.mutex) {
                zAddAll = delegate().addAll(i10, collection);
            }
            return zAddAll;
        }
    ...
    public static class SynchronizedListMultimap<K, V> extends SynchronizedMultimap<K, V> implements ListMultimap<K, V> {
        ...
        public List<V> get(K k10) {
            List<V> list;
            synchronized (this.mutex) {
                list = Synchronized.list(delegate().get((Object) k10), this.mutex);
            }
            return list;
        }
        ...
        public List<V> replaceValues(K k10, Iterable<? extends V> iterable) {
            ...
            synchronized (this.mutex) {
                listReplaceValues = delegate().replaceValues((Object) k10, (Iterable) iterable);
            }
    ...
    public static class SynchronizedMultimap<K, V> extends SynchronizedObject implements Multimap<K, V> {
        ...
        public Collection<V> get(K k10) {
            Collection<V> collectionTypePreservingCollection;
            synchronized (this.mutex) {
                collectionTypePreservingCollection = Synchronized.typePreservingCollection(delegate().get(k10), this.mutex);
            }
            return collectionTypePreservingCollection;
        }
        ...
        public boolean putAll(K k10, Iterable<? extends V> iterable) {
            boolean zPutAll;
            synchronized (this.mutex) {
                zPutAll = delegate().putAll(k10, iterable);
            }
            return zPutAll;
        }
        ...
        public Collection<V> replaceValues(K k10, Iterable<? extends V> iterable) {
            ...
            synchronized (this.mutex) {
                collectionReplaceValues = delegate().replaceValues(k10, iterable);
            }
    ...
    public static class SynchronizedSetMultimap<K, V> extends SynchronizedMultimap<K, V> implements SetMultimap<K, V> {
        ...
        public Set<V> replaceValues(K k10, Iterable<? extends V> iterable) {
            ...
            synchronized (this.mutex) {
                setReplaceValues = delegate().replaceValues((Object) k10, (Iterable) iterable);
            }
    ...
    public static class SynchronizedMultiset<E> extends SynchronizedCollection<E> implements Multiset<E> {
        ...
        public int remove(Object obj, int i10) {
            int iRemove;
            synchronized (this.mutex) {
                iRemove = delegate().remove(obj, i10);
            }
            return iRemove;
        }
    ...
    public static class SynchronizedSortedSetMultimap<K, V> extends SynchronizedSetMultimap<K, V> implements SortedSetMultimap<K, V> {
        ...
        public SortedSet<V> get(K k10) {
            ...
            synchronized (this.mutex) {
                sortedSet = Synchronized.sortedSet(delegate().get((Object) k10), this.mutex);
            }
            return sortedSet;
        }
        ...
        public SortedSet<V> replaceValues(K k10, Iterable<? extends V> iterable) {
            ...
            synchronized (this.mutex) {
                sortedSetReplaceValues = delegate().replaceValues((Object) k10, (Iterable) iterable);
            }
    ...
    public static class SynchronizedNavigableMap<K, V> extends SynchronizedSortedMap<K, V> implements NavigableMap<K, V> {
        ...
        public Map.Entry<K, V> ceilingEntry(K k10) {
            ...
            synchronized (this.mutex) {
                entryNullableSynchronizedEntry = Synchronized.nullableSynchronizedEntry(delegate().ceilingEntry(k10), this.mutex);
            }
        ...
        public K ceilingKey(K k10) {
            K kCeilingKey;
            synchronized (this.mutex) {
                kCeilingKey = delegate().ceilingKey(k10);
            }
            return kCeilingKey;
        }
        ...
        public Map.Entry<K, V> floorEntry(K k10) {
            Map.Entry<K, V> entryNullableSynchronizedEntry;
            synchronized (this.mutex) {
                entryNullableSynchronizedEntry = Synchronized.nullableSynchronizedEntry(delegate().floorEntry(k10), this.mutex);
            }
            return entryNullableSynchronizedEntry;
        }
        ...
        public K floorKey(K k10) {
            K kFloorKey;
            synchronized (this.mutex) {
                kFloorKey = delegate().floorKey(k10);
            }
            return kFloorKey;
        }
        ...
        public Map.Entry<K, V> higherEntry(K k10) {
            Map.Entry<K, V> entryNullableSynchronizedEntry;
            synchronized (this.mutex) {
                entryNullableSynchronizedEntry = Synchronized.nullableSynchronizedEntry(delegate().higherEntry(k10), this.mutex);
            }
            return entryNullableSynchronizedEntry;
        }
        ...
        public K higherKey(K k10) {
            K kHigherKey;
            synchronized (this.mutex) {
                kHigherKey = delegate().higherKey(k10);
            }
            return kHigherKey;
        }
        ...
        public Map.Entry<K, V> lowerEntry(K k10) {
            Map.Entry<K, V> entryNullableSynchronizedEntry;
            synchronized (this.mutex) {
                entryNullableSynchronizedEntry = Synchronized.nullableSynchronizedEntry(delegate().lowerEntry(k10), this.mutex);
            }
            return entryNullableSynchronizedEntry;
        }
        ...
        public K lowerKey(K k10) {
            K kLowerKey;
            synchronized (this.mutex) {
                kLowerKey = delegate().lowerKey(k10);
            }
            return kLowerKey;
        }
