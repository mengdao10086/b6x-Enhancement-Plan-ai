...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
    ...
    public final class AsSet extends ImmutableSortedSet<C> {
        ...
        public int size() {
            ...
            if (numValueOf == null) {
                ...
                UnmodifiableIterator it2 = ImmutableRangeSet.this.ranges.iterator();
                while (it2.hasNext()) {
                    size += (long) ContiguousSet.create((Range) it2.next(), this.domain).size();
                    if (size >= 2147483647L) {
                        break;
                    }
                }
    ...
    private ImmutableList<Range<C>> intersectRanges(final Range<C> range) {
        ...
        return iBinarySearch2 == 0 ? ImmutableList.of() : (ImmutableList<Range<C>>) new ImmutableList<Range<C>>() { // from class: com.google.common.collect.ImmutableRangeSet.1
            ...
            public Range<C> get(int i10) {
                ...
                return (i10 == 0 || i10 == iBinarySearch2 + (-1)) ? ((Range) ImmutableRangeSet.this.ranges.get(i10 + iBinarySearch)).intersection(range) : (Range) ImmutableRangeSet.this.ranges.get(i10 + iBinarySearch);
            }
        };
    }
    ...
    public Range<C> rangeContaining(C c10) {
        int iBinarySearch = SortedLists.binarySearch(this.ranges, Range.lowerBoundFn(), Cut.belowValue(c10), Ordering.natural(), SortedLists.KeyPresentBehavior.ANY_PRESENT, SortedLists.KeyAbsentBehavior.NEXT_LOWER);
        if (iBinarySearch == -1) {
            return null;
        }
