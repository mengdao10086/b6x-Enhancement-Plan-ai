...
class ObjectCountHashMap<K> {
    ...
    public void insertEntry(int i10, @NullableDecl K k10, int i11, int i12) {
        this.entries[i10] = (((long) i12) << 32) | 4294967295L;
        this.keys[i10] = k10;
        this.values[i10] = i11;
    }
    ...
    public int put(@NullableDecl K k10, int i10) {
        CollectPreconditions.checkPositive(i10, a.C);
        long[] jArr = this.entries;
        Object[] objArr = this.keys;
        int[] iArr = this.values;
        ...
        int i11 = this.size;
        int[] iArr2 = this.table;
        int i12 = iArr2[iHashTableMask];
        if (i12 == -1) {
            iArr2[iHashTableMask] = i11;
        } else {
            while (true) {
                long j10 = jArr[i12];
                if (getHash(j10) == iSmearedHash && Objects.equal(k10, objArr[i12])) {
                    int i13 = iArr[i12];
                    iArr[i12] = i10;
                    return i13;
                }
        ...
        int i14 = i11 + 1;
        resizeMeMaybe(i14);
        insertEntry(i11, k10, i10, iSmearedHash);
        this.size = i14;
    ...
    private int remove(@NullableDecl Object obj, int i10) {
