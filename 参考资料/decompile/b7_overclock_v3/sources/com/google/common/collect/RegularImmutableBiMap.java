...
final class RegularImmutableBiMap<K, V> extends ImmutableBiMap<K, V> {
    ...
    public RegularImmutableBiMap(Object[] objArr, int i10) {
        ...
        this.size = i10;
        this.keyOffset = 0;
        int iChooseTableSize = i10 >= 2 ? ImmutableSet.chooseTableSize(i10) : 0;
        this.keyHashTable = RegularImmutableMap.createHashTable(objArr, i10, iChooseTableSize, 0);
        this.inverse = new RegularImmutableBiMap<>(RegularImmutableMap.createHashTable(objArr, i10, iChooseTableSize, 1), objArr, i10, this);
    }
