...
final class RegularImmutableMap<K, V> extends ImmutableMap<K, V> {
        ...
        public ImmutableList<Map.Entry<K, V>> createAsList() {
            return new ImmutableList<Map.Entry<K, V>>() { // from class: com.google.common.collect.RegularImmutableMap.EntrySet.1
                ...
                public Map.Entry<K, V> get(int i10) {
                    ...
                    int i11 = i10 * 2;
                    return new AbstractMap.SimpleImmutableEntry(EntrySet.this.alternatingKeysAndValues[EntrySet.this.keyOffset + i11], EntrySet.this.alternatingKeysAndValues[i11 + (EntrySet.this.keyOffset ^ 1)]);
                }
            };
        }
    ...
    public static final class KeysOrValuesAsList extends ImmutableList<Object> {
        ...
        public Object get(int i10) {
            ...
            return this.alternatingKeysAndValues[(i10 * 2) + this.offset];
        }
    ...
    public static <K, V> RegularImmutableMap<K, V> create(int i10, Object[] objArr) {
        ...
        return new RegularImmutableMap<>(createHashTable(objArr, i10, ImmutableSet.chooseTableSize(i10), 0), objArr, i10);
    }
