...
class MapMakerInternalMap<K, V, E extends InternalEntry<K, V, E>, S extends Segment<K, V, E, S>> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable {
    ...
    public static abstract class AbstractStrongKeyEntry<K, V, E extends InternalEntry<K, V, E>> implements InternalEntry<K, V, E> {
        ...
        public AbstractStrongKeyEntry(K k10, int i10, @NullableDecl E e10) {
            this.key = k10;
            this.hash = i10;
            this.next = e10;
        }
    ...
    public static abstract class AbstractWeakKeyEntry<K, V, E extends InternalEntry<K, V, E>> extends WeakReference<K> implements InternalEntry<K, V, E> {
        ...
        public AbstractWeakKeyEntry(ReferenceQueue<K> referenceQueue, K k10, int i10, @NullableDecl E e10) {
    ...
    private MapMakerInternalMap(MapMaker mapMaker, InternalEntryHelper<K, V, E, S> internalEntryHelper) {
        ...
        int i14 = iMin / i12;
        while (i11 < (i12 * i14 < iMin ? i14 + 1 : i14)) {
            i11 <<= 1;
        }
        while (true) {
        ...
        while (i10 < 3) {
            ...
            for (Segment<K, V, E, S> segment : segmentArr) {
                ...
                for (int i12 = 0; i12 < atomicReferenceArray.length(); i12++) {
                    for (E next = atomicReferenceArray.get(i12); next != null; next = next.getNext()) {
    ...
    public static abstract class Segment<K, V, E extends InternalEntry<K, V, E>, S extends Segment<K, V, E, S>> extends ReentrantLock {
        ...
        public boolean clearValueForTesting(K k10, int i10, WeakValueReference<K, V, ? extends InternalEntry<K, V, ?>> weakValueReference) {
            ...
            try {
                ...
                for (InternalEntry next = e10; next != null; next = next.getNext()) {
        ...
        public boolean containsKey(Object obj, int i10) {
            try {
                ...
                InternalEntry liveEntry = getLiveEntry(obj, i10);
                if (liveEntry != null) {
        ...
        public E copyEntry(E e10, E e11) {
            return (E) this.map.entryHelper.copy(self(), e10, e11);
        }
        ...
        public E newEntryForTesting(K k10, int i10, @NullableDecl InternalEntry<K, V, ?> internalEntry) {
            return (E) this.map.entryHelper.newEntry(self(), k10, i10, castForTesting(internalEntry));
        }
        ...
        public V put(K k10, int i10, V v10, boolean z10) {
            ...
            try {
                ...
                this.modCount++;
                InternalEntry internalEntryNewEntry = this.map.entryHelper.newEntry(self(), k10, i10, e10);
                setValue(internalEntryNewEntry, v10);
        ...
        public boolean reclaimKey(E e10, int i10) {
            ...
            try {
                ...
                for (InternalEntry next = e11; next != null; next = next.getNext()) {
                    if (next == e10) {
                        this.modCount++;
                        InternalEntry internalEntryRemoveFromChain = removeFromChain(e11, next);
                        int i11 = this.count - 1;
            ...
            try {
                ...
                for (InternalEntry next = e10; next != null; next = next.getNext()) {
                    ...
                    if (next.getHash() == i10 && key != null && this.map.keyEquivalence.equivalent(k10, key)) {
                        ...
                        this.modCount++;
                        InternalEntry internalEntryRemoveFromChain = removeFromChain(e10, next);
                        int i11 = this.count - 1;
                        atomicReferenceArray.set(length, (E) internalEntryRemoveFromChain);
                        this.count = i11;
                        return true;
        ...
        public E removeFromChain(E e10, E e11) {
            ...
            E e12 = (E) e11.getNext();
            while (e10 != e11) {
                InternalEntry internalEntryCopyEntry = copyEntry(e10, e12);
                if (internalEntryCopyEntry != null) {
                    e12 = (E) internalEntryCopyEntry;
                } else {
                    i10--;
                }
                e10 = (E) e10.getNext();
        ...
        public void setTableEntryForTesting(int i10, InternalEntry<K, V, ?> internalEntry) {
            this.table.set(i10, (E) castForTesting(internalEntry));
        }
