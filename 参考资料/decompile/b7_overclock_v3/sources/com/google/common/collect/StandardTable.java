...
class StandardTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    public class Column extends Maps.ViewCachingAbstractMap<R, V> {
                    ...
                    if (next.getValue().containsKey(Column.this.columnKey)) {
                        return new AbstractMapEntry<R, V>() { // from class: com.google.common.collect.StandardTable.Column.EntrySetIterator.1EntryImpl
                            ...
                            public V setValue(V v10) {
                                return (V) ((Map) next.getValue()).put(Column.this.columnKey, Preconditions.checkNotNull(v10));
                            }
                        };
                    }
                }
        ...
        public V put(R r10, V v10) {
            return (V) StandardTable.this.put(r10, this.columnKey, v10);
        }
    ...
    public class Row extends Maps.IteratorBasedAbstractMap<C, V> {
        ...
        public Iterator<Map.Entry<C, V>> entryIterator() {
            ...
            final Iterator<Map.Entry<C, V>> it2 = mapBackingRowMap.entrySet().iterator();
        ...
        public V put(C c10, V v10) {
            ...
            Map<C, V> map = this.backingRowMap;
            return (map == null || map.isEmpty()) ? (V) StandardTable.this.put(this.rowKey, c10, v10) : this.backingRowMap.put(c10, v10);
        }
        ...
        public V remove(Object obj) {
            ...
            V v10 = (V) Maps.safeRemove(mapBackingRowMap, obj);
            maintainEmptyInvariant();
            return v10;
        }
