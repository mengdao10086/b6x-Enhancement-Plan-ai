...
public final class Multimaps {
    ...
    public static class CustomMultimap<K, V> extends AbstractMapBasedMultimap<K, V> {
        ...
        public Collection<V> wrapCollection(K k10, Collection<V> collection) {
            return collection instanceof List ? wrapList(k10, (List) collection, null) : collection instanceof NavigableSet ? new AbstractMapBasedMultimap.WrappedNavigableSet(k10, (NavigableSet) collection, null) : collection instanceof SortedSet ? new AbstractMapBasedMultimap.WrappedSortedSet(k10, (SortedSet) collection, null) : collection instanceof Set ? new AbstractMapBasedMultimap.WrappedSet(k10, (Set) collection) : new AbstractMapBasedMultimap.WrappedCollection(k10, collection, null);
        }
    }
                ...
                public Iterator<V> iterator() {
                    return new Iterator<V>() { // from class: com.google.common.collect.Multimaps.MapMultimap.1.1
                        ...
                        public V next() {
                            ...
                            this.f21221i++;
                            AnonymousClass1 anonymousClass1 = AnonymousClass1.this;
                            return MapMultimap.this.map.get(k10);
                        }

                        @Override // java.util.Iterator
                        public void remove() {
                            CollectPreconditions.checkRemove(this.f21221i == 1);
                            this.f21221i = -1;
                            AnonymousClass1 anonymousClass1 = AnonymousClass1.this;
    ...
    public static class TransformedEntriesMultimap<K, V1, V2> extends AbstractMultimap<K, V2> {
        ...
        public Collection<V2> transform(K k10, Collection<V1> collection) {
            Function functionAsValueToValueFunction = Maps.asValueToValueFunction(this.transformer, k10);
