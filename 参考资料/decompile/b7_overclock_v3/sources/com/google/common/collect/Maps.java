...
public final class Maps {
    ...
    public static abstract class AbstractFilteredMap<K, V> extends ViewCachingAbstractMap<K, V> {
        ...
        public boolean apply(@NullableDecl Object obj, @NullableDecl V v10) {
    ...
    public static final class BiMapConverter<A, B> extends Converter<A, B> implements Serializable {
        ...
        public String toString() {
            return "Maps.asConverter(" + this.bimap + a.f26979d;
        }
    }
    ...
    public static class FilteredEntryNavigableMap<K, V> extends AbstractNavigableMap<K, V> {
        ...
        @Override // java.util.NavigableMap
        public NavigableMap<K, V> headMap(K k10, boolean z10) {
            return Maps.filterEntries((NavigableMap) this.unfiltered.headMap(k10, z10), (Predicate) this.entryPredicate);
        }
        ...
        @Override // java.util.NavigableMap
        public NavigableMap<K, V> subMap(K k10, boolean z10, K k11, boolean z11) {
            return Maps.filterEntries((NavigableMap) this.unfiltered.subMap(k10, z10, k11, z11), (Predicate) this.entryPredicate);
        }

        @Override // java.util.NavigableMap
        public NavigableMap<K, V> tailMap(K k10, boolean z10) {
            return Maps.filterEntries((NavigableMap) this.unfiltered.tailMap(k10, z10), (Predicate) this.entryPredicate);
        }
    ...
    public static final class NavigableAsMapView<K, V> extends AbstractNavigableMap<K, V> {
        ...
        @Override // java.util.NavigableMap
        public NavigableMap<K, V> headMap(K k10, boolean z10) {
            return Maps.asMap((NavigableSet) this.set.headSet(k10, z10), (Function) this.function);
        }
        ...
        @Override // java.util.NavigableMap
        public NavigableMap<K, V> subMap(K k10, boolean z10, K k11, boolean z11) {
            return Maps.asMap((NavigableSet) this.set.subSet(k10, z10, k11, z11), (Function) this.function);
        }

        @Override // java.util.NavigableMap
        public NavigableMap<K, V> tailMap(K k10, boolean z10) {
            return Maps.asMap((NavigableSet) this.set.tailSet(k10, z10), (Function) this.function);
        }
    }
    ...
    public static class SortedAsMapView<K, V> extends AsMapView<K, V> implements SortedMap<K, V> {
        ...
        @Override // java.util.SortedMap
        public SortedMap<K, V> headMap(K k10) {
            return Maps.asMap((SortedSet) backingSet().headSet(k10), (Function) this.function);
        }
        ...
        @Override // java.util.SortedMap
        public SortedMap<K, V> subMap(K k10, K k11) {
            return Maps.asMap((SortedSet) backingSet().subSet(k10, k11), (Function) this.function);
        }

        @Override // java.util.SortedMap
        public SortedMap<K, V> tailMap(K k10) {
            return Maps.asMap((SortedSet) backingSet().tailSet(k10), (Function) this.function);
        }
    ...
    public static class TransformedEntriesNavigableMap<K, V1, V2> extends TransformedEntriesSortedMap<K, V1, V2> implements NavigableMap<K, V2> {
        ...
        public NavigableMap<K, V2> subMap(K k10, boolean z10, K k11, boolean z11) {
            return Maps.transformEntries((NavigableMap) fromMap().subMap(k10, z10, k11, z11), (EntryTransformer) this.transformer);
        }
        ...
        public NavigableMap<K, V2> headMap(K k10, boolean z10) {
            return Maps.transformEntries((NavigableMap) fromMap().headMap(k10, z10), (EntryTransformer) this.transformer);
        }

        @Override // java.util.NavigableMap
        public NavigableMap<K, V2> tailMap(K k10, boolean z10) {
            return Maps.transformEntries((NavigableMap) fromMap().tailMap(k10, z10), (EntryTransformer) this.transformer);
        }
    ...
    public static class TransformedEntriesSortedMap<K, V1, V2> extends TransformedEntriesMap<K, V1, V2> implements SortedMap<K, V2> {
        ...
        public SortedMap<K, V2> headMap(K k10) {
            return Maps.transformEntries((SortedMap) fromMap().headMap(k10), (EntryTransformer) this.transformer);
        }
        ...
        public SortedMap<K, V2> subMap(K k10, K k11) {
            return Maps.transformEntries((SortedMap) fromMap().subMap(k10, k11), (EntryTransformer) this.transformer);
        }

        public SortedMap<K, V2> tailMap(K k10) {
            return Maps.transformEntries((SortedMap) fromMap().tailMap(k10), (EntryTransformer) this.transformer);
        }
    }
    ...
    public static class ValueDifferenceImpl<V> implements MapDifference.ValueDifference<V> {
        ...
        private ValueDifferenceImpl(@NullableDecl V v10, @NullableDecl V v11) {
            this.left = v10;
            this.right = v11;
        }

        public static <V> MapDifference.ValueDifference<V> create(@NullableDecl V v10, @NullableDecl V v11) {
        ...
        public String toString() {
            return a.f26978c + this.left + ", " + this.right + a.f26979d;
        }
    }
    ...
    public static <K, V1, V2> Function<V1, V2> asValueToValueFunction(final EntryTransformer<? super K, V1, V2> entryTransformer, final K k10) {
        Preconditions.checkNotNull(entryTransformer);
        return new Function<V1, V2>() { // from class: com.google.common.collect.Maps.10
            @Override // com.google.common.base.Function
            public V2 apply(@NullableDecl V1 v12) {
                return (V2) entryTransformer.transformEntry(k10, v12);
            }
        };
    }
