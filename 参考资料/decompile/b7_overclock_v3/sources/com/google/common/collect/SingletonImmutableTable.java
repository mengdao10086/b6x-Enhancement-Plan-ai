...
class SingletonImmutableTable<R, C, V> extends ImmutableTable<R, C, V> {
    ...
    public SingletonImmutableTable(R r10, C c10, V v10) {
        this.singleRowKey = (R) Preconditions.checkNotNull(r10);
        this.singleColumnKey = (C) Preconditions.checkNotNull(c10);
        this.singleValue = (V) Preconditions.checkNotNull(v10);
    }
