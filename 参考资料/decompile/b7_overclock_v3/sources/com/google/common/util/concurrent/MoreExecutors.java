...
public final class MoreExecutors {
    ...
    /* JADX INFO: renamed from: com.google.common.util.concurrent.MoreExecutors$5, reason: invalid class name */
        ...
        public void execute(final Runnable runnable) {
            try {
                ...
                if (this.thrownFromDelegate) {
                    this.val$future.setException(e10);
                }
            }
        }
    }
    ...
    public static <T> T invokeAnyImpl(ListeningExecutorService listeningExecutorService, Collection<? extends Callable<T>> collection, boolean z10, long j10, TimeUnit timeUnit) throws ExecutionException, InterruptedException, TimeoutException {
        ...
        if (z10) {
            try {
                ...
                Iterator it2 = arrayListNewArrayListWithCapacity.iterator();
                while (it2.hasNext()) {
        ...
        arrayListNewArrayListWithCapacity.add(submitAndAddQueueListener(listeningExecutorService, it3.next(), linkedBlockingQueueNewLinkedBlockingQueue));
        int i10 = size - 1;
        ...
        while (true) {
            ...
            if (future != null) {
                ...
                try {
                    T t10 = (T) future.get();
                    Iterator it4 = arrayListNewArrayListWithCapacity.iterator();
                    while (it4.hasNext()) {
