...
public final class Monitor {
    ...
    @GuardedBy("lock")
    private void await(Guard guard, boolean z10) throws InterruptedException {
        if (z10) {
            signalNextWaiter();
        }
    ...
    @GuardedBy("lock")
    private boolean awaitNanos(Guard guard, long j10, boolean z10) throws InterruptedException {
        boolean z11 = true;
        while (j10 > 0) {
            if (z11) {
                if (z10) {
