...
public class CycleDetectingLockFactory {
    ...
    public static class LockGraphNode {
        ...
        public void checkAcquiredLocks(Policy policy, List<LockGraphNode> list) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                checkAcquiredLock(policy, list.get(i10));
            }
        }
    ...
    public static final class WithExplicitOrdering<E extends Enum<E>> extends CycleDetectingLockFactory {
        ...
        public ReentrantLock newReentrantLock(E e10, boolean z10) {
            return this.policy == Policies.DISABLED ? new ReentrantLock(z10) : new CycleDetectingReentrantLock(this.lockGraphNodes.get(e10), z10);
        }

        public ReentrantReadWriteLock newReentrantReadWriteLock(E e10, boolean z10) {
            return this.policy == Policies.DISABLED ? new ReentrantReadWriteLock(z10) : new CycleDetectingReentrantReadWriteLock(this.lockGraphNodes.get(e10), z10);
        }
    }
    ...
    public static <E extends Enum<E>> Map<E, LockGraphNode> createNodes(Class<E> cls) {
        ...
        for (E e10 : enumConstants) {
            ...
            enumMapNewEnumMap.put(e10, lockGraphNode);
        }
        for (int i11 = 1; i11 < length; i11++) {
            ((LockGraphNode) arrayListNewArrayListWithCapacity.get(i11)).checkAcquiredLocks(Policies.THROW, arrayListNewArrayListWithCapacity.subList(0, i11));
        }
        while (i10 < length - 1) {
            i10++;
            ((LockGraphNode) arrayListNewArrayListWithCapacity.get(i10)).checkAcquiredLocks(Policies.DISABLED, arrayListNewArrayListWithCapacity.subList(i10, length));
        }
        return Collections.unmodifiableMap(enumMapNewEnumMap);
    }

    private static String getLockName(Enum<?> r22) {
        return r22.getDeclaringClass().getSimpleName() + b.f36044h + r22.name();
    }
    ...
    public ReentrantLock newReentrantLock(String str, boolean z10) {
        return this.policy == Policies.DISABLED ? new ReentrantLock(z10) : new CycleDetectingReentrantLock(new LockGraphNode(str), z10);
    }

    public ReentrantReadWriteLock newReentrantReadWriteLock(String str, boolean z10) {
        return this.policy == Policies.DISABLED ? new ReentrantReadWriteLock(z10) : new CycleDetectingReentrantReadWriteLock(new LockGraphNode(str), z10);
    }
