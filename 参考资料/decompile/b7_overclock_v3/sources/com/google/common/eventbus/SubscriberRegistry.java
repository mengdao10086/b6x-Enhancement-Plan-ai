...
final class SubscriberRegistry {
    ...
    private Multimap<Class<?>, Subscriber> findAllSubscribers(Object obj) {
        ...
        UnmodifiableIterator<Method> it2 = getAnnotatedMethods(obj.getClass()).iterator();
        while (it2.hasNext()) {
    ...
    public static ImmutableList<Method> getAnnotatedMethodsNotCached(Class<?> cls) {
        ...
        Iterator it2 = setRawTypes.iterator();
        while (it2.hasNext()) {
    ...
    public Iterator<Subscriber> getSubscribers(Object obj) {
        ...
        UnmodifiableIterator<Class<?>> it2 = immutableSetFlattenHierarchy.iterator();
        while (it2.hasNext()) {
            CopyOnWriteArraySet<Subscriber> copyOnWriteArraySet = this.subscribers.get(it2.next());
