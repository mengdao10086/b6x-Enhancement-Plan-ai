...
abstract class AbstractDirectedNetworkConnections<N, E> implements NetworkConnections<N, E> {
    ...
    public N adjacentNode(E e10) {
        return (N) Preconditions.checkNotNull(this.outEdgeMap.get(e10));
    }
    ...
    public N removeInEdge(E e10, boolean z10) {
        ...
        return (N) Preconditions.checkNotNull(this.inEdgeMap.remove(e10));
    }

    @Override // com.google.common.graph.NetworkConnections
    public N removeOutEdge(E e10) {
        return (N) Preconditions.checkNotNull(this.outEdgeMap.remove(e10));
    }
}
