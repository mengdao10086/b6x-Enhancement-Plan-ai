...
public final class InternetDomainName {
    ...
    static {
        ...
        PART_CHAR_MATCHER = CharMatcher.javaLetterOrDigit().or(charMatcherAnyOf);
    }

    public InternetDomainName(String str) {
        String lowerCase = Ascii.toLowerCase(DOTS_MATCHER.replaceFrom((CharSequence) str, '.'));
        lowerCase = lowerCase.endsWith(b.f36044h) ? lowerCase.substring(0, lowerCase.length() - 1) : lowerCase;
    ...
    private int findSuffixOfType(Optional<PublicSuffixType> optional) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            String strJoin = DOT_JOINER.join(this.parts.subList(i10, size));
            if (matchesType(optional, Optional.fromNullable(a.f51989a.get(strJoin)))) {
                return i10;
            }
            if (a.f51991c.containsKey(strJoin)) {
                return i10 + 1;
            }
    ...
    private static boolean matchesWildcardSuffixType(Optional<PublicSuffixType> optional, String str) {
        ...
        return listSplitToList.size() == 2 && matchesType(optional, Optional.fromNullable(a.f51990b.get(listSplitToList.get(1))));
    }
    ...
    public InternetDomainName child(String str) {
        return from(((String) Preconditions.checkNotNull(str)) + b.f36044h + this.name);
    }
