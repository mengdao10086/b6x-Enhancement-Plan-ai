...
public final class MediaType {
    ...
    private static final CharMatcher TOKEN_MATCHER = CharMatcher.ascii().and(CharMatcher.javaIsoControl().negate()).and(CharMatcher.isNot(f.f58383m)).and(CharMatcher.noneOf("()<>@,;:\\\"/[]?="));
    ...
    public static final MediaType WEBM_AUDIO = createConstant("audio", e.f41042m0);
    ...
    public static final MediaType WEBM_VIDEO = createConstant("video", e.f41042m0);
    ...
    public static final MediaType JSON_UTF_8 = createConstantUtf8("application", UMSSOHandler.JSON);
    ...
    private static final Joiner.MapJoiner PARAMETER_JOINER = Joiner.on("; ").withKeyValueSeparator(u.f30904o);
    ...
    private String computeToString() {
        ...
        sb2.append(f.f58380j);
        sb2.append(this.subtype);
        if (!this.parameters.isEmpty()) {
            sb2.append("; ");
            PARAMETER_JOINER.appendTo(sb2, Multimaps.transformValues((ListMultimap) this.parameters, (Function) new Function<String, String>() { // from class: com.google.common.net.MediaType.2
    ...
    public static MediaType parse(String str) {
        ...
        try {
            ...
            tokenizer.consumeCharacter(f.f58380j);
    ...
    public Optional<Charset> charset() {
        ...
        if (optionalOf == null) {
            ...
            UnmodifiableIterator<String> it2 = this.parameters.get(CHARSET_ATTRIBUTE).iterator();
            String str = null;
    ...
    public MediaType withParameters(String str, Iterable<String> iterable) {
        ...
        while (it3.hasNext()) {
            builder.put(strNormalizeToken, normalizeParameterValue(strNormalizeToken, it3.next()));
        }
