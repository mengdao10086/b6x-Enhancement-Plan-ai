...
public final class Longs {
    ...
    public enum LexicographicalComparator implements Comparator<long[]> {
        ...
        public int compare(long[] jArr, long[] jArr2) {
            ...
            for (int i10 = 0; i10 < iMin; i10++) {
                int iCompare = Longs.compare(jArr[i10], jArr2[i10]);
                if (iCompare != 0) {
                    return iCompare;
                }
            }
    ...
    public static class LongArrayAsList extends AbstractList<Long> implements RandomAccess, Serializable {
        ...
        public int hashCode() {
            ...
            for (int i10 = this.start; i10 < this.end; i10++) {
                iHashCode = (iHashCode * 31) + Longs.hashCode(this.array[i10]);
            }
            return iHashCode;
        }
    ...
    public static Long tryParse(String str, int i10) {
        ...
        int i12 = i11 + 1;
        int iDigit = AsciiDigits.digit(str.charAt(i11));
        if (iDigit < 0 || iDigit >= i10) {
            return null;
        }
        long j10 = -iDigit;
        long j11 = i10;
        ...
        while (i12 < str.length()) {
            int i13 = i12 + 1;
            int iDigit2 = AsciiDigits.digit(str.charAt(i12));
            if (iDigit2 < 0 || iDigit2 >= i10 || j10 < j12) {
                return null;
            }
            long j13 = j10 * j11;
            long j14 = iDigit2;
