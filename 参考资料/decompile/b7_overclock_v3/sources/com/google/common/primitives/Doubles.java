...
public final class Doubles {
    ...
    public static class DoubleArrayAsList extends AbstractList<Double> implements RandomAccess, Serializable {
        ...
        public int hashCode() {
            ...
            for (int i10 = this.start; i10 < this.end; i10++) {
                iHashCode = (iHashCode * 31) + Doubles.hashCode(this.array[i10]);
            }
            return iHashCode;
        }
    ...
    public static double constrainToRange(double d10, double d11, double d12) {
        Preconditions.checkArgument(d11 <= d12, "min (%s) must be less than or equal to max (%s)", Double.valueOf(d11), Double.valueOf(d12));
    ...
    private static Pattern fpPattern() {
        return Pattern.compile(("[+-]?(?:NaN|Infinity|" + ("(?:\\d+#(?:\\.\\d*#)?|\\.\\d+#)(?:[eE][+-]?\\d+#)?[fFdD]?") + "|" + ("0[xX](?:[0-9a-fA-F]+#(?:\\.[0-9a-fA-F]*#)?|\\.[0-9a-fA-F]+#)[pP][+-]?\\d+#[fFdD]?") + a.f26979d).replace("#", com.google.android.material.badge.a.f19590u));
    }
