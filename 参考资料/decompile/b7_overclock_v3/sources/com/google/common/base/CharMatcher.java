...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    public static final class And extends CharMatcher {
        ...
        public String toString() {
            return "CharMatcher.and(" + this.first + ", " + this.second + a.f26979d;
        }
    }
    ...
    public static final class ForPredicate extends CharMatcher {
        ...
        @Override // com.google.common.base.CharMatcher
        public String toString() {
            return "CharMatcher.forPredicate(" + this.predicate + a.f26979d;
        }
    ...
    public static final class Or extends CharMatcher {
        ...
        @Override // com.google.common.base.CharMatcher
        public String toString() {
            return "CharMatcher.or(" + this.first + ", " + this.second + a.f26979d;
        }
    }
    ...
    public static class RangesMatcher extends CharMatcher {
        ...
        @Override // com.google.common.base.CharMatcher
        public boolean matches(char c10) {
            int iBinarySearch = Arrays.binarySearch(this.rangeStarts, c10);
            if (iBinarySearch >= 0) {
                return true;
            }
    ...
    public CharMatcher precomputedInternal() {
        ...
        return new NegatedFastMatcher(precomputedPositive(i10, bitSet, strSubstring)) { // from class: com.google.common.base.CharMatcher.1
