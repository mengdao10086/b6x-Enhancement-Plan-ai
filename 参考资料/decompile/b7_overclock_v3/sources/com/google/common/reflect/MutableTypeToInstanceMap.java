...
public final class MutableTypeToInstanceMap<B> extends ForwardingMap<TypeToken<? extends B>, B> implements TypeToInstanceMap<B> {
    ...
    public static final class UnmodifiableEntry<K, V> extends ForwardingMapEntry<K, V> {
        ...
        public static <K, V> Iterator<Map.Entry<K, V>> transformEntries(Iterator<Map.Entry<K, V>> it2) {
            return Iterators.transform(it2, new Function<Map.Entry<K, V>, Map.Entry<K, V>>() { // from class: com.google.common.reflect.MutableTypeToInstanceMap.UnmodifiableEntry.2
    ...
    public <T extends B> T putInstance(Class<T> cls, @NullableDecl T t10) {
        return (T) trustedPut(TypeToken.of((Class) cls), t10);
    }
    ...
    public <T extends B> T putInstance(TypeToken<T> typeToken, @NullableDecl T t10) {
        return (T) trustedPut(typeToken.rejectTypeVariables(), t10);
    }
}
