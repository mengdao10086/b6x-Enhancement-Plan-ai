...
final class Types {
    ...
    private static final Joiner COMMA_JOINER = Joiner.on(", ").useForNull(i0.f11859x);
    ...
    public static final class GenericArrayTypeImpl implements GenericArrayType, Serializable {
        ...
        public String toString() {
            return Types.toString(this.componentType) + u.f43953p;
        }
    }
    ...
    public static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        public String toString() {
            ...
            sb2.append('<');
            sb2.append(Types.COMMA_JOINER.join(Iterables.transform(this.argumentsList, Types.TYPE_NAME)));
            sb2.append('>');
            return sb2.toString();
        }
    }
    ...
    public static final class TypeVariableImpl<D extends GenericDeclaration> {
        ...
        public TypeVariableImpl(D d10, String str, Type[] typeArr) {
            ...
            this.genericDeclaration = (D) Preconditions.checkNotNull(d10);
