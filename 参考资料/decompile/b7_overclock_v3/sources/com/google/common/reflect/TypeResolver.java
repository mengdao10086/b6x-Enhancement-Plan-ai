...
public final class TypeResolver {
    ...
    public static class WildcardCapturer {
        ...
        private final AtomicInteger f21258id;
        ...
        private WildcardCapturer forTypeVariable(final TypeVariable<?> typeVariable) {
            return new WildcardCapturer(this.f21258id) { // from class: com.google.common.reflect.TypeResolver.WildcardCapturer.1
        ...
        private WildcardCapturer notForTypeVariable() {
            return new WildcardCapturer(this.f21258id);
        }
        ...
        public TypeVariable<?> captureAsTypeVariable(Type[] typeArr) {
            return Types.newArtificialTypeVariable(WildcardCapturer.class, "capture#" + this.f21258id.incrementAndGet() + "-of ? extends " + Joiner.on('&').join(typeArr), typeArr);
        }
