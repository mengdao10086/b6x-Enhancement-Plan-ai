...
public final class ClassPath {
    ...
    private static final Splitter CLASS_PATH_ATTRIBUTE_SEPARATOR = Splitter.on(i0.f11861z).omitEmptyStrings();
    ...
    public static String getClassName(String str) {
        return str.substring(0, str.length() - 6).replace(f.f58380j, '.');
    }

    @VisibleForTesting
    public static File toFile(URL url) {
        Preconditions.checkArgument(url.getProtocol().equals(a.f40702b));
        try {
    ...
    public static abstract class Scanner {
        ...
        public static ImmutableMap<File, ClassLoader> getClassPathEntries(ClassLoader classLoader) {
            ...
            while (it2.hasNext()) {
                URL next = it2.next();
                if (next.getProtocol().equals(a.f40702b)) {
            ...
            if (value != null) {
                for (String str : ClassPath.CLASS_PATH_ATTRIBUTE_SEPARATOR.split(value)) {
                    try {
                        ...
                        if (classPathEntry.getProtocol().equals(a.f40702b)) {
            ...
            for (String str : Splitter.on(StandardSystemProperty.PATH_SEPARATOR.value()).split(StandardSystemProperty.JAVA_CLASS_PATH.value())) {
                try {
                    try {
                        ...
                        builder.add(new URL(a.f40702b, (String) null, new File(str).getAbsolutePath()));
                    }
                } catch (MalformedURLException e10) {
                    ClassPath.logger.log(Level.WARNING, "malformed classpath entry: " + str, (Throwable) e10);
                }
            }
            return builder.build();
        }
            ...
            for (File file2 : fileArrListFiles) {
                ...
                if (file2.isDirectory()) {
                    ...
                    if (set.add(canonicalFile)) {
                        scanDirectory(canonicalFile, classLoader, str + name + fh.a.f28350w, set);
