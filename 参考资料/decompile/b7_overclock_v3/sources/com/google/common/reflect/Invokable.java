...
public abstract class Invokable<T, R> extends Element implements GenericDeclaration {
    ...
    public static class ConstructorInvokable<T> extends Invokable<T, T> {
        ...
        @Override // com.google.common.reflect.Invokable
        public final Object invokeInternal(@NullableDecl Object obj, Object[] objArr) throws IllegalAccessException, InvocationTargetException {
            try {
                return this.constructor.newInstance(objArr);
            } catch (InstantiationException e10) {
                throw new RuntimeException(this.constructor + " failed.", e10);
            }
        }
    ...
    public final ImmutableList<Parameter> getParameters() {
        ...
        for (int i10 = 0; i10 < genericParameterTypes.length; i10++) {
            builder.add(new Parameter(this, i10, TypeToken.of(genericParameterTypes[i10]), parameterAnnotations[i10]));
        }
        return builder.build();
    }
    ...
    public final R invoke(@NullableDecl T t10, Object... objArr) throws IllegalAccessException, InvocationTargetException {
        return (R) invokeInternal(t10, (Object[]) Preconditions.checkNotNull(objArr));
    }

    public abstract Object invokeInternal(@NullableDecl Object obj, Object[] objArr) throws IllegalAccessException, InvocationTargetException;
