...
public abstract class ByteSource {
    ...
    public class AsCharSource extends CharSource {
        ...
        public String toString() {
            return ByteSource.this.toString() + ".asCharSource(" + this.charset + a.f26979d;
        }
    }
    ...
    public static class ByteArrayByteSource extends ByteSource {
        ...
        public ByteSource slice(long j10, long j11) {
            ...
            long jMin = Math.min(j10, this.length);
            return new ByteArrayByteSource(this.bytes, this.offset + ((int) jMin), (int) Math.min(j11, ((long) this.length) - jMin));
        }

        public String toString() {
            return "ByteSource.wrap(" + Ascii.truncate(BaseEncoding.base16().encode(this.bytes, this.offset, this.length), 30, "...") + a.f26979d;
        }
    ...
    public static final class ConcatenatedByteSource extends ByteSource {
        ...
        public Optional<Long> sizeIfKnown() {
            ...
            long jLongValue = 0;
            while (it2.hasNext()) {
                Optional<Long> optionalSizeIfKnown = it2.next().sizeIfKnown();
        ...
        public String toString() {
            return "ByteSource.concat(" + this.sources + a.f26979d;
        }
    }
    ...
    public final class SlicedByteSource extends ByteSource {
        ...
        public ByteSource slice(long j10, long j11) {
            Preconditions.checkArgument(j10 >= 0, "offset (%s) may not be negative", j10);
            Preconditions.checkArgument(j11 >= 0, "length (%s) may not be negative", j11);
            return ByteSource.this.slice(this.offset + j10, Math.min(j11, this.length - j10));
        }

        public String toString() {
            return ByteSource.this.toString() + ".slice(" + this.offset + ", " + this.length + a.f26979d;
        }
    }
    ...
    public boolean contentEquals(ByteSource byteSource) throws Throwable {
        ...
        try {
            ...
            do {
                i10 = ByteStreams.read(inputStream, bArrCreateBuffer, 0, bArrCreateBuffer.length);
                if (i10 == ByteStreams.read(inputStream2, bArrCreateBuffer2, 0, bArrCreateBuffer2.length) && Arrays.equals(bArrCreateBuffer, bArrCreateBuffer2)) {
                }
                return false;
            } while (i10 == bArrCreateBuffer.length);
            return true;
        } finally {
        }
    }
