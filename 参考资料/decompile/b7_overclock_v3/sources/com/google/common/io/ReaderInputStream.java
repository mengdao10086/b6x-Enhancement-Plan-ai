...
final class ReaderInputStream extends InputStream {
    ...
    private int drain(byte[] bArr, int i10, int i11) {
        int iMin = Math.min(i11, this.byteBuffer.remaining());
    ...
    private void readMoreChars() throws IOException {
        ...
        int i10 = this.reader.read(this.charBuffer.array(), iLimit, availableCapacity(this.charBuffer));
        if (i10 == -1) {
            this.endOfInput = true;
        } else {
            this.charBuffer.limit(iLimit + i10);
        }
    }
