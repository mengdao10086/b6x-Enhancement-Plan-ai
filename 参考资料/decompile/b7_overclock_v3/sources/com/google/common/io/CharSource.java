...
public abstract class CharSource {
    ...
    public final class AsByteSource extends ByteSource {
        ...
        public String toString() {
            return CharSource.this.toString() + ".asByteSource(" + this.charset + a.f26979d;
        }
    }
    ...
    public static class CharSequenceCharSource extends CharSource {
        ...
        public String toString() {
            return "CharSource.wrap(" + Ascii.truncate(this.seq, 30, "...") + a.f26979d;
        }
    ...
    public static final class ConcatenatedCharSource extends CharSource {
        ...
        public Optional<Long> lengthIfKnown() {
            ...
            long jLongValue = 0;
            while (it2.hasNext()) {
                Optional<Long> optionalLengthIfKnown = it2.next().lengthIfKnown();
        ...
        public String toString() {
            return "CharSource.concat(" + this.sources + a.f26979d;
        }
    }
