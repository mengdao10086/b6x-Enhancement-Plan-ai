...
public abstract class LinearTransformation {
    ...
    public static final class LinearTransformationBuilder {
        ...
        private final double f21255x1;

        /* JADX INFO: renamed from: y1, reason: collision with root package name */
        private final double f21256y1;
        ...
        public LinearTransformation and(double d10, double d11) {
            ...
            double d12 = this.f21255x1;
            if (d10 != d12) {
                return withSlope((d11 - this.f21256y1) / (d10 - d12));
            }
            Preconditions.checkArgument(d11 != this.f21256y1);
            return new VerticalLinearTransformation(this.f21255x1);
        }

        public LinearTransformation withSlope(double d10) {
            Preconditions.checkArgument(!Double.isNaN(d10));
            return DoubleUtils.isFinite(d10) ? new RegularLinearTransformation(d10, this.f21256y1 - (this.f21255x1 * d10)) : new VerticalLinearTransformation(this.f21255x1);
        }
    ...
    public static final class VerticalLinearTransformation extends LinearTransformation {
        ...
        private LinearTransformation createInverse() {
            return new RegularLinearTransformation(0.0d, this.f21257x, this);
        }
        ...
        public String toString() {
            return String.format("x = %g", Double.valueOf(this.f21257x));
        }
