...
public class RangeSlider extends BaseSlider<RangeSlider, b, c> {
    ...
    public static class RangeSliderState extends AbsSavedState {
        ...
        public void writeToParcel(Parcel parcel, int i10) {
            ...
            parcel.writeFloat(this.f20669a);
    ...
    public interface c extends com.google.android.material.slider.b<RangeSlider> {
        ...
        void f(@n0 RangeSlider rangeSlider);
    }
    ...
    public static List<Float> D0(TypedArray typedArray) {
    ...
    public void onRestoreInstanceState(@p0 Parcelable parcelable) {
        ...
        this.f20667l8 = rangeSliderState.f20669a;
        int i10 = rangeSliderState.f20670b;
        this.f20668m8 = i10;
    ...
    public Parcelable onSaveInstanceState() {
        ...
        rangeSliderState.f20669a = this.f20667l8;
        rangeSliderState.f20670b = this.f20668m8;
    ...
    public RangeSlider(@n0 Context context, @p0 AttributeSet attributeSet, int i10) {
        ...
        TypedArray typedArrayK = t.k(context, attributeSet, R.styleable.RangeSlider, i10, BaseSlider.f20618g8, new int[0]);
        ...
        this.f20667l8 = typedArrayK.getDimension(R.styleable.RangeSlider_minSeparation, 0.0f);
        typedArrayK.recycle();
    }
}
