...
public final class SubLoader implements ILoader, ILoaderVisitor {
    ...
    public void handlerTask() {
        ...
        try {
            Iterator<IThreadTask> it2 = this.mTask.iterator();
            while (it2.hasNext()) {
                ThreadTaskManager.getInstance().startThread(this.parentKey, it2.next());
            }
            sendNormalState(8);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void sendFailState(boolean z10) {
        ...
        data.putBoolean(IThreadStateManager.DATA_RETRY, z10);
        messageObtainMessage.what = 2;
        messageObtainMessage.setData(data);
        messageObtainMessage.sendToTarget();
    }

    private void sendNormalState(int i10) {
        Message messageObtainMessage = this.schedulers.obtainMessage();
        Bundle data = messageObtainMessage.getData();
        if (data == null) {
            data = new Bundle();
    ...
    public void setNeedGetInfo(boolean z10) {
        this.needGetInfo = z10;
    }
    ...
    public void addComponent(IInfoTask iInfoTask) {
        ...
        iInfoTask.setCallback(new IInfoTask.Callback() { // from class: com.arialyy.aria.core.loader.SubLoader.1
            ...
            public void onFail(AbsEntity absEntity, AriaException ariaException, boolean z10) {
                SubLoader.this.sendFailState(z10);
            }
