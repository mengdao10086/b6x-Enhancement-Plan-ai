...
public interface IDGroupListener extends IDLoadListener {
    ...
    void onSubRunning(DownloadEntity downloadEntity, long j10);

    void onSubStart(DownloadEntity downloadEntity);

    void onSubStop(DownloadEntity downloadEntity, long j10);

    void supportBreakpoint(boolean z10, DownloadEntity downloadEntity);
}
