...
public class DownloadGroupTask extends AbsGroupTask<DGTaskWrapper> {
    ...
    public String getTaskName() {
        ...
        sb2.append("任务组->");
        sb2.append(TextUtils.isEmpty(((DownloadGroupEntity) ((DGTaskWrapper) this.mTaskWrapper).getEntity()).getAlias()) ? ((DownloadGroupEntity) ((DGTaskWrapper) this.mTaskWrapper).getEntity()).getGroupHash() : ((DownloadGroupEntity) ((DGTaskWrapper) this.mTaskWrapper).getEntity()).getAlias());
        return sb2.toString();
    }
