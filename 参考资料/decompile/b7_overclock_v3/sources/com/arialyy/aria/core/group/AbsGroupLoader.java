...
public abstract class AbsGroupLoader implements ILoaderVisitor, ILoader {
    ...
    private AbsSubDLoadUtil getDownloader(String str, boolean z10) {
        AbsSubDLoadUtil absSubDLoadUtil = this.mExeLoader.get(str);
        return absSubDLoadUtil == null ? createSubLoader(this.mCache.get(str), z10) : absSubDLoadUtil;
    }
    ...
    public abstract AbsSubDLoadUtil createSubLoader(DTaskWrapper dTaskWrapper, boolean z10);

    public void fail(AriaException ariaException, boolean z10) {
        closeTimer();
        getListener().onFail(z10, ariaException);
    }
