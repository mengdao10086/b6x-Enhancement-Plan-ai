...
public class DownloadGroupListener extends BaseListener implements IDGroupListener {
    ...
    private void handleSubSpeed(DownloadEntity downloadEntity, long j10) {
        if (j10 == 0) {
    ...
    private void saveCurrentLocation() {
        ...
        while (it2.hasNext()) {
            fileSize += it2.next().getCurrentProgress();
        }
    ...
    private void saveSubState(int i10, DownloadEntity downloadEntity) {
    ...
    @Override // com.arialyy.aria.core.listener.IDGroupListener
    public void onSubRunning(DownloadEntity downloadEntity, long j10) {
        handleSubSpeed(downloadEntity, j10);
    ...
    @Override // com.arialyy.aria.core.listener.IDGroupListener
    public void onSubStop(DownloadEntity downloadEntity, long j10) {
        downloadEntity.setCurrentProgress(j10);
        handleSubSpeed(downloadEntity, 0L);
