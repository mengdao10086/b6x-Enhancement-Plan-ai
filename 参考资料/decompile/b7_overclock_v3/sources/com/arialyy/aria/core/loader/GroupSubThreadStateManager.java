...
public class GroupSubThreadStateManager implements IThreadStateManager {
    ...
    public boolean mergeFile() {
        ...
        int i10 = this.mTaskRecord.threadNum;
        for (int i11 = 0; i11 < i10; i11++) {
            arrayList.add(String.format(IRecordHandler.SUB_PATH, this.mTaskRecord.filePath, Integer.valueOf(i11)));
        }
    ...
    public long updateBlockProgress() {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            File file = new File(String.format(IRecordHandler.SUB_PATH, this.mTaskRecord.filePath, Integer.valueOf(i10)));
            if (file.exists()) {
                length += file.length();
            }
        }
    ...
    @Override // com.arialyy.aria.core.inf.IThreadStateManager
    public void updateCurrentProgress(long j10) {
        this.mProgress = j10;
    }
}
