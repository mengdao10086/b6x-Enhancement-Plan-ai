...
public class CheckUEntityUtil implements ICheckEntityUtil {
    ...
    private CheckUEntityUtil(UTaskWrapper uTaskWrapper, int i10) {
        this.action = i10;
    ...
    private boolean checkFilePath() {
        ...
        if (!filePath.startsWith(a.f28350w)) {
    ...
    public static CheckUEntityUtil newInstance(UTaskWrapper uTaskWrapper, int i10) {
        return new CheckUEntityUtil(uTaskWrapper, i10);
    }
