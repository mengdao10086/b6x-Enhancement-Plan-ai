...
final class SimpleSchedulers implements Handler.Callback {
    ...
    private synchronized void handleFail(AbsSubDLoadUtil absSubDLoadUtil, boolean z10) {
        ...
        if (z10 && ((NetUtils.isConnected(AriaConfig.getInstance().getAPP()) || zIsNotNetRetry) && absSubDLoadUtil.getLoader() != null && absSubDLoadUtil.getEntity().getFailNum() <= subReTryNum)) {
    ...
    private synchronized void handleStop(AbsSubDLoadUtil absSubDLoadUtil, long j10) {
        ...
        this.mGState.listener.onSubStop(absSubDLoadUtil.getEntity(), j10);
    ...
    public boolean handleMessage(Message message) {
        ...
        long j10 = data.getLong(IThreadStateManager.DATA_THREAD_LOCATION, loaderUtil.getLoader().getWrapper().getEntity().getCurrentProgress());
        int i10 = message.what;
        if (i10 == 1) {
            handleStop(loaderUtil, j10);
