...
public class CheckDEntityUtil implements ICheckEntityUtil {
    ...
    private CheckDEntityUtil(DTaskWrapper dTaskWrapper, int i10) {
        this.action = i10;
    ...
    private boolean checkFilePath() {
        ...
        if (!tempFilePath.startsWith(a.f28350w)) {
    ...
    public static CheckDEntityUtil newInstance(DTaskWrapper dTaskWrapper, int i10) {
        return new CheckDEntityUtil(dTaskWrapper, i10);
    }
