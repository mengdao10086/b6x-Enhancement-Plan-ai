...
public final class ConnectionHelp {
    ...
    public static InputStream convertInputStream(HttpURLConnection httpURLConnection) throws IOException {
        ...
        return TextUtils.isEmpty(headerField) ? httpURLConnection.getInputStream() : headerField.contains(Constants.CP_GZIP) ? new GZIPInputStream(httpURLConnection.getInputStream()) : headerField.contains("deflate") ? new InflaterInputStream(httpURLConnection.getInputStream()) : httpURLConnection.getInputStream();
    }
