...
final class HttpDFileInfoTask implements IInfoTask, Runnable {
    ...
    public static class FileLenAdapter implements IHttpFileLenAdapter {
        ...
        public long handleFileLen(Map<String, List<String>> map) {
            ...
            long j10 = TextUtils.isEmpty(str) ? -1L : Long.parseLong(str);
            if (j10 >= 0) {
                return j10;
            }
            ...
            return Long.parseLong(str.substring(str.indexOf(a.f28350w) + 1));
        }
    }
    ...
    private void failDownload(AriaHTTPException ariaHTTPException, boolean z10) {
        IInfoTask.Callback callback;
        if (this.isStop || this.isCancel || (callback = this.callback) == null) {
            return;
        }
        callback.onFail(this.mEntity, ariaHTTPException, z10);
    }
    ...
    private void handleConnect(HttpURLConnection httpURLConnection) throws IOException {
        ...
        boolean z11 = !TextUtils.isEmpty(headerField) && headerField.equals("chunked");
        ...
        if (responseCode == 206) {
            if (!checkLen(jHandleFileLen) && !z11) {
                if (jHandleFileLen < 0) {
            ...
            } else if (!checkLen(jHandleFileLen) && !z11) {
                if (jHandleFileLen < 0) {
                    failDownload(new AriaHTTPException(String.format("任务下载失败，文件长度小于0， url: %s", this.mEntity.getUrl())), false);
                }
                ALog.d(TAG, "len < 0");
        ...
        if (this.isStop || this.isCancel || !z10) {
            return;
        }
        this.taskOption.setChunked(z11);
    ...
    private void handleContentDisposition(String str) throws UnsupportedEncodingException {
        if (str.contains(";")) {
            ...
            if (!strArrSplit[0].equals("attachment")) {
                ...
                String[] strArrSplit2 = strArrSplit[2].split(u.f30904o);
            ...
            for (String str2 : strArrSplit) {
                if (str2.startsWith("filename") && str2.contains(u.f30904o)) {
                    String[] strArrSplit3 = str2.split(u.f30904o);
    ...
    private void handleUrlReTurn(HttpURLConnection httpURLConnection, String str) throws IOException {
        ...
        if (TextUtils.isEmpty(str) || str.equalsIgnoreCase(i0.f11859x)) {
        ...
        httpURLConnectionHandleConnection.setRequestProperty(HttpHeaders.COOKIE, headerField);
        httpURLConnectionHandleConnection.setRequestProperty(HttpHeaders.RANGE, "bytes=0-");
    ...
    private void renameFile(String str) {
        ...
        String str2 = file.getParent() + a.f28350w + str;
    ...
    public void run() {
        ...
        try {
            ...
            failDownload(new AriaHTTPException(String.format("下载失败，filePath: %s, url: %s", this.mEntity.getFilePath(), this.mEntity.getUrl()), e12), true);
            if (httpURLConnectionHandleConnection == null) {
                return;
            }
            try {
