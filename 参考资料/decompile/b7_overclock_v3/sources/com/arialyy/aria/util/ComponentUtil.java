    ...
    */
    ...
    public synchronized <T extends IUtil> T buildUtil(AbsTaskWrapper absTaskWrapper, IEventListener iEventListener) {
        ...
        try {
            ...
            t10 = (T) clsLoadClass.getConstructor(new Class[0]).newInstance(new Object[0]);
            try {
                CommonUtil.getMethod(clsLoadClass, "setParams", AbsTaskWrapper.class, IEventListener.class).invoke(t10, absTaskWrapper, iEventListener);
    ...
    public boolean checkComponentExist(int i10) {
        String str;
        String str2;
        if (i10 == 1) {
