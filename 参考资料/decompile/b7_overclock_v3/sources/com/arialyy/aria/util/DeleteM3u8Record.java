...
public class DeleteM3u8Record implements IDeleteRecord {
    ...
    private void deleteEntity(int i10, boolean z10, String str) {
    ...
    private static void removeTsCache(File file, long j10) {
        ...
        String str = file.isDirectory() ? null : String.format("%s/.%s_%s", file.getParent(), file.getName(), Long.valueOf(j10));
    ...
    public void deleteRecord(AbsEntity absEntity, boolean z10, boolean z11) {
        ...
        if (taskRecord == null) {
            ...
            deleteEntity(downloadEntity.getTaskType(), z11, filePath);
            return;
        }
