...
public class AriaServiceLoader<S> {
    ...
    public class LazyLoader {
        ...
        private void fail(Class<?> cls, String str, Throwable th2) throws ServiceConfigurationError {
            ...
            while (it2.hasNext()) {
                if (it2.next().equals(str)) {
                    try {
                        ...
                        fail(this.service, "Provider " + str + " not found", e10);
                        cls = null;
                    }
                    ...
                    try {
                        ...
                        fail(this.service, "Provider " + str + " could not be instantiated", th2);
                    }
                }
            }
            throw new Error();
        ...
        private List<String> parse(Class<?> cls, URL url) throws Throwable {
            ...
            try {
                try {
                                ...
                                try {
                                    ...
                                    if (bufferedReader != null) {
                                        try {
                                            ...
                                            fail(cls, "Error closing configuration file", e11);
                                            throw th;
                                        }
                                    }
                                    if (inputStreamOpenStream != null) {
                    ...
                    fail(cls, "Error closing configuration file", e13);
                }
        ...
        */
        ...
        private int parseLine(Class<?> cls, URL url, BufferedReader bufferedReader, int i10, List<String> list) throws ServiceConfigurationError, IOException {
            ...
            if (length != 0) {
                ...
                if (!Character.isJavaIdentifierStart(iCodePointAt)) {
                    fail(cls, url, i10, "Illegal provider-class name: " + strTrim);
                }
        ...
        private void fail(Class<?> cls, URL url, int i10, String str) throws ServiceConfigurationError {
