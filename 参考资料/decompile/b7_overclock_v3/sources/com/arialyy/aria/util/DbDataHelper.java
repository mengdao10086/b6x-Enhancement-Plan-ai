...
public class DbDataHelper {
    public static List<DTaskWrapper> createDGSubTaskWrapper(DownloadGroupEntity downloadGroupEntity) {
        ...
        Iterator<DownloadEntity> it2 = downloadGroupEntity.getSubEntities().iterator();
        while (it2.hasNext()) {
            DTaskWrapper dTaskWrapper = new DTaskWrapper(it2.next());
    ...
    public static List<DownloadEntity> createHttpSubTask(String str, List<String> list) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            downloadEntity.setFilePath(str + "_" + i10);
    ...
    public static DownloadGroupEntity getDGEntity(long j10) {
        List listFindRelationData = DbEntity.findRelationData(DGEntityWrapper.class, "DownloadGroupEntity.rowid=?", String.valueOf(j10));
    ...
    public static TaskRecord getTaskRecord(String str, int i10) {
        TaskRecord taskRecord = (TaskRecord) DbEntity.findFirst(TaskRecord.class, "filePath=? AND taskType=?", str, String.valueOf(i10));
        if (taskRecord != null) {
            taskRecord.threadRecords = DbEntity.findDatas(ThreadRecord.class, "taskKey=? AND threadType=?", str, String.valueOf(i10));
        }
        return taskRecord;
    }
}
