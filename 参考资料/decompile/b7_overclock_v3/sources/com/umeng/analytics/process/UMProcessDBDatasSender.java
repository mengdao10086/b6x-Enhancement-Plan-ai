...
public class UMProcessDBDatasSender implements UMLogDataProtocol {
    ...
    public class ReplaceCallback implements FileLockCallback {
        ...
        public boolean onFileLock(String str) throws Throwable {
            ...
            String str2 = a.f23844c;
            if (str.startsWith(str2)) {
                str = str.replaceFirst(str2, "");
            }
            UMProcessDBHelper.getInstance(UMProcessDBDatasSender.this.mContext).deleteEventDatas(str.replace(a.f23845d, ""), null, null);
            return true;
        }
    ...
    private int defconProcesserHandler() throws Throwable {
        ...
        if (iA != 0) {
            ...
            UMProcessDBHelper.getInstance(this.mContext).deleteEventDatas(a.f23849h, null, null);
        }
        return iA;
    }
    ...
    private JSONObject generalHeader() {
        ...
        try {
            ...
            jSONObject.put(d.f23505i, AnalyticsConfig.getVerticalType(this.mContext));
            String str2 = "9.5.4";
            ...
            SharedPreferences sharedPreferences = PreferenceWrapper.getDefault(this.mContext);
            jSONObject.put(d.f23508l, UMEnvelopeBuild.imprintProperty(this.mContext, "pr_ve", null));
            jSONObject.put(d.f23509m, UMEnvelopeBuild.imprintProperty(this.mContext, "ud_da", null));
            jSONObject.put(d.f23484ah, "1.0.0");
            if (TextUtils.isEmpty(strImprintProperty)) {
                jSONObject.put(d.f23508l, sharedPreferences.getString("vers_pre_version", "0"));
                jSONObject.put(d.f23509m, sharedPreferences.getString("vers_date", new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).format(new Date(System.currentTimeMillis()))));
            }
        } catch (Throwable th2) {
            th2.printStackTrace();
        }
