...
public class Gender {
    ...
    private static final /* synthetic */ Gender[] f23110a;
    public int value;
    ...
    public static /* synthetic */ class AnonymousClass4 {
        ...
        static {
            ...
            try {
                f23111a[Gender.Female.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f23111a[Gender.Unknown.ordinal()] = 3;
    ...
    static {
        ...
        Female = gender2;
        Gender gender3 = new Gender(DeviceConfigInternal.UNKNOW, i12, i10) { // from class: com.umeng.analytics.Gender.3
            @Override // java.lang.Enum
            public String toString() {
        ...
        Unknown = gender3;
        f23110a = new Gender[]{gender, gender2, gender3};
    }
    ...
    public static com.umeng.commonsdk.statistics.proto.Gender transGender(Gender gender) {
        int i10 = AnonymousClass4.f23111a[gender.ordinal()];
