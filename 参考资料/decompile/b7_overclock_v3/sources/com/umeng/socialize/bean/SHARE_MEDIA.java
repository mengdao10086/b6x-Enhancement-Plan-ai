...
public enum SHARE_MEDIA {
    ...
    public static SnsPlatform createSnsPlatform(String str, String str2, String str3, String str4, int i10) {
        SnsPlatform snsPlatform = new SnsPlatform();
        snsPlatform.mShowWord = str;
        snsPlatform.mIcon = str3;
        snsPlatform.mGrayIcon = str4;
        snsPlatform.mIndex = i10;
    ...
    public String getauthstyle(boolean z10) {
    ...
    public String getsharestyle(boolean z10) {
    ...
    public SnsPlatform toSnsPlatform() {
        ...
        } else if (toString().equals(c.f53852h)) {
