...
public class PlatformName {
    ...
    public static String BYTEDANCE = "抖音";
    public static String BYTEDANCE_FRIENDS = "抖音好友/群";
    public static String BYTEDANCE_PUBLISH = "抖音发布";
    ...
    public static String WXWORK = "企业微信";
