...
public class PlatformConfig {
    ...
    public static class CustomPlatform implements Platform {
        ...
        /* JADX INFO: renamed from: p, reason: collision with root package name */
        private SHARE_MEDIA f24479p;

        public CustomPlatform(SHARE_MEDIA share_media) {
            this.f24479p = share_media;
        }
    ...
    static {
        ...
        Map<SHARE_MEDIA, Platform> map36 = configs;
        SHARE_MEDIA share_media36 = SHARE_MEDIA.BYTEDANCE;
        map36.put(share_media36, new APPIDPlatform(share_media36));
        Map<SHARE_MEDIA, Platform> map37 = configs;
        SHARE_MEDIA share_media37 = SHARE_MEDIA.BYTEDANCE_PUBLISH;
        map37.put(share_media37, new APPIDPlatform(share_media37));
        Map<SHARE_MEDIA, Platform> map38 = configs;
        SHARE_MEDIA share_media38 = SHARE_MEDIA.BYTEDANCE_FRIENDS;
        map38.put(share_media38, new APPIDPlatform(share_media38));
    }
    ...
    public static void setAlipay(String str) {
        ((APPIDPlatform) configs.get(SHARE_MEDIA.ALIPAY)).appId = str.replace(i0.f11861z, "");
    }
    ...
    public static void setBytedance(String str, String str2, String str3, String str4) {
        ...
        aPPIDPlatform.appId = str.replace(i0.f11861z, "");
        aPPIDPlatform.click_key = str2.replace(i0.f11861z, "");
        aPPIDPlatform.appkey = str3.replace(i0.f11861z, "");
        aPPIDPlatform.fileProvider = str4.replace(i0.f11861z, "");
        APPIDPlatform aPPIDPlatform2 = (APPIDPlatform) configs.get(SHARE_MEDIA.BYTEDANCE_PUBLISH);
        aPPIDPlatform2.appId = str.replace(i0.f11861z, "");
        aPPIDPlatform2.click_key = str2.replace(i0.f11861z, "");
        aPPIDPlatform2.appkey = str3.replace(i0.f11861z, "");
        aPPIDPlatform2.fileProvider = str4.replace(i0.f11861z, "");
        APPIDPlatform aPPIDPlatform3 = (APPIDPlatform) configs.get(SHARE_MEDIA.BYTEDANCE_FRIENDS);
        aPPIDPlatform3.appId = str.replace(i0.f11861z, "");
        aPPIDPlatform3.click_key = str2.replace(i0.f11861z, "");
        aPPIDPlatform3.appkey = str3.replace(i0.f11861z, "");
        aPPIDPlatform3.fileProvider = str4.replace(i0.f11861z, "");
    }

    public static void setDing(String str) {
        ((APPIDPlatform) configs.get(SHARE_MEDIA.DINGTALK)).appId = str.replace(i0.f11861z, "");
    }

    public static void setDingFileProvider(String str) {
        ((APPIDPlatform) configs.get(SHARE_MEDIA.DINGTALK)).fileProvider = str.replace(i0.f11861z, "");
    }

    public static void setDropbox(String str, String str2) {
        APPIDPlatform aPPIDPlatform = (APPIDPlatform) configs.get(SHARE_MEDIA.DROPBOX);
        aPPIDPlatform.appId = str.replace(i0.f11861z, "");
        aPPIDPlatform.appkey = str2.replace(i0.f11861z, "");
    }

    public static void setKakao(String str) {
        ((APPIDPlatform) configs.get(SHARE_MEDIA.KAKAO)).appId = str.replace(i0.f11861z, "");
    }
    ...
    public static void setLaiwang(String str, String str2) {
        ...
        aPPIDPlatform2.appId = str.replace(i0.f11861z, "");
        aPPIDPlatform2.appkey = str2.replace(i0.f11861z, "");
    }

    public static void setPinterest(String str) {
        ((APPIDPlatform) configs.get(SHARE_MEDIA.PINTEREST)).appId = str.replace(i0.f11861z, "");
    }

    public static void setQQFileProvider(String str) {
        ((APPIDPlatform) configs.get(SHARE_MEDIA.QZONE)).fileProvider = str.replace(i0.f11861z, "");
        ((APPIDPlatform) configs.get(SHARE_MEDIA.QQ)).fileProvider = str.replace(i0.f11861z, "");
    }
    ...
    public static void setSinaFileProvider(String str) {
        ((APPIDPlatform) configs.get(SHARE_MEDIA.SINA)).fileProvider = str.replace(i0.f11861z, "");
    }
    ...
    public static void setWXFileProvider(String str) {
        ((APPIDPlatform) configs.get(SHARE_MEDIA.WEIXIN)).fileProvider = str.replace(i0.f11861z, "");
        ((APPIDPlatform) configs.get(SHARE_MEDIA.WEIXIN_CIRCLE)).fileProvider = str.replace(i0.f11861z, "");
        ((APPIDPlatform) configs.get(SHARE_MEDIA.WEIXIN_FAVORITE)).fileProvider = str.replace(i0.f11861z, "");
    }
    ...
    public static void setWXWork(String str, String str2, String str3, String str4) {
        ...
        aPPIDPlatform.appId = str.replace(i0.f11861z, "");
        aPPIDPlatform.appkey = str2.replace(i0.f11861z, "");
        aPPIDPlatform.agentId = str3.replace(i0.f11861z, "");
        aPPIDPlatform.schema = str4.replace(i0.f11861z, "");
    }

    public static void setWXWorkFileProvider(String str) {
        ((APPIDPlatform) configs.get(SHARE_MEDIA.WXWORK)).fileProvider = str.replace(i0.f11861z, "");
    }
    ...
    public static void setWeixin(String str, String str2) {
        ...
        aPPIDPlatform3.appId = str.replace(i0.f11861z, "");
        aPPIDPlatform3.appkey = str2.replace(i0.f11861z, "");
    }

    public static void setYixin(String str) {
        ((APPIDPlatform) configs.get(SHARE_MEDIA.YIXIN)).appId = str.replace(i0.f11861z, "");
        ((APPIDPlatform) configs.get(SHARE_MEDIA.YIXIN_CIRCLE)).appId = str.replace(i0.f11861z, "");
    }
}
