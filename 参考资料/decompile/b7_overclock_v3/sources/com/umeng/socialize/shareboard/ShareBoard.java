...
public class ShareBoard extends PopupWindow {
    ...
    private void saveShareboardConfig(Context context, ShareBoardConfig shareBoardConfig) {
        ...
        int i10 = shareBoardConfig.mMenuBgShape;
        String str2 = i10 != ShareBoardConfig.BG_SHAPE_NONE ? i10 == ShareBoardConfig.BG_SHAPE_CIRCULAR ? "1" : i10 == ShareBoardConfig.BG_SHAPE_ROUNDED_SQUARE ? shareBoardConfig.mMenuBgShapeAngle != 0 ? "2" : "3" : null : "0";
        if (TextUtils.isEmpty(str) && TextUtils.isEmpty(str2)) {
            return;
        }
        SocializeSpUtils.putShareBoardConfig(context, str2 + ";" + str);
    }
    ...
    public ShareBoard(Context context, List<SnsPlatform> list, ShareBoardConfig shareBoardConfig) {
        ...
        shareBoardConfig.setOrientation(z10);
