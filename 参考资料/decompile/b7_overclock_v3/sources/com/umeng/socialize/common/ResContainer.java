...
public final class ResContainer {
    ...
    public static String getString(Context context, String str) {
        return context.getString(getResourceId(context, w.b.f53669e, str));
    }
    ...
    public synchronized Map<String, SocializeResource> batch() {
        ...
        while (it2.hasNext()) {
            SocializeResource socializeResource = this.mResources.get(it2.next());
    ...
    public int layout(String str) {
        return getResourceId(this.context, d.f55101w, str);
    }
    ...
    public int string(String str) {
        return getResourceId(this.context, w.b.f53669e, str);
    }
