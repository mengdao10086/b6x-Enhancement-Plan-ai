...
public class QZoneSsoHandler extends UMTencentSSOHandler {
    ...
    private IUiListener getAuthlistener(UMAuthListener uMAuthListener) {
        return new IUiListener() { // from class: com.umeng.socialize.handler.QZoneSsoHandler.4
            ...
            public void onComplete(Object obj) {
                ...
                if (oauthData != null) {
                    TextUtils.isEmpty(oauthData.getString(UMTencentSSOHandler.RET));
                }
            }
    ...
    public void onActivityResult(int i10, int i11, Intent intent) {
        if (i10 == 10104) {
            Tencent.onActivityResultData(i10, i11, intent, getmShareListener(this.mShareListener));
        }
        if (i10 == 11101) {
            Tencent.onActivityResultData(i10, i11, intent, getAuthlistener(this.mAuthListener));
        }
    }
