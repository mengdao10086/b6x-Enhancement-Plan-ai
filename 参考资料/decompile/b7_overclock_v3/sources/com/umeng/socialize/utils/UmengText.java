...
public class UmengText {
    ...
    public static class CACHE {
        ...
        private static String f24823id = "[SCC10000]";
        public static String CACHEFILE = f24823id + "缓存文件错误，请勿担心，不影响正常使用";
        public static String CLOSE = f24823id + "关闭流异常";
    ...
    public static class CHECK {
        ...
        public static String getActivityResult(int i10, int i11) {
            return "onActivityResult =" + i10 + "  resultCode=" + i11;
        }
    ...
    public static class IMAGE {
        ...
        /* JADX INFO: renamed from: id, reason: collision with root package name */
        private static String f24824id = "[SI10000]";
        public static String BINARYTOFILE = f24824id + "字节流转文件错误";
        public static String BITMAOTOBINARY = f24824id + "bitmap转字节流错误";
        public static String CLOSE = f24824id + "流关闭错误";
        public static String GET_FILE_FROM_BINARY = f24824id + "字节流输出文件出错";
        public static String TOOBIG = f24824id + "加载文件过大";
        public static String FILE_TO_BINARY_ERROR = f24824id + "文件转入字节流，先要进行压缩出错";
        public static String GET_IMAGE_SCALE_ERROR = f24824id + "获取文件大小出错";
        public static String READ_IMAGE_ERROR = f24824id + "读取图片文件出错";
        public static String CHECK_FORMAT_ERROR = f24824id + "checkFormat出错";
    ...
    public static class NET {
        ...
        /* JADX INFO: renamed from: id, reason: collision with root package name */
        private static String f24825id = "[SN10000]";
        public static String PARSEERROR = f24825id + "返回字符串不是json，可能是由于服务器不通造成";
        public static String TOOL = f24825id + "工具类内的错误，不影响用户使用";
        public static String IMAGEDOWN = "[SN10004]图片下载错误,请检查网址";
        public static String CLOSE = f24825id + "关闭流异常";
        public static String CREATE = f24825id + "构建response出错,不影响用户使用，但需要查明原因";
        ...
        public static String getURLERROR(String str) {
            return f24825id + "baseurl=" + str + " 该url不正确";
        }
    }
    ...
    public static String supportStyle(boolean z10, String str) {
        StringBuilder sb2 = new StringBuilder("该平台");
        sb2.append(z10 ? "只" : "不");
        sb2.append("支持");
    ...
    public static String tencentEmpty(boolean z10) {
        String str = z10 ? SIMPLE : FULL;
        return "您使用的是" + str + "但是你的AndroidManifest配置不正确，或者配置的不是" + str + "的路径，请参照线上报错必看文档";
    }

    public static String urlEmpty(int i10) {
        StringBuilder sb2 = new StringBuilder("错误:设置视频");
        if (i10 == 0) {
            sb2.append("视频");
        }
        if (i10 == 1) {
