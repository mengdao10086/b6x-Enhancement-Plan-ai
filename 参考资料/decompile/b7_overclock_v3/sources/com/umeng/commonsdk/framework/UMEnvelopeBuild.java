...
public class UMEnvelopeBuild {
    ...
    private static JSONObject add2CacheTable(Context context, JSONObject jSONObject, JSONObject jSONObject2, String str, String str2, String str3) {
        ...
        contentValues.put(ar.f23317e, str2);
        contentValues.put(ar.f23318f, iVarA.c(jSONObject.toString()));
        contentValues.put(ar.f23319g, iVarA.c(jSONObject2.toString()));
        contentValues.put(ar.f23320h, String.valueOf(jCurrentTimeMillis));
        contentValues.put(ar.f23321i, uuidRandomUUID.toString());
        contentValues.put(ar.f23322j, str);
        contentValues.put(ar.f23323k, str3);
        ap.a(context).a(ar.f23315c, contentValues);
        if ("i".equalsIgnoreCase(str2)) {
            UMRTLog.e(UMRTLog.RTLOG_TAG, "--->>> [有状态]inner业务，返回空 JSONObject。");
        } else if (an.aB.equalsIgnoreCase(str2)) {
    ...
    public static JSONObject buildEnvelopeWithExtHeader(Context context, JSONObject jSONObject, JSONObject jSONObject2) {
        return buildEnvelopeWithExtHeader(context, jSONObject, jSONObject2, UMServerURL.PATH_ANALYTICS, jSONObject.has("st") ? "t" : jSONObject2.has(an.f23219au) ? "i" : "a", "9.5.4");
    }
    ...
    */
    ...
    public static JSONObject buildEnvelopeWithExtHeader(Context context, JSONObject jSONObject, JSONObject jSONObject2, String str, String str2, String str3) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            if (!UMWorkDispatch.eventHasExist(com.umeng.commonsdk.internal.a.f24048t)) {
                UMWorkDispatch.sendEvent(context, com.umeng.commonsdk.internal.a.f24048t, com.umeng.commonsdk.internal.b.a(context).a(), null);
            }
