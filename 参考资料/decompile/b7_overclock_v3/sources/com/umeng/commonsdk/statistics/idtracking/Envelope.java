...
public class Envelope {
    ...
    public static Envelope genEncryptEnvelope(Context context, String str, byte[] bArr) {
        try {
            ...
            envelope.seal();
            sharedPreferences.edit().putInt("serial", i10 + 1).putString("signature", envelope.getSignature()).commit();
    ...
    private byte[] genGuid(byte[] bArr, int i10) {
        ...
        for (int i12 = 0; i12 < length; i12++) {
            int i13 = i12 * 2;
            bArr2[i13] = bArrHash2[i12];
            bArr2[i13 + 1] = bArrHash[i12];
        }
    ...
    public void export(Context context) {
        ...
        try {
            ...
            File file = new File(context.getFilesDir(), z.b().b(z.f23796b));
            if (!file.exists()) {
                file.mkdir();
            }
        ...
        try {
            ...
            HelperUtils.writeFile(new File(context.getFilesDir(), z.b().b(z.f23802h)), jSONObject2.toString());
        } catch (Throwable th3) {
            th3.printStackTrace();
        }
    }
    ...
    public byte[] toBinary() {
        ao aoVar = new ao();
        aoVar.a(this.mVersion);
        aoVar.b(this.mAddress);
        aoVar.c(DataHelper.toHexString(this.mSignature));
        aoVar.a(this.mSerialNo);
        aoVar.b(this.mTimestamp);
        aoVar.c(this.mLength);
        aoVar.a(this.mEntity);
        aoVar.d(this.encrypt ? 1 : 0);
        aoVar.d(DataHelper.toHexString(this.mGuid));
        aoVar.e(DataHelper.toHexString(this.mChecksum));
        try {
