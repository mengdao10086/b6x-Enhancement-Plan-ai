...
public abstract class a {
    ...
    private final int f24211a = 10;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final int f24212b = 100;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private final String f24213c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private List<com.umeng.commonsdk.statistics.proto.a> f24214d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private com.umeng.commonsdk.statistics.proto.b f24215e;
    ...
    private boolean g() {
        com.umeng.commonsdk.statistics.proto.b bVar = this.f24215e;
        ...
        if (this.f24214d == null) {
            this.f24214d = new ArrayList(2);
        }
        this.f24214d.add(aVar);
        if (this.f24214d.size() > 10) {
            this.f24214d.remove(0);
        }
        this.f24215e = bVar;
        return true;
    }
    ...
    public void a(com.umeng.commonsdk.statistics.proto.c cVar) {
        this.f24215e = cVar.c().get(this.f24213c);
        ...
        for (com.umeng.commonsdk.statistics.proto.a aVar : listH) {
            if (this.f24213c.equals(aVar.f24277a)) {
                this.f24214d.add(aVar);
            }
        }
    }
