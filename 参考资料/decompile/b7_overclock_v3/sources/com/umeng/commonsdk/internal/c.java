...
public class c implements UMLogDataProtocol {
    ...
    public static final String f24059b = "preInitInvokedFlag";

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static final String f24060c = "policyGrantInvokedFlag";

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public static final String f24061d = "policyGrantResult";

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private static int f24062f = 1;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private Context f24068e;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final String f24058a = z.b().b(z.f23811q);

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private static Class<?> f24063g = null;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    private static Method f24064h = null;

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    private static Method f24065i = null;

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    private static Method f24066j = null;

    /* JADX INFO: renamed from: k, reason: collision with root package name */
    private static boolean f24067k = false;
    ...
    public static String b() {
        Method method;
        Class<?> cls = f24063g;
        if (cls == null || (method = f24064h) == null || f24066j == null) {
            return "";
        }
        try {
            Object objInvoke = method.invoke(cls, new Object[0]);
            return objInvoke != null ? (String) f24066j.invoke(objInvoke, new Object[0]) : "";
    ...
    private static void c() {
        try {
            f24063g = ZIDManager.class;
            Method declaredMethod = ZIDManager.class.getDeclaredMethod("getInstance", new Class[0]);
            if (declaredMethod != null) {
                f24064h = declaredMethod;
            }
            Method declaredMethod2 = f24063g.getDeclaredMethod("getZID", Context.class);
            if (declaredMethod2 != null) {
                f24065i = declaredMethod2;
            }
            Method declaredMethod3 = f24063g.getDeclaredMethod("getSDKVersion", new Class[0]);
            if (declaredMethod3 != null) {
                f24066j = declaredMethod3;
            }
        } catch (Throwable unused) {
        }
    }
    ...
    private void d() {
        ap apVarA = ap.a(this.f24068e);
        aq aqVarA = apVarA.a(ar.f23315c);
        if (aqVarA != null) {
            UMRTLog.e(UMRTLog.RTLOG_TAG, "--->>> [有状态]二级缓存记录构建成真正信封。");
            try {
                String str = aqVarA.f23307a;
                String str2 = aqVarA.f23308b;
                JSONObject jSONObjectA = new com.umeng.commonsdk.statistics.b().a(this.f24068e.getApplicationContext(), new JSONObject(aqVarA.f23309c), new JSONObject(aqVarA.f23310d), aqVarA.f23311e, str2, aqVarA.f23312f);
    ...
    private void e() {
        if (f24067k) {
            ...
            f24067k = true;
            a(this.f24068e, new OnGetOaidListener() { // from class: com.umeng.commonsdk.internal.c.4
                ...
                public void onGetOaid(String str) {
                    ...
                    try {
                        SharedPreferences sharedPreferences = c.this.f24068e.getSharedPreferences(h.f24238a, 0);
                        if (sharedPreferences != null) {
                            SharedPreferences.Editor editorEdit = sharedPreferences.edit();
                            editorEdit.putString(h.f24239b, str);
                            editorEdit.commit();
                        }
                    } catch (Throwable unused) {
                    }
                    UMWorkDispatch.sendEvent(c.this.f24068e, a.f24051w, b.a(c.this.f24068e).a(), null);
                }
            });
        }
    }
    ...
    private void f() {
        if (FieldManager.allow(com.umeng.commonsdk.utils.d.G)) {
            ...
            UMConfigureImpl.init(this.f24068e);
            f24062f++;
            ...
            UMConfigureImpl.registerMessageSendListener(new onMessageSendListener() { // from class: com.umeng.commonsdk.internal.c.5
                ...
                public void onMessageSend() {
                    if (c.this.f24068e != null) {
                        UMWorkDispatch.sendEvent(c.this.f24068e, a.f24052x, b.a(c.this.f24068e).a(), null);
                    }
    ...
    private void h() {
        ...
        if (UMUtils.isMainProgress(this.f24068e)) {
            f(this.f24068e);
            com.umeng.commonsdk.a.a(this.f24068e);
            Context context = this.f24068e;
            UMWorkDispatch.sendEvent(context, o.a.f23739y, CoreProtocol.getInstance(context), null);
            Context context2 = this.f24068e;
            UMWorkDispatch.sendEvent(context2, a.f24048t, b.a(context2).a(), null);
        }
    }
    ...
    */
    public void workEvent(java.lang.Object r13, int r14) throws org.json.JSONException, java.lang.IllegalAccessException, java.lang.reflect.InvocationTargetException {
        /*
    ...
    public String a() {
        Method method;
        Class<?> cls = f24063g;
        if (cls == null || (method = f24064h) == null || f24065i == null) {
            return "";
        }
        try {
            Object objInvoke = method.invoke(cls, new Object[0]);
            return objInvoke != null ? (String) f24065i.invoke(objInvoke, this.f24068e) : "";
        } catch (Throwable unused) {
            return "";
        }
    }
        ...
        if (FieldManager.allow(com.umeng.commonsdk.utils.d.G)) {
            a(context, new OnGetOaidListener() { // from class: com.umeng.commonsdk.internal.c.3
                ...
                public void onGetOaid(String str) {
                    ...
                    try {
                        SharedPreferences sharedPreferences = context.getSharedPreferences(h.f24238a, 0);
                        if (sharedPreferences == null || sharedPreferences.getString(h.f24239b, "").equalsIgnoreCase(str)) {
                            return;
                        }
    ...
    private static void f(Context context) {
        File file = new File(context.getFilesDir().getAbsolutePath() + File.separator + ar.f23324l);
        if (file.exists()) {
            return;
        }
        try {
            ...
            public void run() {
                try {
                    ...
                    if (!TextUtils.isEmpty(strA) && sharedPreferences != null) {
                        SharedPreferences.Editor editorEdit = sharedPreferences.edit();
                        editorEdit.putString(h.f24240c, (jCurrentTimeMillis2 - jCurrentTimeMillis) + "");
                        editorEdit.commit();
                    }
                    if (sharedPreferences != null) {
                        SharedPreferences.Editor editorEdit2 = sharedPreferences.edit();
                        editorEdit2.putString(h.f24239b, strA);
                        editorEdit2.commit();
                    }
                    if (z10) {
