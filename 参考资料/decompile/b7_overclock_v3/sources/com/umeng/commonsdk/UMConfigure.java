...
public class UMConfigure {
    ...
    private static final String[] BUSINESS_TYPE = {"apm", "push", "share", "ulink", "uverify", "usms", "urec", "abtest", "game", an.f23210al};
    ...
    private static void setLatencyWindow(long j10) {
        com.umeng.commonsdk.statistics.a.f24152c = ((int) j10) * 1000;
    }
    ...
    public static void setLogEnabled(boolean z10) {
        try {
            ...
            if (debugLog) {
                ...
                sb3.append("set log enabled e is ");
                sb3.append(th2);
            }
        }
    }
    ...
    private static void setWraperType(String str, String str2) {
        if (!TextUtils.isEmpty(str)) {
            if (str.equals(WRAPER_TYPE_NATIVE)) {
                com.umeng.commonsdk.stateless.a.f24120a = WRAPER_TYPE_NATIVE;
                com.umeng.commonsdk.statistics.a.f24150a = WRAPER_TYPE_NATIVE;
            } else if (str.equals(WRAPER_TYPE_COCOS2DX_X)) {
                com.umeng.commonsdk.stateless.a.f24120a = WRAPER_TYPE_COCOS2DX_X;
                com.umeng.commonsdk.statistics.a.f24150a = WRAPER_TYPE_COCOS2DX_X;
            } else if (str.equals(WRAPER_TYPE_COCOS2DX_XLUA)) {
                com.umeng.commonsdk.stateless.a.f24120a = WRAPER_TYPE_COCOS2DX_XLUA;
                com.umeng.commonsdk.statistics.a.f24150a = WRAPER_TYPE_COCOS2DX_XLUA;
            } else if (str.equals(WRAPER_TYPE_UNITY)) {
                com.umeng.commonsdk.stateless.a.f24120a = WRAPER_TYPE_UNITY;
                com.umeng.commonsdk.statistics.a.f24150a = WRAPER_TYPE_UNITY;
            } else if (str.equals(WRAPER_TYPE_REACTNATIVE)) {
                com.umeng.commonsdk.stateless.a.f24120a = WRAPER_TYPE_REACTNATIVE;
                com.umeng.commonsdk.statistics.a.f24150a = WRAPER_TYPE_REACTNATIVE;
            } else if (str.equals(WRAPER_TYPE_PHONEGAP)) {
                com.umeng.commonsdk.stateless.a.f24120a = WRAPER_TYPE_PHONEGAP;
                com.umeng.commonsdk.statistics.a.f24150a = WRAPER_TYPE_PHONEGAP;
            } else if (str.equals(WRAPER_TYPE_WEEX)) {
                com.umeng.commonsdk.stateless.a.f24120a = WRAPER_TYPE_WEEX;
                com.umeng.commonsdk.statistics.a.f24150a = WRAPER_TYPE_WEEX;
            } else if (str.equals(WRAPER_TYPE_HYBRID)) {
                com.umeng.commonsdk.stateless.a.f24120a = WRAPER_TYPE_HYBRID;
                com.umeng.commonsdk.statistics.a.f24150a = WRAPER_TYPE_HYBRID;
            } else if (str.equals(WRAPER_TYPE_FLUTTER)) {
                com.umeng.commonsdk.stateless.a.f24120a = WRAPER_TYPE_FLUTTER;
                com.umeng.commonsdk.statistics.a.f24150a = WRAPER_TYPE_FLUTTER;
            }
        }
        if (TextUtils.isEmpty(str2)) {
            return;
        }
        com.umeng.commonsdk.stateless.a.f24121b = str2;
        com.umeng.commonsdk.statistics.a.f24151b = str2;
    }
    ...
    public static void submitPolicyGrantResult(Context context, boolean z10) {
        ...
        UMWorkDispatch.sendEvent(context, com.umeng.commonsdk.internal.a.f24054z, com.umeng.commonsdk.internal.b.a(context).a(), Integer.valueOf(policyGrantResult));
    }
    ...
    public static void init(Context context, String str, String str2, int i10, String str3) {
        ...
        try {
            try {
                if (debugLog) {
                    StringBuilder sb2 = new StringBuilder();
                    sb2.append("common type is ");
                    sb2.append(SdkVersion.SDK_TYPE);
                }
            } catch (Throwable th2) {
                if (debugLog) {
                    StringBuilder sb3 = new StringBuilder();
        ...
        if (debugLog) {
            ...
            sb5.append("current appkey is ");
            sb5.append(sAppkey);
            sb5.append(", last appkey is ");
            sb5.append(lastAppkey);
        }
        if (debugLog) {
        ...
        try {
            ...
            if (b.f24153a.indexOf("e") >= 0 && (declaredMethod4 = MobclickAgent.class.getDeclaredMethod("disableExceptionCatch", new Class[0])) != null) {
        ...
        try {
            Class<?> cls4 = Class.forName("com.umeng.message.MessageSharedPrefs");
            Method declaredMethod7 = cls4.getDeclaredMethod("getInstance", Context.class);
            if (declaredMethod7 != null && (objInvoke2 = declaredMethod7.invoke(cls4, applicationContext)) != null) {
                Method declaredMethod8 = cls4.getDeclaredMethod("setMessageAppKey", String.class);
                ...
                Method declaredMethod9 = cls4.getDeclaredMethod(KEY_METHOD_NAME_PUSH_SETCHANNEL, String.class);
                ...
                if (!TextUtils.isEmpty(str3)) {
                    if (debugLog) {
                        ...
                        sb7.append("push secret is ");
                        sb7.append(str3);
                    }
                    Method declaredMethod10 = cls4.getDeclaredMethod("setMessageAppSecret", String.class);
        ...
        try {
            Class<?> cls5 = getClass("com.umeng.socialize.UMShareAPI");
            setFile(cls5, KEY_FILE_NAME_APPKEY, sAppkey);
            if (cls5 != null && (declaredMethod3 = cls5.getDeclaredMethod("init", Context.class, String.class)) != null) {
                declaredMethod3.setAccessible(true);
                declaredMethod3.invoke(cls5, applicationContext, sAppkey);
                if (debugLog) {
        ...
        try {
            ...
            Method declaredMethod11 = cls6.getDeclaredMethod("init", Context.class);
            if (declaredMethod11 != null) {
                declaredMethod11.setAccessible(true);
                declaredMethod11.invoke(cls6, applicationContext);
                if (debugLog) {
        ...
        try {
            if (getClass("com.umeng.umefs.UMEfs") == null && (cls = getClass("com.umeng.umcrash.UMCrash")) != null) {
                ...
                Method declaredMethod12 = cls.getDeclaredMethod("init", Context.class, String.class, String.class);
                if (declaredMethod12 != null) {
                    declaredMethod12.setAccessible(true);
                    declaredMethod12.invoke(cls, applicationContext, sAppkey, sChannel);
                    if (debugLog) {
        ...
        try {
            ...
            if (declaredMethod13 != null) {
                declaredMethod13.invoke(null, applicationContext, sAppkey, sChannel, Integer.valueOf(i10), str3);
        ...
        if (needCheckPolicyResult(applicationContext)) {
            synchronized (lock) {
                int i11 = preInitInvokedFlag;
                int i12 = policyGrantResult;
                try {
        ...
        if (needSendZcfgEnv(applicationContext)) {
            ...
            UMWorkDispatch.sendEvent(applicationContext, com.umeng.commonsdk.internal.a.f24044p, com.umeng.commonsdk.internal.b.a(applicationContext).a(), null);
        } else {
            UMRTLog.e(UMRTLog.RTLOG_TAG, "--->>> 走正常逻辑.");
            if (FieldManager.b()) {
                UMWorkDispatch.sendEvent(applicationContext, com.umeng.commonsdk.internal.a.f24053y, com.umeng.commonsdk.internal.b.a(applicationContext).a(), null);
            }
