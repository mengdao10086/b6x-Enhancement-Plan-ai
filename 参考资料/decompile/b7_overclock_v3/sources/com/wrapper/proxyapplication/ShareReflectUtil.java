...
public class ShareReflectUtil {
    ...
    public static void reduceFieldArray(Object obj, String str, int i10) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
        if (i10 <= 0) {
            return;
        }
        Field fieldFindField = findField(obj, str);
    ...
    public static int getValueOfStaticIntField(Class<?> cls, String str, int i10) {
        try {
