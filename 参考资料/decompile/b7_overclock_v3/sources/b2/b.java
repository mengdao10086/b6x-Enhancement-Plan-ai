...
public class b {
    @n0
    public static Cursor a(@n0 Cursor cursor) {
        try {
    ...
    public static int b(@n0 Cursor cursor, @n0 String str) {
    ...
    public static int c(String[] strArr, String str) {
        String str2 = j3.b.f36044h + str;
        String str3 = j3.b.f36044h + str + "`";
    ...
    public static int d(@n0 Cursor cursor, @n0 String str) {
    ...
    public static int e(@n0 Cursor cursor, @n0 String str) {
        String string;
        int iD = d(cursor, str);
        if (iD >= 0) {
            return iD;
