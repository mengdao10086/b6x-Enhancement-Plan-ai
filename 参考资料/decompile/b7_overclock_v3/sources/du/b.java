...
public class b {
    ...
    public cu.a f26531a = null;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public String f26532b = null;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public String f26533c = null;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public final Object f26534d = new Object();

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public ServiceConnection f26535e = new a();
    ...
    public class a implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            b.this.f26531a = a.AbstractBinderC0285a.Q0(iBinder);
            synchronized (b.this.f26534d) {
                b.this.f26534d.notify();
            }
        }
    ...
    /* JADX INFO: renamed from: du.b$b, reason: collision with other inner class name */
    public static class C0303b {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public static final b f26537a = new b(null);
    }
    ...
    */
    public synchronized java.lang.String a(android.content.Context r5, java.lang.String r6) {
        /*
            ...
            if (r0 == r1) goto L67
            cu.a r0 = r4.f26531a     // Catch: java.lang.Throwable -> L6f
            if (r0 != 0) goto L59
            ...
            android.content.ServiceConnection r1 = r4.f26535e     // Catch: java.lang.Throwable -> L6f
            r2 = 1
            boolean r0 = r5.bindService(r0, r1, r2)     // Catch: java.lang.Throwable -> L6f
            if (r0 == 0) goto L43
            java.lang.Object r0 = r4.f26534d     // Catch: java.lang.Throwable -> L6f
            monitor-enter(r0)     // Catch: java.lang.Throwable -> L6f
            java.lang.Object r1 = r4.f26534d     // Catch: java.lang.Throwable -> L39 java.lang.InterruptedException -> L3b
        ...
        L43:
            ...
            return r5
        L4b:
            java.lang.String r5 = r4.c(r5, r6)     // Catch: android.os.RemoteException -> L51 java.lang.Throwable -> L6f
            monitor-exit(r4)
            return r5
        L51:
            r5 = move-exception
            ...
            return r5
        L59:
            java.lang.String r5 = r4.c(r5, r6)     // Catch: android.os.RemoteException -> L5f java.lang.Throwable -> L6f
            monitor-exit(r4)
            return r5
        L5f:
            r5 = move-exception
        ...
        L6f:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: du.b.a(android.content.Context, java.lang.String):java.lang.String");
    }
    ...
    public final String c(Context context, String str) {
        ...
        if (TextUtils.isEmpty(this.f26532b)) {
            this.f26532b = context.getPackageName();
        }
        if (TextUtils.isEmpty(this.f26533c)) {
            String string = null;
            try {
                signatureArr = context.getPackageManager().getPackageInfo(this.f26532b, 64).signatures;
            } catch (PackageManager.NameNotFoundException e10) {
                e10.printStackTrace();
                signatureArr = null;
            }
        ...
        String strQ0 = ((a.AbstractBinderC0285a.C0286a) this.f26531a).Q0(this.f26532b, this.f26533c, str);
        return TextUtils.isEmpty(strQ0) ? "" : strQ0;
    }
}
