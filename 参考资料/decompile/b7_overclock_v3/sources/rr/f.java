...
public abstract class f {
    ...
    public static final long f49136a = 4294967295L;
    ...
    public static void C(int[] iArr, int i10, int[] iArr2, int i11) {
        ...
        while (true) {
            ...
            if (i15 <= 0) {
                ...
                long j36 = (j28 & 4294967295L) + (j10 * j32);
                int i29 = (int) j36;
                iArr2[i21] = (i29 << 1) | (i26 >>> 31);
    ...
    public static void D(int[] iArr, int[] iArr2) {
        ...
        while (true) {
            ...
            if (i13 <= 0) {
                ...
                long j36 = 4294967295L & j33;
                long j37 = (j29 & 4294967295L) + (j32 * j10);
                int i20 = (int) j37;
                iArr2[4] = i19 | (i20 << 1);
                long j38 = (j30 & 4294967295L) + (j37 >>> 32) + (j14 * j32);
                long j39 = j34 + (j38 >>> 32) + (j32 * j18);
                long j40 = j36 + (j39 >>> 32) + (j32 * j24);
                long j41 = j35 + (j40 >>> 32);
                int i21 = (int) j38;
                ...
                int i26 = (int) j41;
                iArr2[8] = i25 | (i26 << 1);
                iArr2[9] = (i26 >>> 31) | ((iArr2[9] + ((int) (j41 >>> 32))) << 1);
                return;
            }
            i11 = i13;
            i12 = i15;
    ...
    public static BigInteger J(int[] iArr) {
        ...
        for (int i10 = 0; i10 < 5; i10++) {
            int i11 = iArr[i10];
            if (i11 != 0) {
                org.bouncycastle.util.o.h(i11, bArr, (4 - i10) << 2);
            }
        }
    ...
    public static boolean j(int[] iArr, int i10, int[] iArr2, int i11, int[] iArr3, int i12) {
        boolean zN = n(iArr, i10, iArr2, i11);
        if (zN) {
    ...
    public static void r(int[] iArr, int i10, int[] iArr2, int i11, int[] iArr3, int i12) {
        ...
        while (i15 < 5) {
            i14 += i13;
            long j21 = ((long) iArr[i10 + i15]) & 4294967295L;
            int i16 = i14 + 0;
            long j22 = (j21 * j10) + (((long) iArr3[i16]) & 4294967295L) + 0;
            iArr3[i16] = (int) j22;
            int i17 = i14 + 1;
            long j23 = (j22 >>> 32) + (j21 * j11) + (((long) iArr3[i17]) & 4294967295L);
            iArr3[i17] = (int) j23;
            int i18 = i14 + 2;
            long j24 = (j23 >>> 32) + (j21 * j12) + (((long) iArr3[i18]) & 4294967295L);
            iArr3[i18] = (int) j24;
            int i19 = i14 + 3;
            long j25 = (j24 >>> 32) + (j21 * j13) + (((long) iArr3[i19]) & 4294967295L);
            iArr3[i19] = (int) j25;
            int i20 = i14 + 4;
            long j26 = (j25 >>> 32) + (j21 * j14) + (((long) iArr3[i20]) & 4294967295L);
            iArr3[i20] = (int) j26;
            iArr3[i14 + 5] = (int) (j26 >>> 32);
            i15++;
            j12 = j12;
            j10 = j10;
            i13 = 1;
    ...
    public static void s(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i12 = 5; i10 < i12; i12 = 5) {
            ...
            int i13 = i10 + 0;
            long j22 = (j21 * j10) + (((long) iArr3[i13]) & 4294967295L) + 0;
            iArr3[i13] = (int) j22;
            int i14 = i10 + 1;
            long j23 = j11;
            long j24 = (j22 >>> 32) + (j21 * j11) + (((long) iArr3[i14]) & 4294967295L);
            iArr3[i14] = (int) j24;
            int i15 = i10 + 2;
            long j25 = j14;
            long j26 = (j24 >>> 32) + (j21 * j12) + (((long) iArr3[i15]) & 4294967295L);
            iArr3[i15] = (int) j26;
            int i16 = i10 + 3;
            long j27 = (j26 >>> 32) + (j21 * j13) + (((long) iArr3[i16]) & 4294967295L);
            iArr3[i16] = (int) j27;
            int i17 = i10 + 4;
            long j28 = (j27 >>> 32) + (j21 * j25) + (((long) iArr3[i17]) & 4294967295L);
            iArr3[i17] = (int) j28;
    ...
    public static int w(int[] iArr, int i10, int[] iArr2, int i11, int[] iArr3, int i12) {
        ...
        long j16 = 0;
        while (i14 < 5) {
            long j17 = ((long) iArr[i10 + i14]) & j10;
            int i15 = i13 + 0;
