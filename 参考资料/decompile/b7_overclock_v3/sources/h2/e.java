...
public class e {
    ...
    public static final String f30297a = "AnimatorInflater";

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final int f30298b = 0;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static final int f30299c = 100;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public static final int f30300d = 0;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public static final int f30301e = 1;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    public static final int f30302f = 2;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public static final int f30303g = 3;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    public static final int f30304h = 4;

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    public static final boolean f30305i = false;

    public static class a implements TypeEvaluator<n.b[]> {
        ...
        public n.b[] evaluate(float f10, n.b[] bVarArr, n.b[] bVarArr2) {
            if (!n.b(bVarArr, bVarArr2)) {
                throw new IllegalArgumentException("Can't interpolate between two incompatible pathData");
            }
            if (!n.b(this.f30306a, bVarArr)) {
                this.f30306a = n.f(bVarArr);
            }
            for (int i10 = 0; i10 < bVarArr.length; i10++) {
                this.f30306a[i10].d(bVarArr[i10], bVarArr2[i10], f10);
            }
            return this.f30306a;
        }

        public a(n.b[] bVarArr) {
            this.f30306a = bVarArr;
        }
    }
    ...
    */
    public static android.animation.Animator b(android.content.Context r18, android.content.res.Resources r19, android.content.res.Resources.Theme r20, org.xmlpull.v1.XmlPullParser r21, android.util.AttributeSet r22, android.animation.AnimatorSet r23, int r24, float r25) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: h2.e.b(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser, android.util.AttributeSet, android.animation.AnimatorSet, int, float):android.animation.Animator");
    }
    ...
    public static void e(Object[] objArr, String str) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            ...
            Object value = i0.f11859x;
            sb2.append(fraction < 0.0f ? i0.f11859x : Float.valueOf(keyframe.getFraction()));
            sb2.append(", , value : ");
    ...
    public static PropertyValuesHolder f(TypedArray typedArray, int i10, int i11, int i12, String str) {
        ...
        n.b[] bVarArrD = n.d(string);
        n.b[] bVarArrD2 = n.d(string2);
    ...
    public static int h(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray typedArrayS = j0.n.s(resources, theme, attributeSet, h2.a.f30239h0);
        int i10 = 0;
        TypedValue typedValueT = j0.n.t(typedArrayS, xmlPullParser, "value", 0);
    ...
    public static Animator j(Context context, @g.b int i10) throws Resources.NotFoundException {
    ...
    public static Animator k(Context context, Resources resources, Resources.Theme theme, @g.b int i10) throws Resources.NotFoundException {
        return l(context, resources, theme, i10, 1.0f);
    }

    public static Animator l(Context context, Resources resources, Resources.Theme theme, @g.b int i10, float f10) throws Resources.NotFoundException {
    ...
    public static ValueAnimator m(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f10, XmlPullParser xmlPullParser) throws Resources.NotFoundException {
        TypedArray typedArrayS = j0.n.s(resources, theme, attributeSet, h2.a.R);
        TypedArray typedArrayS2 = j0.n.s(resources, theme, attributeSet, h2.a.f30249m0);
        if (valueAnimator == null) {
            valueAnimator = new ValueAnimator();
        }
        r(valueAnimator, typedArrayS, typedArrayS2, f10, xmlPullParser);
        int iL = j0.n.l(typedArrayS, xmlPullParser, "interpolator", 0, 0);
        if (iL > 0) {
    ...
    public static Keyframe n(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i10, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        TypedArray typedArrayS = j0.n.s(resources, theme, attributeSet, h2.a.f30239h0);
        float fJ = j0.n.j(typedArrayS, xmlPullParser, "fraction", 3, -1.0f);
        TypedValue typedValueT = j0.n.t(typedArrayS, xmlPullParser, "value", 0);
        boolean z10 = typedValueT != null;
        if (i10 == 4) {
            i10 = (z10 && i(typedValueT.type)) ? 3 : 0;
        }
        Keyframe keyframeOfInt = z10 ? i10 != 0 ? (i10 == 1 || i10 == 3) ? Keyframe.ofInt(fJ, j0.n.k(typedArrayS, xmlPullParser, "value", 0, 0)) : null : Keyframe.ofFloat(fJ, j0.n.j(typedArrayS, xmlPullParser, "value", 0, 0.0f)) : i10 == 0 ? Keyframe.ofFloat(fJ) : Keyframe.ofInt(fJ);
        int iL = j0.n.l(typedArrayS, xmlPullParser, "interpolator", 1, 0);
        if (iL > 0) {
        ...
        while (true) {
            ...
            if (eventType != 2) {
                ...
                if (xmlPullParser.getName().equals("propertyValuesHolder")) {
                    TypedArray typedArrayS = j0.n.s(resources, theme, attributeSet, h2.a.f30229c0);
                    String strM = j0.n.m(typedArrayS, xmlPullParser, "propertyName", 3);
                    int iK = j0.n.k(typedArrayS, xmlPullParser, "valueType", 2, 4);
    ...
    public static void r(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f10, XmlPullParser xmlPullParser) {
        long jK = j0.n.k(typedArray, xmlPullParser, "duration", 1, 300);
        long jK2 = j0.n.k(typedArray, xmlPullParser, "startOffset", 2, 0);
        int iK = j0.n.k(typedArray, xmlPullParser, "valueType", 7, 4);
        if (j0.n.r(xmlPullParser, "valueFrom") && j0.n.r(xmlPullParser, "valueTo")) {
            if (iK == 4) {
                iK = g(typedArray, 5, 6);
            }
        ...
        valueAnimator.setRepeatCount(j0.n.k(typedArray, xmlPullParser, "repeatCount", 3, 0));
        valueAnimator.setRepeatMode(j0.n.k(typedArray, xmlPullParser, "repeatMode", 4, 1));
        if (typedArray2 != null) {
    ...
    public static void s(ValueAnimator valueAnimator, TypedArray typedArray, int i10, float f10, XmlPullParser xmlPullParser) {
        ...
        String strM = j0.n.m(typedArray, xmlPullParser, "pathData", 1);
        if (strM == null) {
            objectAnimator.setPropertyName(j0.n.m(typedArray, xmlPullParser, "propertyName", 0));
            return;
        }
        String strM2 = j0.n.m(typedArray, xmlPullParser, "propertyXName", 2);
        String strM3 = j0.n.m(typedArray, xmlPullParser, "propertyYName", 3);
        if (i10 != 2) {
        }
        if (strM2 != null || strM3 != null) {
            t(n.e(strM), objectAnimator, f10 * 0.5f, strM2, strM3);
            return;
        }
