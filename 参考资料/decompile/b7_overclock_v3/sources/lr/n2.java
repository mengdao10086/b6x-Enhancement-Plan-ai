...
public class n2 extends i.b {
    public n2(ir.e eVar, ir.f fVar, ir.f fVar2) {
        super(eVar, fVar, fVar2);
    }

    public n2(ir.e eVar, ir.f fVar, ir.f fVar2, ir.f[] fVarArr) {
    ...
    public ir.i A() {
        ...
        return new n2(this.f35706a, fVar, fVar2.a(fVar3), new ir.f[]{fVar3});
    }
    ...
    public ir.i M() {
        ...
        if (fVarA.j()) {
            return new n2(eVarI, fVarA, eVarI.q());
        }
        ir.f fVarP3 = fVarA.p();
        ...
        return new n2(eVarI, fVarP3, fVarP4.a(fVarA).a(fVarP2).k(fVarP4).a(fVarP).a(fVarP3).a(fVarK), new ir.f[]{fVarK});
    }
    ...
    public ir.i N(ir.i iVar) {
        ...
        if (fVarM.j()) {
            return new n2(eVarI, fVarM, eVarI.q());
        }
        ir.f fVarK2 = fVarM.p().k(fVarK);
        ir.f fVarK3 = fVarM.k(fVarP4).k(fVarP3);
        return new n2(eVarI, fVarK2, fVarM.a(fVarP4).p().m(fVarA, fVarB, fVarK3), new ir.f[]{fVarK3});
    }
    ...
    public ir.i a(ir.i iVar) {
        ...
        if (fVarN2.j()) {
            ...
            if (fVarK7.j()) {
                return new n2(eVarI, fVarK7, eVarI.q());
            }
        ...
        return new n2(eVarI, fVarA, fVarA2, new ir.f[]{fVarN});
    }
