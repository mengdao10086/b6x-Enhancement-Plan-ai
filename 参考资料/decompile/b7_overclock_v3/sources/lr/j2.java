...
public class j2 extends i.b {
    public j2(ir.e eVar, ir.f fVar, ir.f fVar2) {
        super(eVar, fVar, fVar2);
    }

    public j2(ir.e eVar, ir.f fVar, ir.f fVar2, ir.f[] fVarArr) {
    ...
    public ir.i A() {
        ...
        return new j2(this.f35706a, fVar, fVar2.a(fVar3), new ir.f[]{fVar3});
    }
    ...
    public ir.i M() {
        ...
        if (fVarA.j()) {
            return new j2(eVarI, fVarA, eVarI.q().o());
        }
        ir.f fVarP2 = fVarA.p();
        ...
        return new j2(eVarI, fVarP2, fVarK.r(fVarA, fVarK2).a(fVarP2).a(fVarK3), new ir.f[]{fVarK3});
    }
    ...
    public ir.i N(ir.i iVar) {
        ...
        if (fVarM.j()) {
            return new j2(eVarI, fVarM, eVarI.q().o());
        }
        ir.f fVarK2 = fVarM.p().k(fVarK);
        ir.f fVarK3 = fVarM.k(fVarP4).k(fVarP3);
        return new j2(eVarI, fVarK2, fVarM.a(fVarP4).p().m(fVarA, fVarO.b(), fVarK3), new ir.f[]{fVarK3});
    }
    ...
    public ir.i a(ir.i iVar) {
        ...
        if (fVarN2.j()) {
            ...
            if (fVarB.j()) {
                return new j2(eVarI, fVarB, eVarI.q().o());
            }
            ...
            if (fVarK7.j()) {
                return new j2(eVarI, fVarK7, eVarI.q().o());
            }
        ...
        return new j2(eVarI, fVarB, fVarA, new ir.f[]{fVarN});
    }

    @Override // ir.i
    public ir.i d() {
        return new j2(null, f(), g());
    }
