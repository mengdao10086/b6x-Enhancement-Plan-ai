...
public class e extends e.c {
    ...
    public static final int f40175s = 2;

    /* JADX INFO: renamed from: q, reason: collision with root package name */
    public f f40177q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    public static final BigInteger f40174r = m.f40280h;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    public static final ir.f[] f40176t = {new m(ir.d.f35647b)};

    public class a extends ir.a {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final /* synthetic */ int f40178a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        public final /* synthetic */ int[] f40179b;
        ...
        public ir.i a(int i10) {
            ...
            int[] iArrH2 = rr.f.h();
            int i11 = 0;
            for (int i12 = 0; i12 < this.f40178a; i12++) {
                int i13 = ((i12 ^ i10) - 1) >> 31;
                for (int i14 = 0; i14 < 5; i14++) {
                    int i15 = iArrH[i14];
                    int[] iArr = this.f40179b;
        ...
        public final ir.i d(int[] iArr, int[] iArr2) {
            return e.this.j(new m(iArr), new m(iArr2), e.f40176t);
        }
    }

    public e() {
        super(f40174r);
        this.f40177q = new f(this, null, null);
        this.f35662b = n(ir.d.f35646a);
        this.f35663c = n(BigInteger.valueOf(7L));
        this.f35664d = new BigInteger(1, jt.h.d("0100000000000000000001B8FA16DFAB9ACA16B6B3"));
