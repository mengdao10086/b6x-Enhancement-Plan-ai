...
public class i2 extends e.b {
    ...
    public static final int f40245s = 6;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    public static final ir.f[] f40246t = {new f2(ir.d.f35647b)};
    ...
    public class a extends ir.a {
        ...
        public final /* synthetic */ long[] f40249b;
        ...
        public ir.i a(int i10) {
            ...
            long[] jArrC2 = rr.j.c();
            int i11 = 0;
            for (int i12 = 0; i12 < this.f40248a; i12++) {
                long j10 = ((i12 ^ i10) - 1) >> 31;
                for (int i13 = 0; i13 < 5; i13++) {
                    long j11 = jArrC[i13];
                    long[] jArr = this.f40249b;
        ...
        public final ir.i d(long[] jArr, long[] jArr2) {
            return i2.this.j(new f2(jArr), new f2(jArr2), i2.f40246t);
        }
    }

    public i2() {
        super(DfuBaseService.NOTIFICATION_ID, 5, 7, 12);
        this.f40247r = new j2(this, null, null);
        this.f35662b = n(BigInteger.valueOf(1L));
        this.f35663c = n(new BigInteger(1, jt.h.d("027B680AC8B8596DA5A4AF8A19A0303FCA97FD7645309FA2A581485AF6263E313B79A2F5")));
        this.f35664d = new BigInteger(1, jt.h.d("03FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEF90399660FC938A90165B042A7CEFADB307"));
