...
public class x0 extends i.b {
    public x0(ir.e eVar, ir.f fVar, ir.f fVar2) {
        super(eVar, fVar, fVar2);
    }

    public x0(ir.e eVar, ir.f fVar, ir.f fVar2, ir.f[] fVarArr) {
    ...
    public ir.i A() {
        ...
        return new x0(this.f35706a, fVar, fVar2.a(fVar3), new ir.f[]{fVar3});
    }
    ...
    public ir.i M() {
        ...
        if (fVarA.j()) {
            return new x0(eVarI, fVarA, eVarI.q().o());
        }
        ir.f fVarP2 = fVarA.p();
        ...
        return new x0(eVarI, fVarP2, fVarK.r(fVarA, fVarK2).a(fVarP2).a(fVarK3), new ir.f[]{fVarK3});
    }
    ...
    public ir.i N(ir.i iVar) {
        ...
        if (fVarM.j()) {
            return new x0(eVarI, fVarM, eVarI.q().o());
        }
        ir.f fVarK2 = fVarM.p().k(fVarK);
        ir.f fVarK3 = fVarM.k(fVarP4).k(fVarP3);
        return new x0(eVarI, fVarK2, fVarM.a(fVarP4).p().m(fVarA, fVarB, fVarK3), new ir.f[]{fVarK3});
    }
    ...
    public ir.i a(ir.i iVar) {
        ...
        if (fVarN2.j()) {
            ...
            if (fVarK7.j()) {
                return new x0(eVarI, fVarK7, eVarI.q().o());
            }
        ...
        return new x0(eVarI, fVarA, fVarA2, new ir.f[]{fVarN});
    }

    @Override // ir.i
    public ir.i d() {
        return new x0(null, f(), g());
    }
