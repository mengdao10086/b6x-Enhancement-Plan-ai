...
public class n extends i.c {
    public n(ir.e eVar, ir.f fVar, ir.f fVar2) {
        super(eVar, fVar, fVar2);
    }

    public n(ir.e eVar, ir.f fVar, ir.f fVar2, ir.f[] fVarArr) {
        super(eVar, fVar, fVar2, fVarArr);
    }

    @Override // ir.i
    public ir.i A() {
        return v() ? this : new n(this.f35706a, this.f35707b, this.f35708c.n(), this.f35709d);
    }
    ...
    public ir.i M() {
        ...
        int[] iArrH2 = rr.f.h();
        int[] iArrH3 = rr.f.h();
        l.o(mVar.f40281g, iArrH3);
        int[] iArrH4 = rr.f.h();
        l.o(iArrH3, iArrH4);
        boolean zI = mVar3.i();
        int[] iArr = mVar3.f40281g;
        if (!zI) {
            l.o(iArr, iArrH2);
            iArr = iArrH2;
        }
        l.q(mVar2.f40281g, iArr, iArrH);
        l.a(mVar2.f40281g, iArr, iArrH2);
        l.h(iArrH2, iArrH, iArrH2);
        l.n(rr.f.b(iArrH2, iArrH2, iArrH2), iArrH2);
        l.h(iArrH3, mVar2.f40281g, iArrH3);
        l.n(rr.o.E0(5, iArrH3, 2, 0), iArrH3);
        l.n(rr.o.H0(5, iArrH4, 3, 0, iArrH), iArrH);
        m mVar4 = new m(iArrH4);
        l.o(iArrH2, mVar4.f40281g);
        int[] iArr2 = mVar4.f40281g;
        l.q(iArr2, iArrH3, iArr2);
        int[] iArr3 = mVar4.f40281g;
        l.q(iArr3, iArrH3, iArr3);
        m mVar5 = new m(iArrH3);
        l.q(iArrH3, mVar4.f40281g, mVar5.f40281g);
        int[] iArr4 = mVar5.f40281g;
        l.h(iArr4, iArrH2, iArr4);
        int[] iArr5 = mVar5.f40281g;
        l.q(iArr5, iArrH, iArr5);
        m mVar6 = new m(iArrH2);
        l.s(mVar.f40281g, mVar6.f40281g);
        if (!zI) {
            int[] iArr6 = mVar6.f40281g;
            l.h(iArr6, mVar3.f40281g, iArr6);
        }
        return new n(eVarI, mVar4, mVar5, new ir.f[]{mVar6});
    }
    ...
    public ir.i a(ir.i iVar) {
        ...
        return new n(eVarI, mVar7, mVar8, new ir.f[]{mVar9});
    }
