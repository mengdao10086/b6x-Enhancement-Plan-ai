...
=======
    PID_OUT_FILTER: { type: "multi", fields: [{ label: "开启", min: 0, max: 1 }, { label: "基础α(‰)", min: 1, max: 1000 }, { label: "温差增益(‰/0.1°)", min: 0, max: 1000 }, { label: "偏差增益(‰/0.1°)", min: 0, max: 500 }, { label: "下降倍率(×0.1)", min: 10, max: 100 }],
      label: "PID 输出端自适应滤波（开启 + 基础α + 温差增益 + 偏差增益 + 下降倍率）",
